<?php
    ...
    for($i=1;$i<=12;$i++){
      ...
      echo   $Where3		= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND YEAR(transaction_date) = '".$year."' AND MONTH(transaction_date) = '".$i."'";
    echo    $fields         = "sum(laboramount+partsamount+taxamount+hazardwasteamount+shopsuppliesamount) as gross, sum(discountamount) as discountamount";
        $Table3		= "XML_ro ";
