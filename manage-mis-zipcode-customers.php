...
$Where		= "1=1 AND MIS_Zip != '' AND market_cust_id = '".$_SESSION['User']['UID']."'";
...
$Where		.= " GROUP BY MIS_Zip ORDER BY ".$SortBy." LIMIT ".$offset.",".$limit;

$Users 	= $usr->GetSelWhere($Table,$Fields,$Where);
for($i=0;$i<count($Users);$i++)
{
	$totalCust = $usr->TotalRows("MIS_customers","MIS_Zip = '".$Users[$i]['MIS_Zip']."' AND market_cust_id = '".$_SESSION['User']['UID']."'");
...
//echo "<pre>";print_r($Users);exit;
$smarty->display('manage-mis-zipcode-customers.tpl');
?>