...
// Version 0.3  14/09/2007 added .zindex()
      ...
      var E_STYLE_1 = new EStyle("stem1.png", new GSize(181,87),  "estyle1", new GPoint(-30,87-3));
      var E_STYLE_2 = new EStyle("stem2.png", new GSize(181,87),  "estyle2", new GPoint(-30,87-1));
      var E_STYLE_3 = new EStyle("stem3.png", new GSize(181,87),  "estyle3", new GPoint(-30,87-10));
      var E_STYLE_4 = new EStyle("stem3.png", new GSize(181,87),  "estyle4", new GPoint(-30,87-10));
      var E_STYLE_5 = new EStyle("stem1.png", new GSize(181,87),  "estyle5", new GPoint(-30,87-3));
      var E_STYLE_6 = new EStyle("stem6.png", new GSize(1100,50), "estyle6", new GPoint(100-2,20));
      var E_STYLE_7 = new EStyle("stem7.png", new GSize(124,24),  "estyle7", new GPoint(-10,23));
      ...
      EWindow.prototype.openOnMap = function(point, html, offset) {
        ...
        if (this.ie && this.estyle.stemImage.toLowerCase().indexOf(".png")>-1) {
          ...
          this.div2.innerHTML = '<img id="stem" src="' + this.estyle.stemImage + '" width="' + this.estyle.stemSize.width +'" height="' + this.estyle.stemSize.height +'">';
        }
