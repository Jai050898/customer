	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: img_path+'/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	img_path+'/progressbg_red.gif',
									30: img_path+'/progressbg_orange.gif',
									70: img_path+'/progressbg_green.gif'
								},
