<div>
			...
			{foreach item=Citem name=Citem from=$item1.Arr}
				<td align="left" valign="middle" style="font-size:13px;">{if $Citem.amount neq ""}$ {$Citem.amount}{else} NA {/if}</td>
				<td align="left" valign="middle" style="font-size:13px;">{if $Citem.actual_amount neq ""}$ {$Citem.actual_amount}{else} NA {/if}</td>
			{foreachelse}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;">NA</td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;">NA</td>
			{/foreach}
			...
			{foreach item=Calitem name=Calitem from=$Cal}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Calitem.gsales}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Calitem.gsales}</strong></td>
			{/foreach}
			</tr>
			<tr style="background-color:#f3f3f3;">
			...
			{foreach item=Calitem name=Calitem from=$Cal}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Calitem.amount}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Calitem.actualamount}</strong></td>
			{/foreach}
			</tr>
			<tr style="background-color:#f3f3f3;">
