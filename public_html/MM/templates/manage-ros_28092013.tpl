                    ...
                    <td align="left" valign="top" colspan="2">
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                            <tr>
                                ...
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('C.fullname','{$sortioption}',document.ManageXMLCustomers);">Full Name </a> {if $smarty.request.sortby eq 'C.fullname'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle" />{/if}</th>
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('V.name','{$sortioption}',document.ManageXMLCustomers);">Vehicle Name </a> {if $smarty.request.sortby eq 'V.name'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle" />{/if}</th>
                                <th bgcolor="#336699" style="color:#fff;">Odometer In / OUT</th>
                                <th bgcolor="#336699" style="color:#fff;">Transaction Date</th>
                                <th bgcolor="#336699" style="color:#fff;">Transaction Total</th>
                            </tr>
                            {foreach item=item name=item from=$Users}
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;">{$item.odometerin} / {$item.odometerout}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;">{$item.transaction_date|date_format:"%m/%d/%y"}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;">${$item.transactiontotal}</td>
                                </tr>
                            {foreachelse}
                                <tr>
