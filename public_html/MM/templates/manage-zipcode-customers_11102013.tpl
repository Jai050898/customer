                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                                ...
                                {foreach item=item name=item from=$Users}
                                    ...
                                    <tr>
                                            ...
                                            <td bgcolor="#f9f9f7" style="color:#000000;"><a href="{$siteurl}/manage-customers.php?zip={$item.zip}"> {$item.Ccount}</a></td>
                                            <td bgcolor="#f9f9f7" style="color:#000000;">${$item.totalSpentYear|string_format:"%.2f"}</td>
                                            <td bgcolor="#f9f9f7" style="color:#000000;">${$item.totalSpentLifetime|string_format:"%.2f"}</td>
                                            <td bgcolor="#f9f9f7" style="color:#000000;">${$item.totalCustSpentVisitedThisYear|string_format:"%.2f"}</td>
                                    </tr>
                                    {else}
                                        <tr>
