	...
	<div class="bodybg" style="min-height:475px;">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
				...
				<tr>
					...
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.comments}</td>
                                        <td bgcolor="#f9f9f7" style="text-align: right;">{$item.dateuploaded|date_format:"%b %d,%Y"}</td>
                                        <td  bgcolor="#f9f9f7" style="text-align: right;"><a href="{$siteurl}/download.php?imag={$item.filename|base64_encode}" class="link023">View</a></td>
				</tr>
				{foreachelse}
				<tr>
