		...
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" >
				...
				<tr>
					...
					<td bgcolor="#f9f9f7"><a href="{$siteurl}/ajax.php?For=Comments&height=600&width=600&type=C&Id={$item.task_id|base64_encode}" class="thickbox" title="View Comments">{$item.commentcount}</a></td>
					<td bgcolor="#f9f9f7"><span class="progressBar" id="task_status{$smarty.foreach.item.index}">{$item.task_status}</span></td>
					<td bgcolor="#f9f9f7"><a href="{$siteurl}/add-tasks.php?task_id={$item.task_id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
