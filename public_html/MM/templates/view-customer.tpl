...
<div id="body">
    <div class="bodybg" style="min-height:475px;">
        <div class="bodyleft">
            ...
            <div style="height:10px;"></div>
            <h2>Lifetime Spending Total: ${$User.lifetimeSpendingTotal|number_format:2:".":","}</h2>
            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
                <tr>
                    <th>Visit</th>
                    <th>Amount Spent</th>
                ...
                {foreach item=item name=item key = k from=$RODetails}
                    <tr>
                        ...
                        <td align="left" valign="center" width="55%"  style="text-align:center"><a href="{$siteurl}/customer-ro-details-view.php?id={$item.ro_id}">${$item.roDetailtotal|number_format:2:".":","}</a></td>
