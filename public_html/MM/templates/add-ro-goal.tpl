...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<h1>{if $smarty.request.task_id neq ""}Edit{else}Add{/if} RO Goal</h1>
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Lognew[]" id="new{$smarty.foreach.item.index+1}" class="select req-string req-numeric" value="{$Tasks.new}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Repeat:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Logrepeat[]" id="repeat{$smarty.foreach.item.index+1}" class="select req-string req-numeric" value="{$Tasks.new}"/></td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
				</tr>
