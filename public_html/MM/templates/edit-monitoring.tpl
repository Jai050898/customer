	...
	<div class="bodybg">
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				<td colspan="2"><u><strong>{"01-`$item.month`-2012"|date_format:"%B"}</strong></u></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">New:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Log1[Loggrosssales][{$item.id}]" id="new{$smarty.foreach.item.index+1}" class="select req-string req-numeric" value="{$item.grosssales}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Repeat:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Log1[Logrocount][{$item.id}]" id="repeat{$smarty.foreach.item.index+1}" class="select req-string req-numeric" value="{$item.rocount}"/></td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
				</tr>
