                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                                ...
                                {foreach item=item name=item from=$Users}
                                    ...
                                    <tr>
                                            ...
                                            <td bgcolor="#f9f9f7" style="color:#000000;">${$item.totalSpentYear|number_format:2:".":","}</td>
                                            <td bgcolor="#f9f9f7" style="color:#000000;">${$item.totalSpentLifetime|number_format:2:".":","}</td>
                                            <td bgcolor="#f9f9f7" style="color:#000000;">${$item.totalCustSpentVisitedThisYear|number_format:2:".":","}</td>
                                    </tr>
                                    {else}
                                        <tr>
