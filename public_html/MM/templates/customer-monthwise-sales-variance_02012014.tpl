                        ...
                        {foreach item=item name=item from=$dataArray}
                            <th width="9%" height="27"  align="left" valign="top">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                      <tr>
                                            <td colspan="2"   height="27" align="center" valign="middle"  bgcolor="#f9f9f7" style="color:#000000;">${$item.highGrossSale|number_format:0:".":","}</td>
                                      </tr>
                                      <tr>
                                           <td colspan="2"   height="27" align="center" valign="middle"  bgcolor="#f9f9f7" style="color:#000000;">${$item.lowGrossSale|number_format:0:".":","}</td>
                                      </tr>
                                      <tr>
                                            <td colspan="2"   height="27" align="center" valign="middle"  bgcolor="#f9f9f7" style="color:#000000;">${$item.averageGrossSale|number_format:0:".":","}</td>
                                      </tr>
                                  </table>
                            </th>
                    {foreachelse}
