    ...
    <div class="bodybg" style="min-height:475px;">
        <div class="bodyleft">
            ...
            <form id="ManageVehicles" class="form" method="GET" name="ManageVehicles">
                ...
                <input type="make" name="make" value="{$smarty.request.make}" />
                        ...
                        <td align="left" valign="top" colspan="2">
                          <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" class="tableinnercontent">
                            <tr>
                                ...
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('model','{$sortioption}',document.ManageVehicles);">Model </a> {if $smarty.request.sortby eq 'model'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle" />{/if}</th>
