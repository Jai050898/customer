<div>
			...
			{foreach item=Citem name=Citem from=$item1.Arr}
				<td align="left" valign="middle" style="font-size:13px;text-align: right;">{if $Citem.amount neq ""}$ {$Citem.amount|number_format:2:".":","}{else} NA {/if}</td>
				<td align="left" valign="middle" style="font-size:13px;text-align: right;">{if $Citem.actual_amount neq ""}$ {$Citem.actual_amount|number_format:2:".":","}{else} NA {/if}</td>
			{foreachelse}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;">NA</td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;">NA</td>
			{/foreach}
			...
			{foreachelse}
			<tr>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;">{$item1.title}</td>
			{foreach item=Calitem name=Calitem from=$Cal}
			...
			{foreach item=Calitem name=Calitem from=$Cal}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Calitem.gsales|number_format:2:".":","}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Calitem.gsales|number_format:2:".":","}</strong></td>
			{/foreach}
			</tr>
			<tr style="background-color:#f3f3f3;">
			...
			{foreach item=Calitem name=Calitem from=$Cal}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Calitem.amount|number_format:2:".":","}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Calitem.actualamount|number_format:2:".":","}</strong></td>
			{/foreach}
			</tr>
			<tr style="background-color:#f3f3f3;">
			<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>% of Gross Sales</strong></td>
			{foreach item=Calitem name=Calitem from=$Cal}
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>{$Calitem.per} %</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>{$Calitem.actper} %</strong></td>
			{/foreach}
			</tr>
			</table>
			{else}
