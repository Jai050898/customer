                                ...
                                <td align="left" valign="top" colspan="2">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                                        <tr>
                                                ...
                                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('lname','{$sortioption}',document.ManageCustomers);">Customer Name</a> {if $smarty.request.sortby eq 'lname'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
                                                ...
                                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('Vcount','{$sortioption}',document.ManageCustomers);">Total Vehicles</a></th>
                                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('Rcount','{$sortioption}',document.ManageCustomers);">Total ROs</a></th>
                                        ...
                                        {foreach item=item name=item from=$Users}
                                            <tr>
                                                ...
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><a href="{$siteurl}/view-customer.php?user_id={$item.cust_id}">{$item.lname} {$item.fname}</a></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"> {$item.city}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;">{$item.state}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><a href="{$siteurl}/manage-vehicles.php?user_id={$item.cust_id}">{$item.Vcount}</a></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><a href="{$siteurl}/manage-ros.php?user_id={$item.cust_id}">{$item.Rcount}</a></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;">{if $item.distance neq ''}{$item.distance|number_format:2}{else}-N/A-{/if}</td>
                                            </tr>
                                        {foreachelse}
                                            <tr>
