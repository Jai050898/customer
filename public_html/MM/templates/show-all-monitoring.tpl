		<div>
			...
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$item|number_format:2:".":","}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$MaxTotals1|number_format:2:".":","}</strong></td>
			</tr>
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$item|number_format:2:".":","}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$MinTotals1|number_format:2:".":","}</strong></td>
			</tr>
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$item|number_format:2:".":","}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$AvgTotals1|number_format:2:".":","}</strong></td>
			</tr>
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$item|number_format:2:".":","}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>${$MedTotals1|number_format:2:".":","}</strong></td>
			</tr>
			{foreach item=CalGoalitem name=CalGoalitem from=$CalGoals}
			<tr height="25" style="color:#993300;">
				<td  align="left" valign="middle" bgcolor="#DCE6F2" style="font-size:13px;text-align: right; width:8%"><strong>{$CalGoalitem.year}</strong></td>
				{foreach item=Gitem name=Gitem from=$CalGoalitem.Items}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right; width:7%">${$Gitem.goalsales|number_format:2:".":","}</td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right; width:7%"><strong>${$CalGoalitem.amount|number_format:2:".":","}</strong></td>
			</tr>
			{/foreach}
			{/if}
			</table>
