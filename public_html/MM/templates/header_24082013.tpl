...
{/if}
<div id="container">
<div id="logo"><a href="http://www.autorepairmarketing.com/customer"><img border="0" src="http://www.autorepairmarketing.com/customer/images/MotorheadMarketing.png"></a><div class="tag">Customer Dashboard</div>
...
<div id="nav">
  <ul>
	...
	<li><a href="#" {if $Page eq 'surveys'}  class="active"{/if}><span>Surveys</span></a>
		<ul>
	...
	<li><a href="#" {if $Page eq 'customers'}  class="active"{/if}><span>Customers</span></a>
		<ul>
			...
			<li><a href="{$siteurl}/manage-mis-customers.php"><span>Manage Customers</span></a></li>
			<li><a href="{$siteurl}/manage-mis-customers-report.php"><span>Customer Report</span></a></li>
			<li><a href="{$siteurl}/manage-mis-zipcode-customers.php"><span>Zip Code List</span></a></li>
			<li><a href="{$siteurl}/manage-mis-city-customers.php"><span>City List</span></a></li>
		</ul>
	</li>
