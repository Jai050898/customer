			...
			<form name="frmStepOne" id="frmStepOne" method="post" enctype="multipart/form-data" class="form" onsubmit="return validateForm();" action="step1.php">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="3" >
				  ...
				  <tr>
					...
					<input type="text" name="TollFreePhone" id="TollFreePhone" maxlength="15" size="20" class="input req-string" value="{$basicInfoDetail.TollFreePhone}"/></td>
				  ...
				  <tr>
					...
					<input type="text" name="FaxLineNumber" id="FaxLineNumber" maxlength="15" size="20" class="input req-string" value="{$basicInfoDetail.FaxLineNumber}"/></td>
				  ...
				  <tr>
					...
					<input type="text" name="OwnerEmailAddress" id="OwnerEmailAddress" maxlength="80" size="40" class="input req-string" value="{$basicInfoDetail.OwnerEmailAddress}"/></td>
				  ...
				  <tr>
					...
					<input type="text" name="WebSiteAddress" id="WebSiteAddress" maxlength="100" size="40" class="input req-string" value="{$basicInfoDetail.WebSiteAddress}"/></td>
...
selected=$basicInfoDetail.GarageMgtSystem separator="<br />" id="GarageMgtSystem"}
					...
					<input type="text" name="GarageMgtSystemOther" class="input req-string" id="GarageMgtSystemOther" maxlength="100" size="40" onchange="setChecked('GarageMgtSystem','frmStepOne','8')" value="{$basicInfoDetail.GarageMgtSystemOther}">																	</td>
...
<span class="infoText">(Please enter exact percentage value, e.g. enter 30 in case the value is 30%) </span>																			</td>
				  ...
				  {/if}
				<tr>
						  <td align="center" valign="top" colspan="3" style="padding-left:255px;"><span id="errorDiv1" class="error-div">&nbsp;{if $response neq ''}{$response}{/if}</span></td>
						</tr>
				  <tr>
...
$('#Post').formValidator({literal}{scope: {/literal}'#frmStepOne',errorDiv:'#errorDiv1'});
</script>
{literal}
	<script language="javascript">
