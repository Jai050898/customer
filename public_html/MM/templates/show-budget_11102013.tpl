	...
	<div class="bodybg">
		<div class="bodyleft">
			...
			<tr style="background-color:{cycle values='#ffffff,#ffffff'};">
				...
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;">$ {$item1.amount}</td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;">$ {$item1.actual_amount}</td>
			</tr>
			{/foreach}
			{/if}
			{/foreach}
			<tr style="background-color:#f3f3f3;">
				...
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Cal.gsales}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Cal.gsales}</strong></td>
			</tr>
			<tr style="background-color:#f3f3f3;">
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>Total</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Cal.amount}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>$ {$Cal.actualamount}</strong></td>
			</tr>
			<tr style="background-color:#f3f3f3;">
