		...
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  {html_select_date prefix='StartDate' time=$time end_year='+3' display_days=false display_months=false}</td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
				</tr>	
				...
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Goal Sales:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Loggoalsales[]" id="new{$smarty.foreach.item.index+1}" class="select req-string req-numeric" value="{$Tasks.Loggoalsales}"/></td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
				</tr>
