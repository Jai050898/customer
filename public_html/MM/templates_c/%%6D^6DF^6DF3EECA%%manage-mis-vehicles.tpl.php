<?php /* Smarty version 2.6.26, created on 2013-06-26 02:50:12
         compiled from manage-mis-vehicles.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-mis-vehicles.tpl', 57, false),)), $this); ?>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
									<tr>
										...
										<th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('MIS_Year','<?php echo $this->_tpl_vars['sortioption']; ?>
...
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('MIS_Make','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMISVehicles);">Make </a> <?php if ($_REQUEST['sortby'] == 'MIS_Make'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
										<th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('MIS_Model','<?php echo $this->_tpl_vars['sortioption']; ?>
...
?>
										<tr>
											...
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_Year']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"> <?php echo $this->_tpl_vars['item']['MIS_Make']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"> <?php echo $this->_tpl_vars['item']['MIS_Model']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/view-mis-vehicle.php?vid=<?php echo $this->_tpl_vars['item']['MIS_Vehicle_ID']; ?>
"><?php echo $this->_tpl_vars['item']['MIS_Vin']; ?>
</a></td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_Body']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_Engine']; ?>
</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
