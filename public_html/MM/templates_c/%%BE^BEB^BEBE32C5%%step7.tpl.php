<?php /* Smarty version 2.6.26, created on 2013-09-17 02:17:36
         compiled from step7.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'step7.tpl', 66, false),array('function', 'html_checkboxes', 'step7.tpl', 128, false),)), $this); ?>
		...
		<div class="bodyleft">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
					  <tbody>
					   ...
					   <td width="14%">
						...
						<td width="14%"><table width="100%" cellspacing="0" cellpadding="0" border="0">
							  <tbody><tr>
								<td width="50%" align="right" valign="middle"><img height="1" width="100%" border="0" alt="" src="images/pixel_silver.gif"/></td>
								<td width="50%" align="left"><img width="11" height="11" border="0" alt="" src="images/checkout_bullet.gif"/></td>
							  </tr>
							</tbody>
							</table></td>
					  </tr>
					  <tr>
						...
						<td width="14%" align="center" class="checkoutBarCurrent"><strong>Finished</strong></td>
					  </tr>
					</tbody>
					</table>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="5">
				  ...
				  <tr>
					<td align="left" style="padding-left:25px" valign="top" >
						...
						<div style="width:100%; " id="divPurhaseMailing">
