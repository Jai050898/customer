<?php /* Smarty version 2.6.26, created on 2014-02-01 06:59:53
         compiled from customer-dc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'customer-dc.tpl', 16, false),array('modifier', 'string_format', 'customer-dc.tpl', 116, false),)), $this); ?>
...
<div id="body">
    <div class="bodybg" style="min-height:475px;">
        <div>
            ...
            <div><div style="float:left;"><h1>Customer Data Center</h1></div><div style="float:right;font-weight:bold;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/new-customers.php?fdate=<?php echo $this->_tpl_vars['todayDate']; ?>
&tdate=<?php echo $this->_tpl_vars['todayDate']; ?>
">New Customer Report</a></div></div>
...
/last-visited-customer-emails.php"><?php echo ((is_array($_tmp=$this->_tpl_vars['LastVisitedCustEmailCnt'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ".", ",") : number_format($_tmp, 0, ".", ",")); ?>
</a></td>
                </tr>
            </table>
            <br /><br />
 ...
 ($<?php echo ((is_array($_tmp=$this->_tpl_vars['lowestYearTotal'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                <tr>
                    <th bgcolor="#336699" style="color:#fff;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/customer-monthwise-sales-variance.php" title="Monthwise Sales Variance">Year</a></th>
...
/customer-monthwise-data.php?y=<?php echo $this->_tpl_vars['item']['Year']; ?>
" title="Monthwise Report"><?php echo $this->_tpl_vars['item']['Year']; ?>
</a>  <a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/customer-weekwise-data.php?y=<?php echo $this->_tpl_vars['item']['Year']; ?>
