<?php /* Smarty version 2.6.26, created on 2013-08-28 08:18:24
         compiled from add-cal.tpl */ ?>
		...
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="LogMain[name]" id="name" class="select req-string" value="<?php echo $this->_tpl_vars['Tasks']['name']; ?>
"/></td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
...
" <?php if ($this->_tpl_vars['item']['id'] == $this->_tpl_vars['Cat']['id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['cat_name']; ?>
					...
					<td align="left" valign="center"><input type="text" name="Log[sdate][]" id="sdate" class="select req-string reqDate" value="<?php echo $this->_tpl_vars['Tasks']['sdate']; ?>
"/></td>
					<td align="left" valign="center"><input type="text" name="Log[edate][]" id="edate" class="select req-string reqDate" value="<?php echo $this->_tpl_vars['Tasks']['edate']; ?>
