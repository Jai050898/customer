<?php /* Smarty version 2.6.26, created on 2013-06-06 22:33:57
         compiled from manage-competitors.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'manage-competitors.tpl', 22, false),array('modifier', 'date_format', 'manage-competitors.tpl', 27, false),array('modifier', 'count', 'manage-competitors.tpl', 35, false),)), $this); ?>
...
/add-competitor.php">Add Competitor</a></span>
...
?>
				<tr>
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['name'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
&nbsp;</td>
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['address']; ?>
&nbsp;</td>
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['city']; ?>
&nbsp;</td>
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['state']; ?>
</td>
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['zip']; ?>
</td>
...
/add-competitor.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
