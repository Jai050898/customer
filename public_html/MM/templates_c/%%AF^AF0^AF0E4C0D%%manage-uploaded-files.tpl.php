<?php /* Smarty version 2.6.26, created on 2013-10-11 07:49:57
         compiled from manage-uploaded-files.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'base64_encode', 'manage-uploaded-files.tpl', 19, false),array('modifier', 'date_format', 'manage-uploaded-files.tpl', 21, false),array('modifier', 'count', 'manage-uploaded-files.tpl', 29, false),)), $this); ?>
...
/upload-file.php">Add Document</a></span>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
				...
				<?php $_from = $this->_tpl_vars['Documents']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['item'] = array('total' => count($_from), 'iteration' => 0);
...
/download.php?imag=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['filename'])) ? $this->_run_mod_handler('base64_encode', true, $_tmp) : smarty_modifier_base64_encode($_tmp)); ?>
"><?php echo $this->_tpl_vars['item']['filename']; ?>
</a>&nbsp;</td>
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['comments']; ?>
</td>
                                        <td bgcolor="#f9f9f7" style="text-align: right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['dateuploaded'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%b %d,%Y") : smarty_modifier_date_format($_tmp, "%b %d,%Y")); ?>
</td>
...
" class="link023">View</a></td>
				...
				<?php if (count($this->_tpl_vars['Documents']) > 0): ?>
				<tr>
