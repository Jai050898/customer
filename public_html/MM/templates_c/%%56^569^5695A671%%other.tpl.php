<?php /* Smarty version 2.6.26, created on 2013-09-17 02:27:32
         compiled from other.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'other.tpl', 42, false),array('function', 'html_checkboxes', 'other.tpl', 50, false),array('function', 'html_radios', 'other.tpl', 90, false),)), $this); ?>
...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<div style="height:10px;"></div>
			<form name="frmOthers" id="frmOthers" method="post" class="fValidator-form" onsubmit="return validateForm();" action="other.php">
