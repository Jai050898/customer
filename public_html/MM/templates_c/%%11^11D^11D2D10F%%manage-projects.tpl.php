<?php /* Smarty version 2.6.26, created on 2013-10-11 07:36:13
         compiled from manage-projects.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'manage-projects.tpl', 27, false),array('modifier', 'count', 'manage-projects.tpl', 35, false),)), $this); ?>
...
/view-project.php?project_id=<?php echo $this->_tpl_vars['item']['project_id']; ?>
"><?php echo $this->_tpl_vars['item']['name']; ?>
</a>&nbsp;</td>
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php if ($this->_tpl_vars['item']['project_status'] == '1'): ?><font color="#00CC33">New</font><?php elseif ($this->_tpl_vars['item']['project_status'] == '2'): ?><font color="#0000FF">Proposal</font><?php elseif ($this->_tpl_vars['item']['project_status'] == '3'): ?><font color="#00EEFF">In Progress</font><?php elseif ($this->_tpl_vars['item']['project_status'] == '4'): ?><font color="#00ff00">Completed</font><?php else: ?><font color="#FF0000">Cancelled</font><?php endif; ?></td>
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php if ($this->_tpl_vars['item']['priority'] == '1'): ?>Urgent<?php elseif ($this->_tpl_vars['item']['priority'] == '2'): ?>High Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '3'): ?>Medium Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '4'): ?> Normal Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '5'): ?>Low Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '6'): ?>Very Low Priority<?php else: ?>Whatever<?php endif; ?></td>
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['totmembers']; ?>
</td>
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['totaltasks']; ?>
</td>
                                        <td bgcolor="#f9f9f7" style="text-align: right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['created_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%b %d,%Y") : smarty_modifier_date_format($_tmp, "%b %d,%Y")); ?>
</td>
                                        <td  bgcolor="#f9f9f7" style="text-align: right;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/add-project.php?project_id=<?php echo $this->_tpl_vars['item']['project_id']; ?>
