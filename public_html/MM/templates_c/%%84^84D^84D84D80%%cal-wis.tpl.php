<?php /* Smarty version 2.6.26, created on 2013-08-28 04:15:09
         compiled from cal-wis.tpl */ ?>
		...
		<h1>Results</h1>
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="GLS" id="GLS" value="<?php echo $this->_tpl_vars['Tasks']['GLS']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Gross Parts Sales (GPS):</td>
				  <td align="left" valign="center"><input type="text" name="GPS" id="GPS" value="<?php echo $this->_tpl_vars['Tasks']['GPS']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Gross Sales (GS):</td>
				  <td align="left" valign="center"><input type="text" name="GS" id="GS" value="<?php echo $this->_tpl_vars['Tasks']['GS']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Total Labor Costs (TLC):</td>
				  <td align="left" valign="center"><input type="text" name="TLC" id="TLC" value="<?php echo $this->_tpl_vars['Tasks']['TLC']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Total Parts Costs (TPC):</td>
				  <td align="left" valign="center"><input type="text" name="TPC" id="TPC" value="<?php echo $this->_tpl_vars['Tasks']['TPC']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Marketing Budget:</td>
				  <td align="left" valign="center"><input type="text" name="MB" id="MB" value="<?php echo $this->_tpl_vars['Tasks']['MB']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Rent Budget:</td>
				  <td align="left" valign="center"><input type="text" name="RB" id="RB" value="<?php echo $this->_tpl_vars['Tasks']['RB']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Number of Customers Needed:</td>
				  <td align="left" valign="center"><input type="text" name="NCN" id="NCN" value="<?php echo $this->_tpl_vars['Tasks']['NCN']; ?>
"/></td>
				</tr>
				<tr>
