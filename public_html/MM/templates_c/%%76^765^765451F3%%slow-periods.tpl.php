<?php /* Smarty version 2.6.26, created on 2013-06-18 01:24:46
         compiled from slow-periods.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'slow-periods.tpl', 30, false),)), $this); ?>
...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<h1><?php if ($_REQUEST['task_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> Slow Periods</h1>
...
function DeleteItem(id)
{
	$("#item"+id).hide(\'slow\');
	//$("#itemtr"+id).hide(\'50\');
	$.post(site_path+"/ajax.php",{For:\'DelCalSlowItem\',id:id},function(data){});
}
</script>
'; ?>