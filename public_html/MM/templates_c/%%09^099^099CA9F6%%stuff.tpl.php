<?php /* Smarty version 2.6.26, created on 2013-09-17 02:21:06
         compiled from stuff.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'stuff.tpl', 76, false),array('modifier', 'nl2br', 'stuff.tpl', 90, false),array('function', 'cycle', 'stuff.tpl', 79, false),array('function', 'html_options', 'stuff.tpl', 108, false),)), $this); ?>
				...
				<table width="100%" >
				  ...
				  <tr>
					<td colspan="3" align="left" style="padding-left:10px">
						  ...
						  <input type="hidden" name="tbl" value="web_tbl_employee" />
					...
					<table width="100%" border="0" >
					  <tr>
						<td align="left" style="padding-bottom:10px" valign="middle">Do you wish to use the site for employment recruiting ?	&nbsp;													<select name="UseForEmpRecruiting" class="form">
									  <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['arrayYesNo1'],'selected' => $this->_tpl_vars['stuffDetail']['UseForEmpRecruiting']), $this);?>
...
<?php echo '
	...
	function deleteEmpoyee(id)
	{
		document.getElementById("divVeil").style.height=newHeight+\'px\';
		document.getElementById("divVeil").style.display=\'block\';
		queryString=\'act=del&tbl=web_tbl_employee&EmpId=\'+id;
	...
	function hideDiv()
	{
		...
		queryString=\'tbl=web_tbl_employee\';
