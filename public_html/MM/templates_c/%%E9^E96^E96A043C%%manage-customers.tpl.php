<?php /* Smarty version 2.6.26, created on 2013-10-25 02:47:29
         compiled from manage-customers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'manage-customers.tpl', 54, false),array('modifier', 'count', 'manage-customers.tpl', 64, false),)), $this); ?>
                        ...
                        <td align="left" valign="top" colspan="2">
                            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" class="tableinnercontent">
                                <tr>
                                        ...
                                        <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('fname','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCustomers);">Customer Name</a> <?php if ($_REQUEST['sortby'] == 'fname'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
                                        ...
                                        <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('Vcount','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCustomers);">Total Vehicles </a> <?php if ($_REQUEST['sortby'] == 'Vcount'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
                                        <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('Rcount','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCustomers);">Total ROs </a> <?php if ($_REQUEST['sortby'] == 'Rcount'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
                                        <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('distance','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCustomers);">Distance (Miles)</a></th>
                                </tr>
...
/manage-vehicles.php?user_id=<?php echo $this->_tpl_vars['item']['cust_id']; ?>
"><?php echo $this->_tpl_vars['item']['Vcount']; ?>
</a></td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/manage-ros.php?user_id=<?php echo $this->_tpl_vars['item']['cust_id']; ?>
"><?php echo $this->_tpl_vars['item']['Rcount']; ?>
</a></td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php if ($this->_tpl_vars['item']['distance'] != ''): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['distance'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
<?php else: ?>-N/A-<?php endif; ?></td>
                                    </tr>
                                <?php endforeach; else: ?>
                                    <tr>
                                        <th bgcolor="#f9f9f7" style="color:#000000;" colspan="7"><font color="#FF0000"><strong>No Customers Added</strong></font></th>
                                    </tr>
