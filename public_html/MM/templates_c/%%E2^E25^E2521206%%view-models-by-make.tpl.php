<?php /* Smarty version 2.6.26, created on 2013-10-23 03:31:43
         compiled from view-models-by-make.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'view-models-by-make.tpl', 61, false),)), $this); ?>
...
<div id="body">
    <div class="bodybg" style="min-height:475px;">
        <div class="bodyleft">
            ...
            <h1>Vehicle Management by Make</h1>
            <form id="ManageVehicles" class="form" method="GET" name="ManageVehicles">
                <input type="hidden" name="sortby" value="<?php echo $_REQUEST['sortby']; ?>
" />
                <input type="hidden" name="sortoption" value="<?php echo $_REQUEST['sortoption']; ?>
" />
                <input type="make" name="make" value="<?php echo $_REQUEST['make']; ?>
" />
                <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                    ...
                    <tr>
                      <td colspan="2">
                            <div class="search_divbox"   style="margin-left:10px">
                        ...
                        <td align="left" valign="top" colspan="2">
                          <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" class="tableinnercontent">
                            <tr>
                                ...
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('model','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageVehicles);">Model </a> <?php if ($_REQUEST['sortby'] == 'model'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
?>
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"> <?php echo $this->_tpl_vars['item']['model']; ?>
</td>
                            ...
                            <?php endforeach; else: ?>
                                <tr>
                                    <th align="center" bgcolor="#f9f9f7" style="color:#000000;" colspan="6"><font color="#FF0000"><strong>No records found</strong></font></th>
                                </tr>
