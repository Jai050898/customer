<?php /* Smarty version 2.6.26, created on 2013-06-18 01:21:48
         compiled from edit-budget.tpl */ ?>
...
"/></td>
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="LogMain[gsales ]" id="gsales " class="select req-string req-numeric" value="<?php echo $this->_tpl_vars['Cal']['gsales']; ?>
"/></td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
				...
				<tr >
				  ...
				  <td align="center" valign="center" style="padding-left:5px;">Amount:</td>
...
" <?php if ($this->_tpl_vars['item1']['id'] == $this->_tpl_vars['item']['cat_id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item1']['cat_name']; ?>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log1[amount][<?php echo $this->_tpl_vars['item']['id']; ?>
]" id="editsdate<?php echo ($this->_foreach['item']['iteration']-1)+1; ?>
" class="select req-string req-numeric" value='<?php echo $this->_tpl_vars['item']['amount']; ?>
'/></td>
				  <td align="left" valign="center"><input type="text" name="Log1[actual_amount][<?php echo $this->_tpl_vars['item']['id']; ?>
]" id="editedate<?php echo ($this->_foreach['item']['iteration']-1)+1; ?>
" class="select req-string req-numeric" value='<?php echo $this->_tpl_vars['item']['actual_amount']; ?>
'/></td>
				</tr>
...
" <?php if ($this->_tpl_vars['item']['id'] == $this->_tpl_vars['Cat']['id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['cat_name']; ?>
					...
					<td align="left" valign="center"><input type="text" name="Log[amount][]" id="amount" class="selectclassAmt" value="<?php echo $this->_tpl_vars['Tasks']['amount']; ?>
"/></td>
					<td align="left" valign="center"><input type="text" name="Log[actual_amount][]" id="actual_amount" class="selectclassAmt" value="<?php echo $this->_tpl_vars['Tasks']['actual_amount']; ?>
"/></td>
				</tr>
