<?php /* Smarty version 2.6.26, created on 2013-05-22 06:13:04
         compiled from manage-mis-ros.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-mis-ros.tpl', 55, false),)), $this); ?>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
									<tr>
										...
										<th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('MIS_type','<?php echo $this->_tpl_vars['sortioption']; ?>
...
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('MIS_license','<?php echo $this->_tpl_vars['sortioption']; ?>
...
?>
										<tr>
											...
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_type']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/view-mis-ro.php?hid=<?php echo $this->_tpl_vars['item']['MIS_id']; ?>
"> <?php echo $this->_tpl_vars['item']['MIS_license']; ?>
</a></td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_sched']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_promised']; ?>
</td>
											<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo $this->_tpl_vars['item']['MIS_balancedue']; ?>
</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
