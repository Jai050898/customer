...
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'integrated-step3.tpl', 31, false),array('function', 'html_checkboxes', 'integrated-step3.tpl', 231, false),)), $this); ?>
...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<form name="frmStepTwo" id="frmStepTwo" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step3.php">
			<div class="left_content" style="color:#2f3337;">
				<h2><u>Company Profile</u></h2>
