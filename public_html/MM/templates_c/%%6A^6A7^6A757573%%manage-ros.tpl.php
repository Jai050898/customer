<?php /* Smarty version 2.6.26, created on 2013-10-23 06:09:23
         compiled from manage-ros.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'manage-ros.tpl', 52, false),array('modifier', 'number_format', 'manage-ros.tpl', 53, false),array('modifier', 'count', 'manage-ros.tpl', 63, false),)), $this); ?>
...
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
                                ...
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('R.transaction_date','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageXMLCustomers);">Transaction Date</a></th>
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('R.transactiontotal','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageXMLCustomers);">Transaction Total</a></th>
                            </tr>
...
/manage-ro-details.php?ro_id=<?php echo $this->_tpl_vars['item']['ro_id']; ?>
"><?php echo $this->_tpl_vars['item']['ro_id']; ?>
</a></td> -->
                                    <td bgcolor="#f9f9f7" style="color:#000000;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/view-repair-order.php?ro_id=<?php echo $this->_tpl_vars['item']['ro_id']; ?>
"><?php echo $this->_tpl_vars['item']['ro_id']; ?>
</a></td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['fullname']; ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['name']; ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['odometerin']; ?>
 / <?php echo $this->_tpl_vars['item']['odometerout']; ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['transaction_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d/%y") : smarty_modifier_date_format($_tmp, "%m/%d/%y")); ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['transactiontotal'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
                                </tr>
                            <?php endforeach; else: ?>
                                <tr>
