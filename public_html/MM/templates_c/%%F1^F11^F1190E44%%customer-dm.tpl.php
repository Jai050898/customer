<?php /* Smarty version 2.6.26, created on 2013-09-23 02:04:19
         compiled from customer-dm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'customer-dm.tpl', 10, false),array('modifier', 'stripslashes', 'customer-dm.tpl', 341, false),)), $this); ?>
...
<?php echo ';
                            ...
                            <?php endif; ?>
			<?php endif; ?>
			                            <?php if ($_REQUEST['comphid'] == 'all'): ?>
                                <?php echo '
                                    var shopCount5='; ?>
<?php echo $this->_tpl_vars['MapCRescnt']; ?>
<?php echo ';
                                '; ?>
...
?>			
                                <?php echo '			
                                    var address = "<br />'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['address1'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php echo '<br />'; ?>
...
?>			
                                    <?php echo '
                                        var address1 = "<br />'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['item1']['address1'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php echo '<br />'; ?>
<?php echo $this->_tpl_vars['item1']['city']; ?>
<?php echo ', '; ?>
<?php echo $this->_tpl_vars['item1']['state']; ?>
<?php echo ' '; ?>
<?php echo $this->_tpl_vars['item1']['zip']; ?>
<?php echo '<br />";
                                        var name1 = "'; ?>
<?php echo $this->_tpl_vars['item1']['lname']; ?>
<?php echo '";
...
?>			
                                    <?php echo '
                                        var address3 = "<br />'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['item3']['address1'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php echo '<br />'; ?>
<?php echo $this->_tpl_vars['item3']['city']; ?>
<?php echo ', '; ?>
<?php echo $this->_tpl_vars['item3']['state']; ?>
<?php echo ' '; ?>
<?php echo $this->_tpl_vars['item3']['zip']; ?>
<?php echo '<br />";
                                        var name3 = "'; ?>
<?php echo $this->_tpl_vars['item3']['lname']; ?>
<?php echo '";
...
?>			
                                    <?php echo '
                                        var address2 = "<br />'; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['item2']['address1'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php echo '<br />'; ?>
<?php echo $this->_tpl_vars['item2']['city']; ?>
<?php echo ', '; ?>
<?php echo $this->_tpl_vars['item2']['state']; ?>
<?php echo ' '; ?>
<?php echo $this->_tpl_vars['item2']['zip']; ?>
<?php echo '<br />";
                                        var name2 = "'; ?>
<?php echo $this->_tpl_vars['item2']['lname']; ?>
<?php echo '";
...
<?php echo '),address2, name2, zIndex2);
			...
			<?php if ($this->_tpl_vars['Search'] == 'NO'): ?>
                            <?php if ($_REQUEST['comphid'] == 'all'): ?>
                                <?php $_from = $this->_tpl_vars['MapCRes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['item'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['item']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['item']['iteration']++;
?>			
...
<?php echo '";
                                            var marker = createMarkerComp(new GLatLng('; ?>
<?php echo $this->_tpl_vars['item']['coordinates']; ?>
<?php echo '),address5, name5, zIndex5);
                                            map.addOverlay(marker);
                                            zIndex5--;
                                    '; ?>
...
">
                                <input type="hidden" name="comphid" id="comphid" value="<?php echo $_REQUEST['comphid']; ?>
">
...
/js/ewindows/markers/markerd.png" border="0" />
                                            ...
                                            <td><input type="checkbox" name="comp" id="comp" onchange="javascript: hideflag('all');" <?php if ($_REQUEST['comphid'] == 'all'): ?> checked="checked"<?php endif; ?>/> &nbsp; Show All Competitors</td>
                                        </tr>	
                                        <?php if ($this->_tpl_vars['MapCRescnt'] == 0 && $_REQUEST['comphid'] == 'all'): ?>
                                        <tr>
...
/js/ewindows/markers/marker.png" border="0" /> &nbsp; Total Customers</td>
                                    <td style="width:100px;"></td>
                                    <td><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/js/ewindows/markers/markercomp-brown.png" border="0" /> &nbsp; Compititors</td>
                            </tr>
                            </table>
                            <?php else: ?>
                            <table>
