<?php /* Smarty version 2.6.26, created on 2013-09-17 02:20:09
...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<div style="height:10px;"></div>
			<form name="frmHistory" id="frmHistory" method="post" class="fValidator-form" onsubmit="return validateForm();" action="history.php">
