<?php /* Smarty version 2.6.26, created on 2013-10-11 06:32:07
         compiled from manage-ro-details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'manage-ro-details.tpl', 45, false),array('modifier', 'number_format', 'manage-ro-details.tpl', 46, false),array('modifier', 'count', 'manage-ro-details.tpl', 60, false),)), $this); ?>
                    ...
                    <td align="left" valign="top" colspan="2">
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                            <tr>
                                ...
                                <th bgcolor="#336699" style="color:#fff;"><a href="javascript: setClientSort('R.ro_id','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageXMLCustomers);">RO Id</a> <?php if ($_REQUEST['sortby'] == 'R.ro_id'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
?>
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['ro_id']; ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo $this->_tpl_vars['item']['transactiondetailextid']; ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['unitquantity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['unitcost'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['unitsale'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['extendedcost'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['extendedsale'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
