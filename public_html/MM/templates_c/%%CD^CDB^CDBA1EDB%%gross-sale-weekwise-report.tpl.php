<?php /* Smarty version 2.6.26, created on 2014-02-21 04:04:07
         compiled from gross-sale-weekwise-report.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'gross-sale-weekwise-report.tpl', 39, false),array('function', 'math', 'gross-sale-weekwise-report.tpl', 67, false),)), $this); ?>
<?php echo '
<style type="text/css">
    .customersTBL {
...
$this->_sections['foo']['loop'] = is_array($_loop=54) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['bar']['loop'] = is_array($_loop=$this->_tpl_vars['calc1']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                                            <?php if ($this->_sections['bar']['index'] < $this->_tpl_vars['item1']['StartDay']): ?>
                                                <td>&nbsp;</td>
                                            <?php else: ?>
                                                <?php echo smarty_function_math(array('assign' => 'calc2','equation' => "a-b+1",'a' => $this->_sections['bar']['index'],'b' => $this->_tpl_vars['item1']['StartDay']), $this);?>

                                                <td><?php echo $this->_tpl_vars['item']['Year']; ?>
-<?php echo $this->_tpl_vars['key1']; ?>
-<?php echo $this->_tpl_vars['calc2']; ?>
</td>
                                            <?php endif; ?>
