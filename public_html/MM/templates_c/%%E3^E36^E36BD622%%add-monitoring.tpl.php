<?php /* Smarty version 2.6.26, created on 2013-08-28 04:16:08
         compiled from add-monitoring.tpl */ ?>
...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<h1><?php if ($_REQUEST['task_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> Monitoring Goal</h1>
...
?>
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Loggrosssales[]" id="new<?php echo ($this->_foreach['item']['iteration']-1)+1; ?>
" class="select req-string req-numeric" value="<?php echo $this->_tpl_vars['Tasks']['Loggrosssales']; ?>
"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">RO Count:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Logrocount[]" id="repeat<?php echo ($this->_foreach['item']['iteration']-1)+1; ?>
" class="select req-string req-numeric" value="<?php echo $this->_tpl_vars['Tasks']['Logrocount']; ?>
"/></td>
				</tr>
				<tr>
				  <td colspan="2"><hr /></td>
