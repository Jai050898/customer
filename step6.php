...
$smarty->assign('breadcrumb','Marketing Survey Step-6');
$usr 		= new General;
...
$marketingElementsDetailarr = $usr->GetAllWhere("tbl_marketing_elements","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	#set the values
	$customerMarketingElements['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_marketing_elements',$customerMarketingElements,"UserId = '".$_SESSION['User']['UID']."'");
