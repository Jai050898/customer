...
$smarty->assign('breadcrumb','Integrated Survey- Step10');
$usr 		= new General;

$businessCustomerDetailarr = $usr->GetAllWhere("tbl_survey_customer_profile","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$businessCustomerProfile['UserId'] = $_SESSION['User']['UID'];
	...
	$businessCustomerProfile['worstAdvertisingEfforts'] = $_POST['worstAdvertisingEfforts'];
	...
	if($_POST['isNew'])
	{
		$ins 	= $Gen->InsertQry('tbl_survey_customer_profile',$businessCustomerProfile);	
	}
	else
		$ins = $Gen->UpdateQry('tbl_survey_customer_profile',$businessCustomerProfile,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step11.php');
		exit;
...
$smarty->display('integrated-step10.tpl');
?>