...
$smarty->assign('breadcrumb','Website Survey- Competitive Advantages');
$usr 		= new General;

$competitiveAdvantagesInfoarr = $usr->GetAllWhere("web_tbl_competitive_advantages","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$competitiveAdvantages['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_competitive_advantages',$competitiveAdvantages,"UserId = '".$_SESSION['User']['UID']."'");
