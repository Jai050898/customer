<?php /* Smarty version 2.6.26, created on 2011-02-02 05:27:31
         compiled from manage-tasks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'manage-tasks.tpl', 24, false),array('modifier', 'base64_encode', 'manage-tasks.tpl', 26, false),array('modifier', 'count', 'manage-tasks.tpl', 35, false),)), $this); ?>
...
/client/add-tasks.php">Add Task</a></span>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" >
				<tr>
					...
					<td  bgcolor="#336699" style="color:#fff;"><strong>Cmts</strong></td>
...
?>
				<tr>
					...
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php if ($this->_tpl_vars['item']['priority'] == '1'): ?>Urgent<?php elseif ($this->_tpl_vars['item']['priority'] == '2'): ?>High Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '3'): ?>Mediun Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '4'): ?> Normal Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '5'): ?>Low Priority<?php elseif ($this->_tpl_vars['item']['priority'] == '6'): ?>Very Low Priority<?php else: ?>Whatever<?php endif; ?></td>
					<td bgcolor="#f9f9f7" style="color:#000000;"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['dead_line'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
					<td bgcolor="#f9f9f7"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/client/view-task.php?task_id=<?php echo $this->_tpl_vars['item']['task_id']; ?>
"><?php echo $this->_tpl_vars['item']['title']; ?>
</a></td>
					<td bgcolor="#f9f9f7"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/ajax.php?For=Comments&height=600&width=600&type=Cl&Id=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['task_id'])) ? $this->_run_mod_handler('base64_encode', true, $_tmp) : smarty_modifier_base64_encode($_tmp)); ?>
" class="thickbox" title="View Comments"><?php echo $this->_tpl_vars['item']['commentcount']; ?>
</a></td>
					<td bgcolor="#f9f9f7"><span class="progressBar" id="task_status<?php echo ($this->_foreach['item']['iteration']-1); ?>
"><?php echo $this->_tpl_vars['item']['task_status']; ?>
</span></td>
					<td bgcolor="#f9f9f7"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/client/add-tasks.php?task_id=<?php echo $this->_tpl_vars['item']['task_id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
					<td colspan="7" bgcolor="#f9f9f7"><font color="#FF0000">No Tacking Found</font></td>
				</tr>
