<?php /* Smarty version 2.6.26, created on 2011-02-01 12:49:33
...
" <?php if ($this->_tpl_vars['item']['user_id'] == $this->_tpl_vars['Tasks']['user_id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['first_name']; ?>
</option>
										<?php endforeach; endif; unset($_from); ?>
									</select></td>
				</tr>
