...
$smarty->assign('breadcrumb','Website Survey- Marketing');
$usr 		= new General;

$marketingInfoarr = $usr->GetAllWhere("web_tbl_marketing","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_marketing',$marketing,"UserId = '".$_SESSION['User']['UID']."'");
