...
$smarty->assign('breadcrumb','Marketing Survey Step-5');
$usr 		= new General;
...
$servicePracticesDetailarr = $usr->GetAllWhere("tbl_service_practices","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	#set the values
	$customerServicePractices['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_service_practices',$customerServicePractices,"UserId = '".$_SESSION['User']['UID']."'");
