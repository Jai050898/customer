...
$smarty->assign('breadcrumb','Add/Edit Project Tasks');
$usr 		= new General;
...
if(isset($_REQUEST['task_id']) && $_REQUEST['task_id'] != "" && $_REQUEST['hid_key']=='Post')
{
	...
	header("Location:".SITEURL.'/project-tracker.php');
	exit;
}
...
$Projects = $usr->GetSelWhere("tbl_projects","project_id,name","1=1 AND client_id = '".$_SESSION['User']['UID']."'");
