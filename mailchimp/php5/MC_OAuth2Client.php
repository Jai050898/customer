...
class MC_OAuth2Client extends OAuth2Client {
    ...
    public function __construct() {
        ...
        $base =  'marketingnavigator.info';   //your host
        //$path = '/home/navigato/public_html/mailchimp/php5/complete.php'; //the path on your host
         $path = '/mailchimp/php5/complete.php'; //the path on your host
		    
        $client_id = '185848230123';   //client_id from creating app in MC (see README)
        $client_secret = '690acd608bd771b6365f3c20873a459b'; //client_secret from creating app in MC  (see README)
