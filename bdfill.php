...
//echo getcwd();exit;
//vars and config
define ('CSVVEHICLES', '/home/navigato/public_html/files/Customers.csv');
set_time_limit(0);
$items = array ();
$i = 0;
$c = 0;
