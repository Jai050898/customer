...
$smarty->assign('breadcrumb','Integrated Survey- Step6');
$usr 		= new General;

$policyInfoarr = $usr->GetAllWhere("tbl_survey_policy","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$policy = array();
	$policy['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_policy',$policy,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step7.php');
		exit;
