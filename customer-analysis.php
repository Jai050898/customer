<?php
   ...
   // echo '<pre>';print_r($customersArray);exit;
    ...
    $allArray['years'][$j] = $i;
        ...
        // $custTotalClass = '';
        // $custArray  = array();
        // $Where1  = "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND YEAR(transaction_date) = '".$i."' GROUP BY cust_id";
        // $fields1 = "id";
        // $Table1  = "XML_ro";
        // $custArray  = $usr->GetSelWhere($Table1, $fields1, $Where1);
        ...
        $fields4 = "sum(laboramount+partsamount+taxamount+hazardwasteamount+shopsuppliesamount) as grossSales, sum(discountamount) as discountamount,SUM(manager_Charges) as managercharges";
        $Table4	= "XML_ro ";
        ...
        $allArray['managercharges'][$j] = $grossSaleArray['0']['managercharges'];
