...
require_once('/home/automark/public_html/customer/yousendit/sample/UserAPIs.php');
require_once('/home/automark/public_html/customer/yousendit/sample/StorageAPIs.php');
require_once('/home/automark/public_html/customer/yousendit/sample/FileTransfer.php');
require_once('/home/automark/public_html/customer/yousendit/sample/FolderShareSendAPIs.php');
...
function commitUpload(){
	...
	if (strlen($var0)==0){
		...
		if (!empty($current)){
			...
			$responseObject = $sendObj->sendFile($current,"pm4.rizecorp@yahoo.com");
                        //$responseObject = $sendObj->sendFile($current,"srinivas.rize@gmail.com");
                        //$responseObject = $sendObj->sendFile($current,$_SESSION['User']['Email']);
			//Code to Store data in Database
			$usr 		= new General;
			$InsArr = array();
			$InsArr['fileid']		= $current;
			$InsArr['uploader_id']	= $_SESSION['User']['UID'];
			$InsId					= $usr->InsertQry('tbl_large_uploads',$InsArr);
