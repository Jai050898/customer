...
function refresh(divname){
	$('#viewform').load('http://www.autorepairmarketing.com/customer/yousendit/sample/ui.php #'+divname);
}

function refreshActions(divnameActions, divnameLink, divnameTitle){
		$('#actions').load('http://www.autorepairmarketing.com/customer/yousendit/sample/ui.php #'+divnameActions);
		$('#link').load('http://www.autorepairmarketing.com/customer/yousendit/sample/ui.php #'+divnameLink);
		$('#title').load('http://www.autorepairmarketing.com/customer/yousendit/sample/ui.php #'+divnameTitle);		
}
...
function uploadForm(fileCount) {
		...
		$('#uploadf').ajaxSubmit({ 
		beforeSend: function(){
			$("#spinner").html('<img src="http://www.autorepairmarketing.com/customer/yousendit/sample/images/roller.gif" alt="Wait" />');
		},
		success: function(data) {
			//alert(data);
			$("#spinner").html('');
				...
				error: function(){
					if (i<n) {
						...
						if (document.getElementById('method').value == 'preparesend'){
							dostuff('commitsend','http://www.autorepairmarketing.com/customer/yousendit/sample/SendMethods.php',document.getElementById('token').value,document.getElementById('sendemailnotif').checked,document.getElementById('expiration').value,document.getElementById('bid1').value);
						}else {
							dostuff('commitupload','http://www.autorepairmarketing.com/customer/yousendit/sample/StoreMethods.php',document.getElementById('token').value,document.getElementById('parent').value,document.getElementById('bid1').value);
						}
						}
				},
				success: function(){
					...
					if (i<n) {
						...
						if (document.getElementById('method').value == 'preparesend'){
							...
							dostuff('commitupload','http://www.autorepairmarketing.com/customer/yousendit/sample/StoreMethods.php',document.getElementById('token').value,document.getElementById('parent').value,document.getElementById('bid1').value);
							//dostuff('sendfile','StoreMethods.php',document.getElementById('token').value,document.getElementById('fileid').value,"pm4.rizecorp@yahoo.com")
							//dostuff('commitsend','http://www.autorepairmarketing.com/customer/yousendit/sample/SendMethods.php',document.getElementById('token').value,document.getElementById('sendemailnotif').checked,document.getElementById('expiration').value,document.getElementById('bid1').value)
						}
						}
				}
