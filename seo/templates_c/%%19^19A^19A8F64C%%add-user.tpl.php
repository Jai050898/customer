<?php /* Smarty version 2.6.26, created on 2013-04-09 02:13:23
         compiled from add-user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'add-user.tpl', 43, false),)), $this); ?>
...
$this->_sections['list']['last']       = ($this->_sections['list']['iteration'] == $this->_sections['list']['total']);
?>
													<input type="checkbox" name="payment_type[]" id="payment_type" <?php if ($this->_tpl_vars['PTarray'] != '' && in_array ( $this->_tpl_vars['PT'][$this->_sections['list']['index']]['id'] , $this->_tpl_vars['PTarray'] )): ?> checked="checked" <?php endif; ?> value="<?php echo $this->_tpl_vars['PT'][$this->_sections['list']['index']]['id']; ?>
" />&nbsp;<?php echo $this->_tpl_vars['PT'][$this->_sections['list']['index']]['payment_type']; ?>
<br /><br />
												<?php endfor; endif; ?>
												</td>
											  </tr> 
...
$this->_sections['list']['last']       = ($this->_sections['list']['iteration'] == $this->_sections['list']['total']);
?>
													<input type="checkbox" name="language[]" id="language" <?php if ($this->_tpl_vars['LGarray'] != '' && in_array ( $this->_tpl_vars['LG'][$this->_sections['list']['index']]['id'] , $this->_tpl_vars['LGarray'] )): ?> checked="checked" <?php endif; ?> value="<?php echo $this->_tpl_vars['LG'][$this->_sections['list']['index']]['id']; ?>
" />&nbsp;<?php echo $this->_tpl_vars['LG'][$this->_sections['list']['index']]['languages']; ?>
<br /><br />
												<?php endfor; endif; ?>
...
$this->_sections['list']['last']       = ($this->_sections['list']['iteration'] == $this->_sections['list']['total']);
?>
													<input type="checkbox" name="services[]" id="services" <?php if ($this->_tpl_vars['KEYarray'] != '' && in_array ( $this->_tpl_vars['KEY'][$this->_sections['list']['index']]['key_id'] , $this->_tpl_vars['KEYarray'] )): ?> checked="checked" <?php endif; ?> value="<?php echo $this->_tpl_vars['KEY'][$this->_sections['list']['index']]['key_id']; ?>
" />&nbsp;<?php echo $this->_tpl_vars['KEY'][$this->_sections['list']['index']]['key_name']; ?>
<br /><br />
												<?php endfor; endif; ?>
...
$this->_sections['list']['last']       = ($this->_sections['list']['iteration'] == $this->_sections['list']['total']);
?>
													<input type="checkbox" name="brands[]" id="brands" <?php if ($this->_tpl_vars['Brandsarray'] != '' && in_array ( $this->_tpl_vars['Brands'][$this->_sections['list']['index']]['brand_id'] , $this->_tpl_vars['Brandsarray'] )): ?> checked="checked" <?php endif; ?> value="<?php echo $this->_tpl_vars['Brands'][$this->_sections['list']['index']]['brand_id']; ?>
" />&nbsp;<?php echo $this->_tpl_vars['Brands'][$this->_sections['list']['index']]['brand_name']; ?>
<br /><br />
												<?php endfor; endif; ?>
												</td>
											  </tr>
