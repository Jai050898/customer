<?php /* Smarty version 2.6.26, created on 2013-05-01 01:23:22
         compiled from print-view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'print-view.tpl', 32, false),array('modifier', 'nl2br', 'print-view.tpl', 48, false),)), $this); ?>
...
/seo/manage-users.php">Manage Users</a></li>
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['User']['last_name'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
						  ...
						  <tr class="color_trbg">
							...
							<td width="80%" align="left"><?php echo $this->_tpl_vars['User']['State_Name']; ?>
</td>
						  </tr>
						  <tr class="color_trbg">
							<td width="20%">City</td>
...
"><?php echo $this->_tpl_vars['User']['filename']; ?>
					...
					<tr>
					<td height="50" align="center" valign="top"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/seo/print.php?user_id=<?php echo $_REQUEST['user_id']; ?>
" target="_blank"><input type="button" name="Print" value="Print"  style="cursor:pointer;" /></a></td>
					</tr>
				</table>			  
			  <!--end of middle part -->
			  <!--end of right part -->
