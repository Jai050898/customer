<?php /* Smarty version 2.6.26, created on 2013-04-18 03:57:06
...
/seo/dashboard.php">Home</a></li>
							<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/seo/manage-competitors.php">Manage Competitors</a></li>
...
" /></td>
											...
											<tr class="color_trbg">
												<td>Phone</td>
												<td align="left"><input type="text" name="Log[phone]" id="phone" class="input req-string" value="<?php echo $this->_tpl_vars['User']['phone']; ?>
"/></td>
											 </tr>
											<tr class="color_trbg">
												<td>Website</td>
												<td align="left"><input type="text" name="Log[website]" id="website" class="input req-string" value="<?php echo $this->_tpl_vars['User']['website']; ?>
" /></td>
											</tr>
											<tr class="color_trbg">
												<td>Reviews</td>
												<td align="left"><input type="text" name="Log[reviews]" id="reviews" class="input req-numeric" value="<?php echo $this->_tpl_vars['User']['reviews']; ?>
" /></td>
											</tr>
											<tr class="color_trbg">
												<td>Verified</td>
