		...
		<div id="innerleft">
		  ...
		  <div class="ad_textsp">
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
					<td height="50" align="center" valign="top"><a href="{$siteurl}/seo/print.php?user_id={$smarty.request.user_id}" target="_blank"><input type="button" name="Print" value="Print"  style="cursor:pointer;" /></a></td>
					</tr>
				</table>			  
			  <!--end of middle part -->
			  <!--end of right part -->
