					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/seo/add-shopdata.php">Add Shop Data</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Users}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left"><a href="{$siteurl}/seo/add-shopdata.php?user_id={$item.user_id}" class="link023">Edit</a></td>
