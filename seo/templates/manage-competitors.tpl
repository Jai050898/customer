					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/seo/add-competitor.php?user_id={$smarty.request.user_id}">Add Competitor</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Users}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left">
											<a href="{$siteurl}/seo/add-competitor.php?id={$item.id}&user_id={$smarty.request.user_id}" class="link023"><img src="{$siteurl}/images/page_edit.png" title="Edit" alt="Edit" /></a> &nbsp;<a href="{$siteurl}/seo/compserp.php?user_id={$item.id}" class="link023"><img src="{$siteurl}/images/images.png" title="Compitetor Site" alt="Compitetor Site" /></a>
											</td>
										</tr>
									{foreachelse}
										<tr>
