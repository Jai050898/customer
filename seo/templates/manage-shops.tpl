					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/seo/add-shop.php">Add Shop</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Users}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left"><a href="{$siteurl}/seo/add-shop.php?user_id={$item.shop_id}" class="link023">Edit</a></td>
											<td align="left"><a href="opensearch.php?id={$item.shop_id}&type=g" target="_blank"><img src="{$siteurl}/images/google.png" /></a>&nbsp;<a href="{$siteurl}/seo/opensearch.php?id={$item.shop_id}&type=b" target="_blank"><img src="{$siteurl}/images/bing.png" /></a>&nbsp;<a href="opensearch.php?id={$item.shop_id}&type=y" target="_blank"><img src="{$siteurl}/images/yahoo.png" /></a></td>
										</tr>
									{foreachelse}
										<tr>
