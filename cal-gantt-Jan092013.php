...
<tr>
<td width="50%"><a href="http://marketingnavigator.info/cal-gantt.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $py;?>">Pre Year</a></td>
<td width="50%" align="right"><a href="http://marketingnavigator.info/cal-gantt.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $ny;?>">Next Year</a></td>
</tr>
</table>
...
$days1=getWeeks($y,$i);
$Fields 	= "*";
$Where 		= "customer_id  = '".$_SESSION['User']['UID']."' AND year = '".$y."' AND month = '".$i."'";
...
{ ?>
	<td height="30" colspan="<?php echo $days1;?>" align="center" valign="middle" bgcolor="#FFFFFF" style="font-size:12px;">NA</td>
<?php 
}
}
?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1"  style="font-size:14px; font-family:Arial, Helvetica, sans-serif;">
<tr>
<td width="50%" align="right"><a href="http://marketingnavigator.info/cal-gantt-day.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $_REQUEST['year'];?>">View Daily Gantt</a></td>
</tr>
</table>