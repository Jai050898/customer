...
$smarty->assign('breadcrumb','Integrated Survey- Step13');
$usr 		= new General;

$marketingLeadersDetailarr = $usr->GetAllWhere("tbl_survey_marketing_leaders","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_marketing_leaders',$customerMarketingLeaders,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step14.php');
		exit;
