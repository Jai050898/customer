...
$smarty->assign('breadcrumb','Edit Marketing Calendar Item');
$usr 		= new General;
...
//Code to get Items
$Items = $usr->GetSelWhere("tbl_calendars_items","*","1=1 AND status = 'A'  AND cal_id = '".$_REQUEST['id']."' ORDER BY sdate DESC");
