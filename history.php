...
$smarty->assign('breadcrumb','Website Survey- Business History');
$usr 		= new General;

$historyInfoarr = $usr->GetAllWhere("web_tbl_company_history","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_company_history',$companyHistory,"UserId = '".$_SESSION['User']['UID']."'");
