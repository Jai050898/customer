<?php
    ...
    for($i=$currentYear,$j=1;$i>=$lastYear;$i--){
        ...
        if($i == $currentYear) {
            $dataArray[$i]['comparativeGrossSale'] = $dataArray[$i]['grossSale'];
        } else {
            $dataArray[$i]['comparativeGrossSale'] = $dataArray[$i+1]['grossSale'] - $dataArray[$i]['grossSale'];
        }
...
//        $dataArray[$i]['comparativevariance']   = $compVariance1;
    ...
    $last12monthsavgVisits  = $last12monthsallVisitsCnt / $last12monthsVisitsCnt;
