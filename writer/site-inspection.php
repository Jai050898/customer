...
if(isset($_REQUEST['id']) && $_REQUEST['id'] != "")
{
	...
	$Cat	= $usr->GetSelWhere("tbl_site_inspection_writer",$Fields,$Where);
...
if(isset($_REQUEST['id']) && $_REQUEST['id'] != "" && $_REQUEST['hid_key']=='Post' && !empty($Cat)) 
{
	...
	$UpOverview 				= $Gen->UpdateQry("tbl_site_inspection_writer",$PrFields,"sid = ".$_REQUEST['id']);
	header("Location:".SITEURL.'/writer/manage-users.php');
	exit;
}
...
if(isset($_REQUEST['hid_key']) && $_REQUEST['hid_key']=='Post')
{
	...
	$ins 						= $Gen->InsertQry('tbl_site_inspection_writer',$PrFields);
	header("Location:".SITEURL.'/writer/manage-users.php');
}
