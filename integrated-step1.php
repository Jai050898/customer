...
$smarty->assign('breadcrumb','Integrated Survey- Step1');
$usr 		= new General;

$basicInfoDetailarr = $usr->GetAllWhere("tbl_survey_basic_information","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$customerBasicInfo['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_basic_information',$customerBasicInfo,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step2.php');
		exit;
