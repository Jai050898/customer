...
$smarty->assign('breadcrumb','Manage Links');
$usr 		= new General;
...
$Where		= " 1=1 AND show_to_customers = 'Y' AND status = 'A'";
if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!='')
{
	$Where .= " AND link_url like '%".$_REQUEST['keyword']."%'";	
}
$Table		= "tbl_links";
$Fields		= "link_id,link_url,code,show_to_customers,no_of_clicks,created_date,status";
