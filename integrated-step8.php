...
$smarty->assign('breadcrumb','Integrated Survey- Step8');
$usr 		= new General;

$basicInfoDetailarr = $usr->GetAllWhere("tbl_survey_marketing_info","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$marketingBasicInfo['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_marketing_info',$marketingBasicInfo,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step9.php');
		exit;
