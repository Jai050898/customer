...
{	
	...
	$upid	= $Gen->UpdateQry('tbl_requests',$upar,"id IN(".$_REQUEST['hid_id'].")");
}
$Where		= "1=1 AND status != 'D'";
//echo "<pre>";print_r($_REQUEST);exit;
if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!='')
{
	$Where .= " AND keyword like '%".$_REQUEST['keyword']."%' OR domain like '%".$_REQUEST['keyword']."%' OR city like '%".$_REQUEST['keyword']."%' OR state like '%".$_REQUEST['keyword']."%'";	
}
...
//echo "<pre>";print_r($Users);exit;
$smarty->display('manage-requests.tpl');
?>