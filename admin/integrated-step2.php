...
$historyInfoarr = $usr->GetAllWhere("tbl_survey_company_history","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_company_history',$companyHistory,"UserId = '".$_REQUEST['id']."'");

		header('location:integrated-step3.php?id='.$_REQUEST['id']);
		exit;
