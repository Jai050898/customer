<?php
    ...
    if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!='') {
            $Where .= " AND S.schedulecustomer like '%".$_REQUEST['keyword']."%' OR V.name like '%".$_REQUEST['keyword']."%' OR S.scheduleextid like '%".$_REQUEST['keyword']."%' OR S.estimatedhours like '%".$_REQUEST['keyword']."%'";	
    }
