...
$companyDetailarr = $usr->GetAllWhere("web_tbl_basic_information","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$companyBasicInfo['UserId'] = $_REQUEST['id'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_basic_information',$companyBasicInfo,"UserId = '".$_REQUEST['id']."'");

	header('location:history.php?id='.$_REQUEST['id']);
	exit;
}	
