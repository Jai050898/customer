...
$businessProfileDetailarr = $usr->GetAllWhere("tbl_survey_business_profile","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$customerBusinessProfile['UserId'] = $_REQUEST['id'];
	...
	$delaff = $usr->DeleteQry("tbl_survey_affiliation","UserId = '".$_REQUEST['id']."'");
	...
	//code to delete affiliate
	$delass = $usr->DeleteQry("tbl_survey_association","UserId = '".$_REQUEST['id']."'");
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_business_profile',$customerBusinessProfile,"UserId = '".$_REQUEST['id']."'");

		header('location:integrated-step4.php?id='.$_REQUEST['id']);
		exit;
