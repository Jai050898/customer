...
<tr>
<td><a href="http://www.marketingnavigator.info/admin/cal-gantt-day.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $py;?>&user_id=<?php echo $_REQUEST['user_id'];?>">Pre Year</a></td>
<td><a href="http://www.marketingnavigator.info/admin/cal-gantt-day.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $ny;?>&user_id=<?php echo $_REQUEST['user_id'];?>">Next Year</a></td>
</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1"  style="font-size:14px; font-family:Arial, Helvetica, sans-serif;">
<tr>
<td width="50%" align="left"><a href="http://www.marketingnavigator.info/admin/cal-gantt.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $_REQUEST['year'];?>&user_id=<?php echo $_REQUEST['user_id'];?>">View Weekly Gantt</a></td>
</tr>
</table>