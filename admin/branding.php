...
$brandingInfoarr = $usr->GetAllWhere("web_tbl_branding","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_branding',$branding,"UserId = '".$_REQUEST['id']."'");

		header('location:policy.php?id='.$_REQUEST['id']);
		exit;
