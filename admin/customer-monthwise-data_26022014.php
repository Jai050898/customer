<?php
    ...
    for($i=1;$i<=12;$i++){
         ...
         // Total RO's
        $Where2		= "1=1 AND company_id = '".$_REQUEST['user_id']."' AND YEAR(transaction_date) = '".$year."' AND MONTH(transaction_date) = '".$i."'";
        $Table2		= "XML_ro ";
        ...
        $Where3		= "1=1 AND company_id = '".$_REQUEST['user_id']."' AND YEAR(transaction_date) = '".$year."' AND MONTH(transaction_date) = '".$i."'";
