...
$Table		= "tbl_users A LEFT JOIN tbl_country B ON A.country = B.Country_Code LEFT JOIN tbl_states C ON A.country = C.Country_Code AND A.state = C.State_ID";
$Fields		= "A.user_id,A.first_name,A.last_name,A.email,A.user_name,A.company_name,A.phone,A.country,A.state,A.city,A.status,A.login_status,A.access_to_mark_survey,A.access_to_site_survey,A.access_to_integrated_survey,B.Country_Name,C.State_Name";
