...
$servicesInfoarr = $usr->GetAllWhere("tbl_survey_services","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_services',$services,"UserId = '".$_REQUEST['id']."'");

		header('location:integrated-step12.php?id='.$_REQUEST['id']);
		exit;
