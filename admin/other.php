...
$otherInfoarr = $usr->GetAllWhere("web_tbl_other_info","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_other_info',$othersInfo,"UserId = '".$_REQUEST['id']."'");
	
	
		header('location:website-survey.php?user_id='.$_REQUEST['id']);
		exit;
