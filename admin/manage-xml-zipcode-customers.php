<?php
    ...
    $Where  = "1=1 AND zip != '' AND zip != '-1' AND zip!= '1 -'";
    ...
    $Table		= "XML_customers";
    $Fields1            = "id";
    $Fields		= "zip, city, count( id ) AS Ccount, company_id";
...
$Where		.= " ORDER BY ".$SortBy." LIMIT ".$offset.",".$limit;
    ...
    for($i=0;$i<$cnt;$i++) {
        ...
        $totalCustArray = $usr->GetSelWhere("XML_customers","cust_id","zip = '".$Users[$i]['zip']."' AND company_id = '".$Users[$i]['company_id']."' GROUP BY cust_id");
        ...
        $Where3		= "1=1 AND company_id = '".$Users[$i]['company_id']."' AND YEAR(transaction_date) = '".$currentYear."' AND cust_id IN (".$custIds.")";
        ...
        $Where4		= "1=1 AND company_id = '".$Users[$i]['company_id']."' AND cust_id IN (".$custIds.")";
        ...
        $Where5		= "1=1 AND company_id = '".$Users[$i]['company_id']."' AND cust_id IN (".$custIds.") AND YEAR(transaction_date) < '".$currentYear."'";
        $fields5            = "cust_id";
        $Table5		= "XML_ro ";
        ...
        if(!empty($totalCustsSpentVisitedThisYear)){
            ...
            $Where6		= " 1=1 AND company_id = '".$Users[$i]['company_id']."' AND YEAR(transaction_date) = '".$currentYear."' AND cust_id IN (".$custIdsVisitedThisYear.")";
	...
	$Clients = $usr->GetSelWhere("tbl_users","user_id,xml_id,company_name"," status = 'A' AND is_staff= 'N' ");
