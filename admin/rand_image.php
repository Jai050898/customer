<?php
/*********************************************************************
  Author      : Primaccess Technolgies. 
  Date 	      : 
  Modified On : 
  Description :  random image code
**********************************************************************/
session_start();
...
$size = 20;
/*
imagestring ($image, $size, 60, 22,  $letter1, $textColor1); 
imagestring ($image, $size, 60, 22,  $letter2, $textColor2); 
imagestring ($image, $size, 60, 22,  $letter3, $textColor3); 
imagestring ($image, $size, 60, 22,  $letter4, $textColor4); 
imagestring ($image, $size, 60, 22,  $letter5, $textColor5); 
*/
