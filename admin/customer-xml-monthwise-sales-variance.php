<?php
    ...
    for($y=$year;$y>$limit;$y--) {
        for($i=1;$i<=12;$i++){
            ...
            $Where3		= "1=1 AND company_id = '".$_REQUEST['user_id']."' AND YEAR(transaction_date) = '".$y."' AND MONTH(transaction_date) = '".$i."'";
    ...
    $smarty->display('customer-xml-monthwise-sales-variance.tpl');
