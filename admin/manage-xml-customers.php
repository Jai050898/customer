...
//    }
    ...
    if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!='') {
            $Where .= " AND A.lname like '%".$_REQUEST['keyword']."%' OR A.fname like '%".$_REQUEST['keyword']."%' OR A.email like '%".$_REQUEST['keyword']."%'";
    }
    ...
    if(isset($_REQUEST['user_id']) && $_REQUEST['user_id'] != '') {
            $Where .= " AND A.company_id = '".$_REQUEST['user_id']."'";
    }
    if(isset($_REQUEST['cust_id']) && $_REQUEST['cust_id'] != '') {
            $Where .= " AND A.cust_id = '".$_REQUEST['cust_id']."'";
    }
   ...
   // echo "<prE>";print_r($Users);exit;
    ...
    $srcpath 	= "user_id=".$_REQUEST['user_id']."&keyword=".$_REQUEST['keyword']."&city=".$_REQUEST['city']."&zip=".$_REQUEST['zip']."&sortby=".$_REQUEST['sortby']."&sortoption=".$_REQUEST['sortoption']."&page=";
    ...
    //Code to get Clients
    $Clients = $usr->GetSelWhere("tbl_users","user_id,first_name,company_name, xml_id"," status = 'A' AND is_staff= 'N' ");
