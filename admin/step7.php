...
$usr 		= new General;
$marketingLeadersDetailarr = $usr->GetAllWhere("tbl_marketing_leaders","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_marketing_leaders',$customerMarketingLeaders,"UserId = '".$_REQUEST['id']."'");

		header('location:marketing-survey.php?user_id='.$_REQUEST['id']);
		exit;
