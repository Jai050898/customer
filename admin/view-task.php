...
if(isset($_REQUEST['task_id']) && $_REQUEST['task_id'] != "")
{
	...
	$Fields		= "A.task_id,A.project_id,A.user_id,A.priority,A.context,A.dead_line,A.title,A.description,A.task_status,A.status,A.created_Date,B.name,COUNT(D.comment_id) as commentcount";
