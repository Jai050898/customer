		...
		<input type="hidden" name="sortoption" value="{$smarty.request.sortoption}" />
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <td align="right"><a href="{$siteurl}/admin/add-revenue.php">Add Revenue</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('annual_revenue','{$sortioption}',document.ManageCat);">Annual Revenue</a> {if $smarty.request.sortby eq 'annual_revenue'}<img src="../images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
				...
				<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
				  ...
				  <td align="left">{$item.annual_revenue}</td>
				  ...
				  <td align="left"><a href="{$siteurl}/admin/add-languages.php?id={$item.id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
