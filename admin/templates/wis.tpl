					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/admin/add-wis.php?user_id={$smarty.request.user_id}">Add What if Scenarios</a></td>
							</tr>
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Tasks}
										...
										<td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="{$item.id}"/></td>
											...
											<td align="left">
											<a href="{$siteurl}/admin/edit-wis.php?id={$item.id}&user_id={$smarty.request.user_id}" class="link023"><img src="{$siteurl}/images/edit.png" border="0" title="Edit" alt="Edit" /></a>
											</td>
										</tr>
									{foreachelse}
										<tr>
										  <th width="100%" align="center" colspan="12"><font color="#FF0000"><strong>No What if Scenarios Added</strong></font></th>
										</tr>
									{/foreach}
								  </table>
								</td>
