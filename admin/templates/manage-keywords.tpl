		...
		<input type="hidden" name="sortoption" value="{$smarty.request.sortoption}" />
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <td align="right"><a href="{$siteurl}/admin/add-keyword.php">Add Keyword</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('key_name','{$sortioption}',document.ManageCat);">Keyword Name</a> {if $smarty.request.sortby eq 'key_name'}<img src="../images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
				...
				<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
				  <td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="{$item.key_id}"/></td>
				  <td align="left">{$item.key_name}</td>
				  ...
				  <td align="left"><a href="{$siteurl}/admin/add-keyword.php?key_id={$item.key_id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
