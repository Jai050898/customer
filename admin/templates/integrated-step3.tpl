		...
		<div id="contentpane">
			...
			<div id="innerleft">
			  <div class="admin-rightpart">
					...
					<div class="ad_textsp">
						<form name="frmStepTwo" id="frmStepTwo" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step3.php?id={$smarty.request.id}">
