		...
		<div id="contentpane">
			...
			<div id="innerleft">
			  <div class="admin-rightpart">
					...
					<div class="ad_textsp">
						<form name="frmCompetitiveAdvantages" id="frmCompetitiveAdvantages" method="post" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step12.php?id={$smarty.request.id}">
