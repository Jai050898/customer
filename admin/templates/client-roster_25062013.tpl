					...
					<tr>
					  <td align="left" valign="top" >
						  ...
						  <tr class="color_trbg">
							...
							<td>{$item.first_name|stripslashes} {$item.last_name|stripslashes}</td>
							<td>{$item.city|stripslashes}</td>
							<td>{$item.State_Name|stripslashes}</td>
							<td>{$item.phone|stripslashes}</td>
							<td>{$item.website|stripslashes}</td>
						  </tr>
						  {foreachelse}
							<tr>
