								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Tasks}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left" bgcolor="#{$item.color}">&nbsp;</td>
											...
											<td align="left">
											<a href="{$siteurl}/admin/calendars-cat.php?cat_id={$item.id}&act=del&user_id={$smarty.request.user_id}" class="link023"><img src="{$siteurl}/images/del.png" border="0" title="Delete" alt="Delete" /></a>
											</td>
										</tr>
									{foreachelse}
										<tr>
