						...
						<td align="left" valign="top" >
							...
							<input type="hidden" name="hid_key" id="hid_key" value="">
								<table width="100%" cellspacing="0" cellpadding="0" class="addadmin_box01">
                                 ...
                                 {section name=totallist loop=$Cate_portfolio}
                                     {if $Cate_portfolio[totallist].cat_name neq ''}
                                     <option value="{$Cate_portfolio[totallist].cat_id}">{$Cate_portfolio[totallist].cat_name}</option>{/if}
                                 {/section}
                                 </select>
									 </td>
									</tr>
