                                                    ...
                                                    <td align="left" valign="top" colspan="2">
                                                      <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
                                                            <tr>
                                                                    ...
                                                                    <th width="17%" align="left"><a href="javascript: setClientSort('fname','{$sortioption}',document.ManageXMLCustomers);">Customer Name</a> {if $smarty.request.sortby eq 'fname'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
                                                                    ...
                                                                    <th width="10%" align="left"><a href="javascript: setClientSort('Vcount','{$sortioption}',document.ManageXMLCustomers);">Total Vehicles</a> {if $smarty.request.sortby eq 'Vcount'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}</a></th>
                                                                    <th width="10%" align="left"><a href="javascript: setClientSort('Vcount','{$sortioption}',document.ManageXMLCustomers);">Total Repair Orders</a> {if $smarty.request.sortby eq 'Rcount'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}</a></th>
                                                                    <th width="10%" align="left"><a href="javascript: setClientSort('distance','{$sortioption}',document.ManageXMLCustomers);">Distance</a> {if $smarty.request.sortby eq 'distance'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}</a></th>
                                                            </tr>
                                                            {foreach item=item name=item from=$Users}
                                                                <tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
                                                                        ...
                                                                        <td align="left"><a href="{$siteurl}/admin/view-xml-customer.php?user_id={$item.cust_id}">{if $item.lname neq '' && $item.fname neq ''}{$item.fname} {$item.lname}{else}-N/A-{/if}</a></td>
