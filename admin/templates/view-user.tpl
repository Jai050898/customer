					...
					<tr>
					  <td align="left" valign="top" >
						  ...
						  <tr class="color_trbg">
							...
							<td width="80%" align="left">{if $User.State_Code neq ""}{$User.State_Code}{else}{$User.State_Name}{/if}</td>
						  </tr>
						  <tr class="color_trbg">
							<td width="20%">City</td>
						...
						<tr class="color_trbg">
						  ...
						  <tr class="color_trbg">
							...
							<td align="left">{$User.shop_labor_rate}</td>
						  </tr>
						  <tr class="color_trbg">
							<td>No of Technicians</td>
							<td align="left">{$User.no_of_technicians}</td>
						  </tr>
										   
						  <tr class="color_trbg">
							<td>No of Advisors</td>
							<td align="left">{$User.no_of_advisors}</td>
						  </tr>
						  <tr class="color_trbg">
							<td>sq ft of shop (entire)</td>
							<td align="left">{$User.sq_ft_of_shop}</td>
						  </tr>
						<tr class="color_trbg">
						 ...
						 <tr class="color_trbg">
						  ...
						  <tr class="color_trbg">
							<td>Birthday </td>
							<td align="left">{$User.dob|date_format:"%m-%d-%Y"}</td>
						  </tr> 
						  <tr class="color_trbg">
