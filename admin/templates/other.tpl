		...
		<div id="contentpane">
			...
			<div id="innerleft">
			  <div class="admin-rightpart">
					...
					<div class="ad_textsp">
						<form name="frmOthers" id="frmOthers" method="post" class="fValidator-form" onsubmit="return validateForm();" action="other.php?id={$smarty.request.id}">
...
<br />
					...
					<textarea name="GarageManagement" rows="3" cols="50" class="form">{$otherInfo.GarageManagement}</textarea>
</td>
					<td colspan="2">&nbsp;</td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					...
					{html_options name='CollectEmailAddress' options=$arrayYesNo1 selected=$otherInfo.CollectEmailAddress}
</td>
					<td colspan="2">&nbsp;</td>
				  </tr>
				  <tr>
