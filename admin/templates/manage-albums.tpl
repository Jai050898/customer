		...
		<input type="hidden" name="sortoption" value="{$smarty.request.sortoption}" />
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <td align="right"><a href="{$siteurl}/admin/add-album.php">Add Album</a></td>
			</tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('album_name','{$sortioption}',document.ManageCat);">Album Name</a> {if $smarty.request.sortby eq 'album_name'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
				...
				<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
				  <td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="{$item.album_id}"/></td>
				  <td align="left"><a href="{$siteurl}/admin/view-album.php?album_id={$item.album_id}">{$item.album_name}</a>&nbsp; <strong>(<a href="{$siteurl}/admin/manage-album-photos.php?album={$item.album_id}">{$item.totphotos}</a>)</strong></td>
				  ...
				  <td align="left"><a href="{$siteurl}/admin/add-album.php?album_id={$item.album_id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
