				 ...
				 <tr>
				  ...
				  <tr>
					...
					<td align="left" style="padding-bottom:10px" valign="middle">Please list your 3 common best periods (months) : 
					  ...
					  <input type="text" name="MonthFrequentCustomer" id="MonthFrequentCustomer" maxlength="100" size="40" class="form" value="{$businessCustomerDetail.MonthFrequentCustomer}" />
					  </td>
				  ...
				  <tr>
					...
					<td align="left" style="padding-bottom:10px" valign="middle">Please list your 3 common slow periods (months) : 
					  ...
					  <input type="text" name="MonthLessCustomer" id="MonthLessCustomer" maxlength="100" size="40" class="form" value="{$businessCustomerDetail.MonthLessCustomer}" />
					  </td>
				  ...
				  <tr>
					...
					<td align="left" style="padding-bottom:10px" valign="middle">What is the top 3 most profitable services you sell ? <br />
					  ...
					  <textarea name="ServiceCustBuyMost" id="ServiceCustBuyMost" rows="3" cols="40">{$businessCustomerDetail.ServiceCustBuyMost}</textarea>
					  </td>
...
<tr>
					...
					<td align="left" style="padding-bottom:10px" valign="middle">What are the 3 least profitable services you sell ? <br />
					  ...
					  <textarea name="ServiceCustBuyLeast" id="ServiceCustBuyLeast" rows="3" cols="40">{$businessCustomerDetail.ServiceCustBuyLeast}</textarea>
					  </td>
				  ...
				  <tr>
					...
					<input type="text" name="worstAdvertisingEfforts" id="worstAdvertisingEfforts" maxlength="100" size="40" class="form" value="{$businessCustomerDetail.worstAdvertisingEfforts}"/></td>
