                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="left" valign="top" >
                                <table width="100%" cellspacing="0" cellpadding="0" class="addadmin_box01">
                                    <tr>
                                          <td colspan="2"><h2>LIFETIME SPENDING TOTAL: ${$User.total_extendedsale}</h2></td>
                                    </tr>
                                    <tr class="color_trbg">
                                    ...
                                    {foreach item=item name=item key = k from=$RODetails}
                                      ...
                                      <tr class="color_trbg">
                                            ...
                                            <td width="80%" align="left">${$item.unitcost}</td>
                                      </tr>
                                      <tr class="color_trbg">
                                            <td width="20%">Unit Sale</td>
                                            <td width="80%" align="left">${$item.unitsale}</td>
                                      </tr>
                                      <tr class="color_trbg">
                                            <td width="20%">Extended Cost</td>
                                            <td width="80%" align="left">${$item.extendedcost}</td>
                                      </tr>
                                      <tr class="color_trbg">
                                            <td width="20%">Extended Sale</td>
                                            <td width="80%" align="left">${$item.extendedsale}</td>
                                      </tr>
                                      <tr class="color_trbg">
