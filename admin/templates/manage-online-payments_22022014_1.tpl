                                                        ...
                                                        <div class="bodybg" style="min-height:475px;">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#fff">
                                                             <tr>				
                                                                ...
                                                                <tr>
                                                                    <th width="35%" align="left">Invoice Number</th>
                                                                    <th width="35%" align="left">Amount( in $)</th>
                                                                <th align="center" width="35%" colspan="3">Action</th>
                                                                </tr>
...
<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
                                                                    ...
                                                                    <td align="center"><a href='manage-online-payments.php?action=del&id={$allInvoice[invoice].id}'><img src="../images/delete.png" border="0" alt="Delete" title="Delete"/></a>&nbsp;&nbsp;&nbsp;<a href='editInvoice.php?action=edit&id={$allInvoice[invoice].id}'><img src="../images/page_edit.png" border="0" alt="Edit" title="Edit"/></a>&nbsp;&nbsp;&nbsp;<a href='manage-online-payments.php?action=generateLink&id={$allInvoice[invoice].id}'><img src="../images/link.jpeg" border="0" alt="Generate Link" title="Generate Link"/></a></td>
                                                               </tr>
                                                                    {sectionelse}
                                                                <tr>
