...
<ul>
		...
		<li><a href="http://validator.w3.org/unicorn/check?ucn_uri={$domain}&ucn_task=conformance#" target="_blank" id="linkid">http://validator.w3.org/unicorn/check?ucn_uri={$domain}&ucn_task=conformance# </a></li>
		<li><a href="http://www.sitetrail.com/{$domain}" target="_blank" id="linkid">http://www.sitetrail.com/{$domain}</a></li>
		<!-- <li><a href="http://www.woorank.com/en/www/{$host}" target="_blank">http://www.woorank.com/en/www/{$host}</a></li> -->
		<li><a href="http://www.alexa.com/siteinfo/{$domain}" target="_blank" id="linkid">http://www.alexa.com/siteinfo/{$domain}</a></li>
		<!-- <li><a href="http://www.quantcast.com/{$domain}" target="_blank">http://www.quantcast.com/{$domain}</a></li> -->
		...
		<!-- <li><a href="http://uitest.com/en/check/results/?uri={$domain}" target="_blank">http://uitest.com/en/check/results/?uri={$domain}</a></li>
		
		<li><a href="http://www.yelp.com/biz/{$dword1}-{$city}" target="_blank">http://www.yelp.com/biz/{$dword1}-{$city}</a></li> -->
		<li><a href="http://www.merchantcircle.com/search?q={$dword}&qn={$city}+{$state}" target="_blank" id="linkid">http://www.merchantcircle.com/search?q={$dword}
		&qn={$city}+{$state} </a></li>
