					...
					<div class="admin_topbgnav">
						  <div id="admin_bcrumb">
							  <ul>
								  ...
								  <li><a href="{$siteurl}/admin/manage-brands-cat.php">Manage Brand Category</a></li>
								  <li>{if $smarty.request.id neq ""}Edit{else}Add{/if} Brand Category</li>
							  </ul>
						  	<div class="clr"></div>
						  </div>
						<div id="admin_head">{if $smarty.request.id neq ""}Edit{else}Add{/if} Brand Category</div>
					  </div>
					<div class="ad_textsp">
							  ...
							  <td align="left" valign="top" >
								...
								<input type="hidden" name="hid_key" id="hid_key" value="">
									<table width="100%" cellspacing="0" cellpadding="0" class="addadmin_box01">
										<tr>
											<td colspan="2"><h2>{if $smarty.request.id neq ""}Edit{else}Add{/if} Brand Category</h2></td>
										  </tr>
										<tr class="color_trbg">
