					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/admin/export-mms-data.php" target="_blank">Generate Report</a>&nbsp;&nbsp;<a href="{$siteurl}/admin/client-roster.php" target="_blank">All Clients Roster</a>&nbsp;&nbsp;<a href="{$siteurl}/admin/add-user.php">Add User</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
										...
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<a href="{$siteurl}/admin/users-daily-data.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/data-server.png" title="MIS Users Daily Data" alt="MIS Users Daily Data" /></a>
                                                                                        ...
                                                                                        {if in_array($item.user_id, $mmsAry)}
                                                                                            <a href="{$siteurl}/admin/manage-xml-customers.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/viewmmsdata.png" title="View MMS Data" alt="View MMS Data" /></a>
                                                                                        {/if}
											</td>
										</tr>
									{foreachelse}
