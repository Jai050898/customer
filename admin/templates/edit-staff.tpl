		...
		<div id="contentpane">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td><input type="password" name="Log[password]" id="Log[password]"  class="input req-string" value="{$password}"/></td>				
                                </tr>
				...
				{if $error neq ""}
                        ...
                        {/if}
                        {if $smarty.request.res neq ""}
                            <tr class="color_trbg">
                            <td colspan="2" style="color:#00FF00;text-align:center">{$smarty.request.res}</td>
                            </tr>
                        {/if}
			</table>
			<div class="clear"></div>
