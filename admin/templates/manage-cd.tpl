		...
		<input type="hidden" name="sortoption" value="{$smarty.request.sortoption}" />
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <td align="right"><a href="{$siteurl}/admin/add-cd.php">Add Confirmed Directories</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="30%" align="left"><a href="javascript: setClientSort('name','{$sortioption}',document.ManageCat);">Name</a> {if $smarty.request.sortby eq 'name'}<img src="../images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
				...
				<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
				  ...
				  <td align="left"> {if $item.payment eq "Y"} YES {else} NO {/if}</td>
				  ...
				  <td align="left"><a href="{$siteurl}/admin/add-cd.php?id={$item.id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
