										...
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											{if in_array($item.user_id, $mmsAry)}
                                                                                            ...
                                                                                            {/if}
                                                                                             ...
                                                                                             {if in_array($item.user_id, $mmsAry)}
                                                                                            <a href="{$siteurl}/admin/top-ten-vehicles.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/vehicles.gif" title="Top Ten Vehicles" alt="Top Ten Vehicles" /></a>
                                                                                            {/if}
                                                                                             

                                                                                             {if in_array($item.user_id, $mmsAry)}
                                                                                            <a href="{$siteurl}/admin/ro-calculations.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/Calculator.png" title="RO Calculations" alt="RO Calculations" /></a>
                                                                                            {/if}

                                                                                             {if in_array($item.user_id, $mmsAry)}
                                                                                            <a href="{$siteurl}/admin/gross-sale-weekwise-report.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/cal-week.gif" title="Week Wise Gross sale" alt="Week Wise Gross sale" /></a>
                                                                                            {/if}

                                                                                             {if in_array($item.user_id, $mmsAry)}
                                                                                            <a href="{$siteurl}/admin/gross-sale-daywise-report.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/calendar_day.png" title="Day Wise Gross sale" alt="Day Wise Gross sale" /></a>
                                                                                            {/if}
