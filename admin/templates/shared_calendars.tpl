					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/admin/cal-user.php?user_id={$smarty.request.user_id}">My Calendars</a></td>
							</tr>
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Tasks}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left">
											<a href="{$siteurl}/shared-cal.php?id={$item.id}&act=del&user_id={$smarty.request.user_id}" class="link023"><img src="{$siteurl}/images/del.png" border="0" title="Delete" alt="Delete" /></a>
											</td>
										</tr>
									{foreachelse}
										<tr>
