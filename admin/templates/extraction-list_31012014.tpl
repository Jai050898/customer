								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="16%" align="left">Customer Name</th>
										...
										<th width="6%" align="left">RO Total ({$lastYear})</th>
                                                                                ...
                                                                                <th width="2%" align="left">&nbsp;</th>
                                                                                <th width="10%" align="left">Avg. Customer lifetime value</th>
                                                                                <th width="2%" align="left">&nbsp;</th>
                                                                                <th width="9%" align="left">12 mo lifespan</th>
                                                                                <th width="2%" align="left">&nbsp;</th>
                                                                                <th width="8%" align="left">Total lifespan</th>
                                                                                <th width="1%" align="left">&nbsp;</th>
                                                                                <th width="8%" align="left">Total Emails</th>
                                                                                <th width="2%" align="left">&nbsp;</th>
									...
									{foreach item=item name=item from=$Users}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="right" >{$item.custTotalLastYear|number_format:0:".":","}</td>
                                                                                        ...
                                                                                        <td>&nbsp;</td>
                                                                                        <td align="right" >{$item.LastVisitedCustEmailCnt|number_format:0:".":","}</td>
                                                                                        <td>&nbsp;</td>
										</tr>
									{foreachelse}
										<tr>
