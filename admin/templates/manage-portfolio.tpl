		...
		<input type="hidden" name="sortoption" value="{$smarty.request.sortoption}" />
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <td align="right"><a href="{$siteurl}/admin/add-portfolio.php">Add Portfolio</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="35%" align="left"><a href="javascript: setClientSort('project_name','{$sortioption}',document.ManagePortfolio);">Project Name</a> {if $smarty.request.sortby eq 'project_name'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
				  <th width="20%" align="left">Status </th>
				  <th width="25%" align="left"><a href="javascript: setClientSort('created_date','{$sortioption}',document.ManagePortfolio);">Crated Date </a> {if $smarty.request.sortby eq 'created_date'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle" />{/if}</th>
				...
				<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
				  ...
				  <td align="left"><a href="{$siteurl}/admin/view-portfolio.php?portfolio_id={$item.id}" class="link023">View</a>&nbsp; | &nbsp;<a href="{$siteurl}/admin/add-portfolio.php?portfolio_id={$item.id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
			...
			<tr>
			  <td colspan="2"><table width="100%" cellspacing="0" cellpadding="5">
				...
				<td  align="right"  bgcolor="#854141">.{$first}.<div style="float:right; padding-right:5px;">{if $first neq ""}{$first}{/if}{if $prev neq ""}{$prev}{/if}{if $nav neq ""}{$nav}{/if}{if $next neq ""}{$next}{/if}{if $last neq ""}{$last}{/if}</div></td>
				</tr>
				</table>
				</td>
                </tr>
