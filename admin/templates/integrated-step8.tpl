					...
					<div class="admin_topbgnav">
					  <div id="admin_bcrumb">
						  <ul>
							...
							<li>Basic Marketing Info</li>
						  </ul>
						<div class="clr"></div>
					  </div>
				 	<div id="admin_head">Basic Marketing Info</div>
				  </div>
					<div class="ad_textsp">
						<form name="frmStepOne" id="frmStepOne" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step8.php?id={$smarty.request.id}">
...
selected=$basicInfoDetail.MarketSegment separator="<br />" id="MarketSegment"}
				  ...
				  <tr>
					<td align="left" style="padding-bottom:10px; padding-left:25px" valign="top">
					{html_checkboxes name="FuelSource" values=$fuellSourceIndexArray output=$fuellSourceStrArray
selected=$basicInfoDetail.FuelSource separator="<br />" id="FuelSource"}
...
<span class="infoText">(Please enter exact percentage value, e.g. enter 30 in case the value is 30%) </span>																			</td>
				  ...
				  <tr>
					...
					<input type="text" name="DetailTracking" id="DetailTracking" maxlength="150" size="40" class="form" value="{$basicInfoDetail.DetailTracking}" /> 
</td>
					<td colspan="2">&nbsp;</td>
				  </tr>	
				  <tr>
