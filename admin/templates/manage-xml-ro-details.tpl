									...
									{foreach item=item name=item from=$Users}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left"><a href="{$siteurl}/admin/manage-xml-vehicles.php?vid={$item.vehicle_id}">{$item.name}</td>
                                                                                        ...
                                                                                        <td align="left">${$item.unitcost|number_format:2:".":","}</td>
											<td align="left">${$item.unitsale|number_format:2:".":","}</td>
											<td align="left" >${$item.extendedcost|number_format:2:".":","}</td>
                                                                                        <td align="left" >${$item.extendedsale|number_format:2:".":","}</td>
