                                    ...
                                    <div>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="month-tab-market"  bgcolor="#754141">
                                                ...
                                                <th width="20%" height="30"  align="left" valign="top">
                                                    ...
                                                    <tr>
                                                    {foreach item=item name=item from=$allArray.comparitiveGrossSale|number_format:2:".":","}
                                                    <td height="36"  align="center" valign="middle"  bgcolor="#f9f9f7" style="color:#000000;">{if $item neq 0.00}${$item}{/if}</td>
                                                    {/foreach}
                                                    </tr>
