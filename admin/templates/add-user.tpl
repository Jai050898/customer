										...
										<table width="100%" cellspacing="0" cellpadding="0" class="addadmin_box01">
											...
											<tr class="color_trbg">
											  ...
											  <tr class="color_trbg">
												...
												<td width="88%" align="left">
													<input type="text" name="Log[user_name]" id="user_name" class="input req-string" value="{$User.user_name}" {if $smarty.request.user_id neq ""} onBlur="javascript:fnCheckUnameAvailEdit('user_name',this.value,'uiddiv',{$smarty.request.user_id});" {else} onBlur="javascript:fnCheckUnameAvail('user_name',this.value,'uiddiv');" {/if}/><br /><span id="uiddiv" style="padding-left:5px; color:red"></span>
												 </td>
											  </tr>
											{if $smarty.request.user_id eq ""}
												<tr class="color_trbg">
											...
											<tr class="color_trbg">
												...
												<td align="left"><input type="text" name="Log[garage_mgmt_software_version]" id="garage_mgmt_software_version" class="input " value="{$User.garage_mgmt_software_version}"/></td>
											  </tr>
                                                                                          <tr class="color_trbg">
