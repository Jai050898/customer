	...
	<div id="mainbody">
       ...
       <!--                                                                                      <a href="{$siteurl}/admin/manage-permission.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/menu_permission.gif" title="MenuPermission" alt="MenuPermission" /></a>&nbsp; -->
											    ...
											    {if in_array($item.user_id, $mmsAry)}
                                                                                            ...
                                                                                            {/if}
                                                                                             <a href="{$siteurl}/admin/manage-permission.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/menu_permission.gif" title="MenuPermission" alt="MenuPermission" /></a>&nbsp;
                                                                                             <a href="{$siteurl}/admin/notification_mail.php?user_id={$item.user_id}" class="link023"><img src="{$siteurl}/images/mail_notification.png" title="Notification Mail" alt="Notification Mail" height="18px" width="18px" /></a>&nbsp;
