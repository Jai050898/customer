		...
		<div id="contentpane">
			...
			<div id="innerleft">
			  <div class="admin-rightpart">
					...
					<div class="ad_textsp">
						<form name="frmAboutCompany" id="frmAboutCompany" method="post" class="fValidator-form" onsubmit="return validateForm();" action="companyDetail.php?id={$smarty.request.id}">
