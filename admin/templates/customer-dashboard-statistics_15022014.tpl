...
<div class="admin_nav" style="float:right;font-weight:bold;">
    <a href="{$siteurl}/admin/new-xml-customers.php?&user_id={$smarty.request.user_id}&fdate={$todayDate}&tdate={$todayDate}">New Customer Report</a></div>
</div>
...
<div id="body">
    <div class="bodybg" style="min-height:475px;">
        <div>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#854141">
                <tr>
                    <th bgcolor="#854141" style="color:#fff;"><a href="{$siteurl}/admin/customer-xml-monthwise-sales-variance.php?user_id={$smarty.request.user_id}" title="Monthwise Sales Variance">Year</a></th>
