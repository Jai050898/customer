      ...
      <div id="admin_head">Marketing Budget for {$Cal.year}</div>
	   ...
	   <div class="ad_textsp">
			...
			<tr style="background-color:{cycle values='#ffffff,#ffffff'};">
				<td>{$item1.title}</td>
				<td>$ {$item1.amount|number_format:2:".":","}</td>
				<td>$ {$item1.actual_amount|number_format:2:".":","}</td>
			</tr>
			{/foreach}
			{/if}
			{/foreach}
			<tr style="background-color:#f3f3f3;">
				...
				<td><strong>$ {$Cal.gsales|number_format:2:".":","}</strong></td>
				<td><strong>$ {$Cal.gsales|number_format:2:".":","}</strong></td>
			</tr>
			<tr style="background-color:#f3f3f3;">
				<td><strong>Total</strong></td>
				<td><strong>$ {$Cal.amount|number_format:2:".":","}</strong></td>
				<td><strong>$ {$Cal.actualamount|number_format:2:".":","}</strong></td>
			</tr>
			<tr style="background-color:#f3f3f3;">
