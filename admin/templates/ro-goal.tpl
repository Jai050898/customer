					...
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/admin/add-ro-goal.php?user_id={$smarty.request.user_id}">Add RO Goal</a></td>
							</tr>
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Tasks}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left">{$item.newval}</td>
											<td align="left">{$item.repeatval}</td>
											...
											<td align="left">
											<a href="{$siteurl}/admin/edit-ro-goal.php?id={$item.id}&user_id={$smarty.request.user_id}" class="link023"><img src="{$siteurl}/images/edit.png" border="0" title="Edit" alt="Edit" /></a>
											</td>
										</tr>
									{foreachelse}
										<tr>
