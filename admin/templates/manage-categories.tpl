...
<div id="bodypart">
      ...
      <div id="admin_head">Manage Survey</div>
      </div>
	  <div class="ad_textsp">
		...
		<input type="hidden" name="sortoption" value="{$smarty.request.sortoption}" />
			...
			<tr>
			 ...
			 <tr>
			  ...
			  <td align="right"><a href="{$siteurl}/admin/add-category.php">Add Survey</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				...
				<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
				  ...
				  <td align="left">{if $smarty.foreach.item.first}<a href="{$siteurl}/admin/manage-categories.php?act=down&id={$item.cat_id}&order={$item.showorder}"><img src="{$siteurl}/images/arrow_down.png" /></a>{elseif $smarty.foreach.item.last}<a href="{$siteurl}/admin/manage-categories.php?act=up&id={$item.cat_id}&order={$item.showorder}"><img src="{$siteurl}/images/arrow_up.png" /></a>{else}<a href="{$siteurl}/admin/manage-categories.php?act=down&id={$item.cat_id}&order={$item.showorder}"><img src="{$siteurl}/images/arrow_down.png" /></a>&nbsp;&nbsp;<a href="{$siteurl}/admin/manage-categories.php?act=up&id={$item.cat_id}&order={$item.showorder}"><img src="{$siteurl}/images/arrow_up.png" /></a>{/if}</td>
				  <td align="left">{$item.showorder}</td>
				  <td align="left"><a href="{$siteurl}/admin/view-category.php?cat_id={$item.cat_id}">{$item.cat_name}</a></td>
				  ...
				  <td align="left"><a href="{$siteurl}/admin/add-category.php?cat_id={$item.cat_id}" class="link023">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
