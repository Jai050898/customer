<?php /* Smarty version 2.6.26, created on 2013-05-18 04:18:03
         compiled from manage-cd.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-cd.tpl', 59, false),array('modifier', 'date_format', 'manage-cd.tpl', 92, false),array('function', 'cycle', 'manage-cd.tpl', 86, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      <li>Manage Confirmed Directories</li>
     
      </ul>
      <div class="clr"></div>
      </div>
      <div id="admin_head">Manage Confirmed Directories</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Confirmed Directories</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-cd.php">Add Confirmed Directories</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="30%" align="left"><a href="javascript: setClientSort('name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Name</a> <?php if ($_REQUEST['sortby'] == 'name'): ?><img src="../images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
				  <th width="15%" align="left">Payment </th>
...
"/></td>
				  ...
				  <td align="left"> <?php if ($this->_tpl_vars['item']['payment'] == 'Y'): ?> YES <?php else: ?> NO <?php endif; ?></td>
				  <td align="left"> <?php echo $this->_tpl_vars['item']['amount']; ?>
</td>
...
/admin/add-cd.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Confirmed Directories Added</strong></font></th>
				</tr>
