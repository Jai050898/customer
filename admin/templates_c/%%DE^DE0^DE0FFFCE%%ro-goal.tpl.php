<?php /* Smarty version 2.6.26, created on 2012-12-29 08:13:59
         compiled from ro-goal.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'ro-goal.tpl', 47, false),array('modifier', 'date_format', 'ro-goal.tpl', 50, false),array('modifier', 'count', 'ro-goal.tpl', 66, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
								  <li>Users RO Goals</li>
							  </ul>
							<div class="clr"></div>
						</div>
						<div id="admin_head">Manage RO Goals</div>
				  </div>
				  <div class="ad_textsp">
...
" />
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td><h2>Manage RO Goals</h2></td>
							  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-ro-goal.php?user_id=<?php echo $_REQUEST['user_id']; ?>
">Add RO Goal</a></td>
							</tr>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="30%" align="left">Month</th>
										<th width="30%" align="left">New</th>
										<th width="30%" align="left">Repeat</th>
...
;">
											...
											<td align="left"><?php echo $this->_tpl_vars['item']['newval']; ?>
</td>
											<td align="left"><?php echo $this->_tpl_vars['item']['repeatval']; ?>
</td>
...
/admin/edit-ro-goal.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
...
/images/edit.png" border="0" title="Edit" alt="Edit" /></a>
									...
									<?php endforeach; else: ?>
										<tr>
										  <th width="100%" align="center" colspan="7"><font color="#FF0000"><strong>No Users Calendars Categories Added</strong></font></th>
										</tr>
