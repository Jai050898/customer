<?php /* Smarty version 2.6.26, created on 2013-06-18 02:54:52
         compiled from manage-projects.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-projects.tpl', 53, false),array('modifier', 'date_format', 'manage-projects.tpl', 88, false),array('function', 'cycle', 'manage-projects.tpl', 81, false),)), $this); ?>
...
/admin/add-project.php">Add Project</a></td>
			</tr>
			 <tr>
...
<?php endif; ?>" class="searchinput" /> <input type="image" src="../images/go_but.png" onclick="document.ManageProjects.submit();" /> 
			 <div class="clr"></div>
			  </div></td>
			</tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="25%" align="left"><a href="javascript: setClientSort('A.name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageProjects);">Project Name</a> <?php if ($_REQUEST['sortby'] == 'A.name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
				  <th width="15%" align="left">Customer</th>
				  <th width="15%" align="left">Project Status </th>
				  <th width="10%" align="left"><a href="javascript: setClientSort('totaltasks','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageProjects);">Tasks</a> <?php if ($_REQUEST['sortby'] == 'totaltasks'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
				  <th width="10%" align="left">Status </th>
				  <th width="15%" align="left"><a href="javascript: setClientSort('A.created_date','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageProjects);">Crated Date </a> <?php if ($_REQUEST['sortby'] == 'A.created_date'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
 ...
 <?php echo $this->_tpl_vars['item']['last_name']; ?>
				  ...
				  <td align="left"><?php if ($this->_tpl_vars['item']['project_status'] == '1'): ?><font color="#00CC33">New</font><?php elseif ($this->_tpl_vars['item']['project_status'] == '2'): ?><font color="#0000FF">Proposal</font><?php elseif ($this->_tpl_vars['item']['project_status'] == '3'): ?><font color="#00EEFF">In Progress</font><?php elseif ($this->_tpl_vars['item']['project_status'] == '4'): ?><font color="#00ff00">Completed</font><?php else: ?><font color="#FF0000">Cancelled</font><?php endif; ?></td>
				  <td align="left"><?php echo $this->_tpl_vars['item']['totaltasks']; ?>
</td>
				  ...
				  <td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-project.php?project_id=<?php echo $this->_tpl_vars['item']['project_id']; ?>
