<?php /* Smarty version 2.6.26, created on 2011-02-17 06:12:44
...
">Website survey</a></li>
				 	...
				 	<div id="admin_head">Basic Company Information</div>
				  </div>
					<div class="ad_textsp">
						<form name="frmAboutCompany" id="frmAboutCompany" method="post" class="fValidator-form" onsubmit="return validateForm();" action="companyDetail.php?id=<?php echo $_REQUEST['id']; ?>
">
