<?php /* Smarty version 2.6.26, created on 2013-09-10 06:08:45
         compiled from manage-xml-recommendations.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-xml-recommendations.tpl', 46, false),array('modifier', 'nl2br', 'manage-xml-recommendations.tpl', 50, false),array('modifier', 'date_format', 'manage-xml-recommendations.tpl', 51, false),array('modifier', 'count', 'manage-xml-recommendations.tpl', 62, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
								  <li>Manage MMS Recommendations</li>
							  </ul>
							<div class="clr"></div>
						</div>
						<div id="admin_head">Manage MMS Recommendations</div>
				  </div>
				  <div class="ad_textsp">
...
" />
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td><h2>Manage MMS Recommendations</h2></td>
							  <td align="right">&nbsp;</td>
							</tr>
							<tr>
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="17%" align="left">Customer Name</th>
										<th width="17%" align="left">Vehicle</th>
										<th width="10%" align="left">Recommended Text</th>
										<th width="10%" align="left">Recommendation Date</th>
										<th width="10%" align="left">FollowUp Date</th>
									</tr>
...
"><?php if ($this->_tpl_vars['item']['fullname'] != ''): ?><?php echo $this->_tpl_vars['item']['fullname']; ?>
<?php else: ?>-N/A-<?php endif; ?></a></td>
                                                                                    <td align="left" style="padding-right:15px;"> <?php echo $this->_tpl_vars['item']['name']; ?>
</td>
                                                                                    <td align="left"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['rec_text'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td>
                                                                                    <td align="left" ><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['rec_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d/%y") : smarty_modifier_date_format($_tmp, "%m/%d/%y")); ?>
</td>
                                                                                    <td align="left" ><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['dt_follow_update'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d/%y") : smarty_modifier_date_format($_tmp, "%m/%d/%y")); ?>
</td>
                                                                            </tr>
									<?php endforeach; else: ?>
                                                                            <tr>
