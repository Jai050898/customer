<?php /* Smarty version 2.6.26, created on 2013-02-27 05:51:54
         compiled from manage-mis-zipcode-customers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-mis-zipcode-customers.tpl', 63, false),array('modifier', 'count', 'manage-mis-zipcode-customers.tpl', 77, false),)), $this); ?>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="17%" align="left"><a href="javascript: setClientSort('MIS_Zip','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMISCustomers);">Zip Code</a> <?php if ($_REQUEST['sortby'] == 'MIS_Zip'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
if ($this->_foreach['item']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['item']['iteration']++;
?>
										<?php if ($this->_tpl_vars['item']['MIS_Zip'] != ""): ?>
...
;">
											...
											<td align="left"><?php echo $this->_tpl_vars['item']['MIS_Zip']; ?>
</td>
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-mis-customers.php?zip=<?php echo $this->_tpl_vars['item']['MIS_Zip']; ?>
