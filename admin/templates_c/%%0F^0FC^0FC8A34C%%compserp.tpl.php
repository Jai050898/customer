<?php /* Smarty version 2.6.26, created on 2013-04-29 05:32:16
         compiled from compserp.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'compserp.tpl', 44, false),array('modifier', 'date_format', 'compserp.tpl', 70, false),)), $this); ?>
...
/seo/manage-users.php">Manage Users</a></li>
			  ...
			  <div id="admin_head">Competitors SERPs</div>
		  </div>
		  <div class="ad_textsp">
		  <table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td  colspan="2">
								...
								<td align="left"><?php echo ((is_array($_tmp=$this->_tpl_vars['CustInfo']['name'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
								<td style="width:150px;">&nbsp;</td>
								<td align="right"><strong>Website :</strong></td>
								<td align="left"><?php echo $this->_tpl_vars['CustInfo']['website']; ?>
</td>
								<td style="width:150px;">&nbsp;</td>
								...
								<td align="left"><?php echo $this->_tpl_vars['CustInfo']['zip']; ?>
</td>
								</tr>
								</table>
							  </td>
