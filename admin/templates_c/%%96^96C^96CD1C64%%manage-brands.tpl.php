<?php /* Smarty version 2.6.26, created on 2013-05-14 03:31:28
         compiled from manage-brands.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-brands.tpl', 59, false),array('modifier', 'stripslashes', 'manage-brands.tpl', 89, false),array('modifier', 'date_format', 'manage-brands.tpl', 93, false),array('function', 'cycle', 'manage-brands.tpl', 87, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      ...
      <div id="admin_head">Manage Brands</div>
      </div>
	  <div class="ad_textsp">
...
/admin/add-brand.php">Add Brands</a></td>
			</tr>
			 <tr>
			  <td  colspan="2"><div class="search_divbox">
			  <select name="cid" id="cid" class="searchinput">
...
" <?php if ($_REQUEST['cid'] == $this->_tpl_vars['item']['id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['name']; ?>
</option>
...
<?php endif; ?>" class="searchinput" /> <input type="image" src="../images/go_but.png" onclick="document.ManageCat.submit();" /> 
			...
			<tr>
			  <td colspan="2"><table width="100%" cellspacing="0" cellpadding="5">
				...
				<input name="input2" type="button"  value="Export" onclick="javascript:SetStatus(document.ManageCat,'E','chkall[]');"/>
				</td>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('brand_name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Name</a> <?php if ($_REQUEST['sortby'] == 'brand_name'): ?><img src="../images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
				  <th width="15%" align="left">Categoty </th>
				  <th width="15%" align="left">Export </th>
				  <th width="15%" align="left">Status </th>
				  <th width="25%" align="left"><a href="javascript: setClientSort('created_date','<?php echo $this->_tpl_vars['sortioption']; ?>
...
;">
				  <td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['brand_id']; ?>
"/></td>
				  <td align="left"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['brand_name'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
				  <td align="left"><?php if ($this->_tpl_vars['item']['catname'] != ""): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['catname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php else: ?>NA<?php endif; ?></td>
				  <td align="left"><?php if ($this->_tpl_vars['item']['export'] == 'Y'): ?><font color="#00CC33">YES</font><?php else: ?><font color="#FF0000">NO</font><?php endif; ?></td>
...
/admin/add-brand.php?brand_id=<?php echo $this->_tpl_vars['item']['brand_id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Brands Added</strong></font></th>
				</tr>
