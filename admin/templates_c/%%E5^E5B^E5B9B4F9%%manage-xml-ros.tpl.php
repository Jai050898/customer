<?php /* Smarty version 2.6.26, created on 2013-10-24 09:32:13
         compiled from manage-xml-ros.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-xml-ros.tpl', 40, false),array('modifier', 'date_format', 'manage-xml-ros.tpl', 75, false),array('modifier', 'number_format', 'manage-xml-ros.tpl', 76, false),array('function', 'cycle', 'manage-xml-ros.tpl', 69, false),)), $this); ?>
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										<!-- <th width="4%" align="left"><input type="checkbox" name="checkall" id="checkall" onclick="javascript:funCheckAll(document.ManageMMSCustomers,'chkall[]','checkall');" /></th> -->
                                                                                <th width="8%" align="left"><a href="javascript: setClientSort('R.ro_id','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMMSCustomers);">RO Id</a> <?php if ($_REQUEST['sortby'] == 'ro_id'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										...
										<th width="10%" align="left">Odometer In / OUT</th>
                                                                                <th width="10%" align="left"><a href="javascript: setClientSort('R.transaction_date','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMMSCustomers);">Transaction Date</a> <?php if ($_REQUEST['sortby'] == 'R.transaction_date'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?></th>
										<th width="10%" align="left"><a href="javascript: setClientSort('R.transactiontotal','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMMSCustomers);">Transaction Total</a> <?php if ($_REQUEST['sortby'] == 'R.transactiontotal'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?></th>
									</tr>
...
/admin/manage-xml-ro-details.php?ro_id=<?php echo $this->_tpl_vars['item']['ro_id']; ?>
"><?php echo $this->_tpl_vars['item']['ro_id']; ?>
</a></td>
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-xml-customers.php?cust_id=<?php echo $this->_tpl_vars['item']['cust_id']; ?>
"><?php echo $this->_tpl_vars['item']['fullname']; ?>
</a></td>
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-xml-vehicles.php?vid=<?php echo $this->_tpl_vars['item']['vehicle_id']; ?>
"><?php echo $this->_tpl_vars['item']['name']; ?>
</td>
                                                                                        <td align="left"><?php echo $this->_tpl_vars['item']['odometerin']; ?>
 / <?php echo $this->_tpl_vars['item']['odometerout']; ?>
</td>
											<td align="left"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['transaction_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d/%y") : smarty_modifier_date_format($_tmp, "%m/%d/%y")); ?>
</td>
											<td align="left" >$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['transactiontotal'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
