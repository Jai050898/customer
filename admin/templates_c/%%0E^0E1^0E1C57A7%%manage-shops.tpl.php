<?php /* Smarty version 2.6.26, created on 2013-03-18 02:53:52
         compiled from manage-shops.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-shops.tpl', 58, false),array('modifier', 'stripslashes', 'manage-shops.tpl', 60, false),array('modifier', 'count', 'manage-shops.tpl', 77, false),)), $this); ?>
...
/admin/add-shop.php">Add Shop</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
...
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="15%" align="center"><a href="javascript: setClientSort('shop_email','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageUsers);">Email </a> <?php if ($_REQUEST['sortby'] == 'shop_email'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
/admin/view-user.php?user_id=<?php echo $this->_tpl_vars['item']['shop_id']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['shop_name'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</a></td>
											<td align="right" style="padding-right:15px;"> <?php echo $this->_tpl_vars['item']['shop_email']; ?>
</td>
											<td align="left"><?php echo $this->_tpl_vars['item']['shop_phone']; ?>
</td>
											<td align="left" ><?php echo $this->_tpl_vars['item']['shop_state']; ?>
</td>
											<td align="left" ><?php echo $this->_tpl_vars['item']['shop_city']; ?>
</td>
											...
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-shop.php?user_id=<?php echo $this->_tpl_vars['item']['shop_id']; ?>
" class="link023">Edit</a></td>
											<td align="left"><a href="opensearch.php?id=<?php echo $this->_tpl_vars['item']['shop_id']; ?>
&type=g" target="_blank"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/google.png" /></a>&nbsp;<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/opensearch.php?id=<?php echo $this->_tpl_vars['item']['shop_id']; ?>
&type=b" target="_blank"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/bing.png" /></a>&nbsp;<a href="opensearch.php?id=<?php echo $this->_tpl_vars['item']['shop_id']; ?>
&type=y" target="_blank"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/yahoo.png" /></a></td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
