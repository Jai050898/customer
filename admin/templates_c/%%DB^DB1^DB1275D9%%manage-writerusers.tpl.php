<?php /* Smarty version 2.6.26, created on 2013-06-18 02:45:09
         compiled from manage-writerusers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-writerusers.tpl', 48, false),array('function', 'cycle', 'manage-writerusers.tpl', 89, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
								  <li>Manage Writer Users</li>
							  </ul>
							<div class="clr"></div>
						</div>
						<div id="admin_head">Manage Writer Users</div>
				  </div>
				  <div class="ad_textsp">
...
" />
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td><h2>Manage Writer Users</h2></td>
							  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-writeruser.php">Add Writer User</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
...
',document.ManageUsers);">Customer Name</a> <?php if ($_REQUEST['sortby'] == 'A.first_name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="25%" align="left"><a href="javascript: setClientSort('A.email','<?php echo $this->_tpl_vars['sortioption']; ?>
...
"/></td>
 ...
 <?php echo $this->_tpl_vars['item']['last_name']; ?>
											...
											<td align="left" ><?php if ($this->_tpl_vars['item']['State_Code'] != ""): ?><?php echo $this->_tpl_vars['item']['State_Code']; ?>
<?php else: ?><?php echo $this->_tpl_vars['item']['State_Name']; ?>
<?php endif; ?></td>
...
/admin/resendmail_seouser.php?user_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
...
/images/email.png" title="Resend Welcome notification mail" alt="Resend Welcome notification mail" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-seouser.php?user_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/page_edit.png" title="Edit" alt="Edit" /> </a>
									...
									<?php endforeach; else: ?>
										<tr>
										  <th width="100%" align="center" colspan="7"><font color="#FF0000"><strong>No Writer Users Added</strong></font></th>
										</tr>
