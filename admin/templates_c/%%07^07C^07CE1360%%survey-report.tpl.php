<?php /* Smarty version 2.6.26, created on 2012-11-16 01:30:16
         compiled from survey-report.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'survey-report.tpl', 33, false),)), $this); ?>
...
/admin/view-survey.php?user_id=<?php echo $_REQUEST['user_id']; ?>
&survey_id=<?php echo $this->_tpl_vars['item']['cat_id']; ?>
"><?php echo $this->_tpl_vars['item']['cat_name']; ?>
</a>&nbsp;&nbsp;<?php if ($this->_tpl_vars['item']['completed'] == 'Y'): ?>(<font color="#0000FF">Completed&nbsp;&nbsp;<a href="export_survey.php?uid=<?php echo $_REQUEST['user_id']; ?>
&sid=<?php echo $this->_tpl_vars['item']['cat_id']; ?>
">Export Survey</a></font>)<?php endif; ?></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
