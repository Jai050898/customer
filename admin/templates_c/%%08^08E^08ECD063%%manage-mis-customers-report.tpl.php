<?php /* Smarty version 2.6.26, created on 2013-01-25 01:58:37
         compiled from manage-mis-customers-report.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-mis-customers-report.tpl', 65, false),array('modifier', 'count', 'manage-mis-customers-report.tpl', 81, false),)), $this); ?>
...
" <?php if ($_REQUEST['user_id'] == $this->_tpl_vars['item']['user_id']): ?> selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['first_name']; ?>
</option>
...
<?php endif; ?>" class="searchinput" />
									...
									<div class="search_divbox">
									<label style="float:left; margin-right:10px;"><strong>Years</strong> :</label> <label style="float:left; margin-right:5px;"><strong>From</strong></label><input type="text" name="yearfrom" id="yearfrom" value="<?php if ($_REQUEST['yearfrom'] != ""): ?><?php echo $_REQUEST['yearfrom']; ?>
<?php endif; ?>" class="searchinput"  /><label style="float:left; margin-right:5px;"><strong>To</strong></label><input type="text" name="yearto" id="yearto" value="<?php if ($_REQUEST['yearto'] != ""): ?><?php echo $_REQUEST['yearto']; ?>
<?php endif; ?>" class="searchinput" />
									<input type="image" src="../images/go_but.png" onclick="document.ManageMISCustomers.submit();"  /> &nbsp;&nbsp;&nbsp;
								 	<div class="clr"></div>
								</div>
...
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="10%" align="left"><a href="javascript: setClientSort('MIS_LifetimeVisits','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMISCustomers);">Life Time Visits </a> <?php if ($_REQUEST['sortby'] == 'MIS_LifetimeVisits'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
"><?php echo $this->_tpl_vars['item']['MIS_lastname']; ?>
 <?php echo $this->_tpl_vars['item']['MIS_firstname']; ?>
											...
											<td align="left" style="padding-right:15px;"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-mis-ros.php?user_id=<?php echo $this->_tpl_vars['item']['MIS_cust_ID']; ?>
"><?php echo $this->_tpl_vars['item']['MIS_LifetimeVisits']; ?>
</a></td>
											<td align="left"><?php echo $this->_tpl_vars['item']['MIS_FirstVisited']; ?>
</td>
											<td align="left"><?php echo $this->_tpl_vars['item']['MIS_LastVisited']; ?>
</td>
											<td align="left" ><?php echo $this->_tpl_vars['item']['duration']; ?>
 Days</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
