<?php /* Smarty version 2.6.26, created on 2012-11-02 06:45:44
...
/dashboard.php">Home</a></li>
		...
		<ul style="list-style-type:upper-roman; padding-left:50px; padding-bottom:10px;">
				...
				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step1.php?id=<?php echo $_REQUEST['user_id']; ?>
" style="text-decoration:none">About The Company</a></li>

				

				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step2.php?id=<?php echo $_REQUEST['user_id']; ?>
" style="text-decoration:none">Your Company History</a></li>

	

				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step3.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Company Profile</a></li>				

				

				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step4.php?id=<?php echo $_REQUEST['user_id']; ?>
" style="text-decoration:none">About The Stuff</a></li>

			

				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step5.php?id=<?php echo $_REQUEST['user_id']; ?>
" style="text-decoration:none">Branding</a></li>

	

				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step6.php?id=<?php echo $_REQUEST['user_id']; ?>
" style="text-decoration:none">Policies</a></li>

	

				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step7.php?id=<?php echo $_REQUEST['user_id']; ?>
" style="text-decoration:none">Notoriety</a></li>

				

				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step8.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Basic Marketing Info</a></li>



				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step9.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Marketing / Advertising Opportunties</a></li>



				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step10.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Customer Profile</a></li>



				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step11.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Service Practices</a></li>
				...
				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step12.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Marketing / Advertising Elements</a></li>



				<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step13.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Marketing / Advertising Leaders</a></li>

				

				<li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/integrated-step14.php?id=<?php echo $_REQUEST['user_id']; ?>
...
/admin/integrated-step1.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Click here</a> and Start filling out the form now.
