<?php /* Smarty version 2.6.26, created on 2011-02-17 06:40:52
         compiled from policy.tpl */ ?>
...
">Website survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmPolicy" id="frmPolicy" method="post" class="fValidator-form" onsubmit="return validateForm();" action="policy.php?id=<?php echo $_REQUEST['id']; ?>
">
