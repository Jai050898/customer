<?php /* Smarty version 2.6.26, created on 2013-05-13 01:10:08
         compiled from manage-languages.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-languages.tpl', 53, false),array('modifier', 'date_format', 'manage-languages.tpl', 82, false),array('function', 'cycle', 'manage-languages.tpl', 78, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      ...
      <div id="admin_head">Manage Languages</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Languages</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-languages.php">Add Languages</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('languages','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Languages</a> <?php if ($_REQUEST['sortby'] == 'languages'): ?><img src="../images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
"/></td>
				  <td align="left"><?php echo $this->_tpl_vars['item']['languages']; ?>
</td>
...
" class="link023">Edit</a></td>
				...
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Languages Added</strong></font></th>
				</tr>
