<?php /* Smarty version 2.6.26, created on 2013-06-18 03:22:22
         compiled from manage-links.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-links.tpl', 48, false),array('modifier', 'base64_encode', 'manage-links.tpl', 80, false),array('modifier', 'date_format', 'manage-links.tpl', 82, false),array('function', 'cycle', 'manage-links.tpl', 77, false),)), $this); ?>
...
/admin/add-link.php">Add Link</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="35%" align="left"><a href="javascript: setClientSort('link_url','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageLinks);">Link</a> <?php if ($_REQUEST['sortby'] == 'link_url'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="15%" align="left"><a href="javascript: setClientSort('no_of_clicks','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageLinks);">No Of Clicks <?php if ($_REQUEST['sortby'] == 'no_of_clicks'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?></th>
...
;">
										<td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['link_id']; ?>
"/></td>
										<td align="left"><a href="<?php echo $this->_tpl_vars['item']['link_url']; ?>
" target="_blank"><?php echo $this->_tpl_vars['item']['link_url']; ?>
</a></td>
										<td align="left"><?php if ($this->_tpl_vars['item']['no_of_clicks'] != '0'): ?><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-stats.php?link_id=<?php echo $this->_tpl_vars['item']['link_id']; ?>
...
" class="link023"><?php echo $this->_tpl_vars['item']['no_of_clicks']; ?>
</a><?php else: ?>0<?php endif; ?></td>
										<td align="left"><?php echo $this->_tpl_vars['item']['code']; ?>
</td>
...
/admin/add-link.php?link_id=<?php echo $this->_tpl_vars['item']['link_id']; ?>
" class="link023">Edit</a>&nbsp;<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-stats.php?link_id=<?php echo $this->_tpl_vars['item']['link_id']; ?>
&url=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['link_url'])) ? $this->_run_mod_handler('base64_encode', true, $_tmp) : smarty_modifier_base64_encode($_tmp)); ?>
" class="link023">Statistics</a></td>
									</tr>
									<?php endforeach; else: ?>
									<tr>
