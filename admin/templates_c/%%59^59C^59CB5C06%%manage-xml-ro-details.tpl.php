<?php /* Smarty version 2.6.26, created on 2013-10-25 01:16:10
         compiled from manage-xml-ro-details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-xml-ro-details.tpl', 41, false),array('modifier', 'number_format', 'manage-xml-ro-details.tpl', 79, false),array('function', 'cycle', 'manage-xml-ro-details.tpl', 73, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
                                                                  <li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-xml-ros.php">Manage MMS RO's</a></li>
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
                                                                                        ...
                                                                                        <td align="left"><?php echo $this->_tpl_vars['item']['transactiondetailextid']; ?>
</td>
                                                                                        <td align="left"><?php echo $this->_tpl_vars['item']['unitquantity']; ?>
</td>
                                                                                        <td align="left">$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['unitcost'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
											<td align="left">$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['unitsale'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
											<td align="left" >$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['extendedcost'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
                                                                                        <td align="left" >$<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['extendedsale'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, ".", ",") : number_format($_tmp, 2, ".", ",")); ?>
</td>
                                                                                        <td align="left" ><?php echo $this->_tpl_vars['item']['laborhours']; ?>
</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
