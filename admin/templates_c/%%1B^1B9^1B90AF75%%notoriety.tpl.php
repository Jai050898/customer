<?php /* Smarty version 2.6.26, created on 2011-02-17 06:41:18
         compiled from notoriety.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_checkboxes', 'notoriety.tpl', 54, false),)), $this); ?>
...
">Website survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmNotoriey" id="frmNotoriey" method="post" class="fValidator-form" onsubmit="return validateForm();" action="notoriety.php?id=<?php echo $_REQUEST['id']; ?>
">
