<?php /* Smarty version 2.6.26, created on 2013-05-13 01:11:15
         compiled from manage-revenue.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-revenue.tpl', 53, false),array('modifier', 'date_format', 'manage-revenue.tpl', 82, false),array('function', 'cycle', 'manage-revenue.tpl', 78, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      <li>Manage Revenue</li>
     
      </ul>
      <div class="clr"></div>
      </div>
      <div id="admin_head">Manage Revenue</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Revenue</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-revenue.php">Add Revenue</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('annual_revenue','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Annual Revenue</a> <?php if ($_REQUEST['sortby'] == 'annual_revenue'): ?><img src="../images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
"/></td>
				  <td align="left"><?php echo $this->_tpl_vars['item']['annual_revenue']; ?>
</td>
...
/admin/add-languages.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Annual Revenue Added</strong></font></th>
				</tr>
