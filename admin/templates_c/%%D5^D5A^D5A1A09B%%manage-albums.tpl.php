<?php /* Smarty version 2.6.26, created on 2013-05-13 01:08:42
         compiled from manage-albums.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-albums.tpl', 54, false),array('modifier', 'date_format', 'manage-albums.tpl', 83, false),array('function', 'cycle', 'manage-albums.tpl', 79, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      ...
      <div id="admin_head">Manage Albums</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Albums</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-album.php">Add Album</a></td>
			</tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('album_name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Album Name</a> <?php if ($_REQUEST['sortby'] == 'album_name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
;">
				  <td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['album_id']; ?>
"/></td>
				  <td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-album.php?album_id=<?php echo $this->_tpl_vars['item']['album_id']; ?>
"><?php echo $this->_tpl_vars['item']['album_name']; ?>
</a>&nbsp; <strong>(<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-album-photos.php?album=<?php echo $this->_tpl_vars['item']['album_id']; ?>
"><?php echo $this->_tpl_vars['item']['totphotos']; ?>
				  ...
				  <td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-album.php?album_id=<?php echo $this->_tpl_vars['item']['album_id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="7"><font color="#FF0000"><strong>No Albums Added</strong></font></th>
				</tr>
