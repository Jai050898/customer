<?php /* Smarty version 2.6.26, created on 2014-03-24 05:56:08
         compiled from view-report.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'view-report.tpl', 48, false),array('function', 'cycle', 'view-report.tpl', 85, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
								  <li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/rebate-reports.php?user_id=<?php echo $_REQUEST['user_id']; ?>
">Rebate Reports</a></li>
							   <li>View Reports</li>
...
;">
		 <td style="color:#000000;text-align:center;"><?php echo $this->_tpl_vars['item']['batch_date']; ?>
										...
										<?php echo $this->_tpl_vars['item']['company_name']; ?>
											...
											<td align="left"><?php echo $this->_tpl_vars['item']['city']; ?>
                                                                                        ...
                                                                                        <td align="left"><?php echo $this->_tpl_vars['item']['amountSpent']; ?>
                                                                                                                                                                  ...
                                                                                                                                                                  <td align="left"><?php echo $this->_tpl_vars['item']['rebate_percent']; ?>
</td>

                                                                                        <td align="left"><?php echo $this->_tpl_vars['item']['rebate']; ?>
</td>
                                                                                        <td align="left"><?php if ($this->_tpl_vars['item']['start_range'] > 0 && $this->_tpl_vars['item']['end_range'] > 0): ?><?php echo $this->_tpl_vars['item']['start_range']; ?>
-<?php echo $this->_tpl_vars['item']['end_range']; ?>
<?php else: ?>No Range specified<?php endif; ?></td>
