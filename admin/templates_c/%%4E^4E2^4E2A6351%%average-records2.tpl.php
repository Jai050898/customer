<?php /* Smarty version 2.6.26, created on 2014-02-10 01:36:56
         compiled from average-records2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'average-records2.tpl', 44, false),)), $this); ?>
...
?>
                                                        <tr>
                                                        <td  height="30" colspan="2" bgcolor="#854141" align="center" valign="middle" style="color:#fff;"><?php echo $this->_tpl_vars['item']; ?>
</td>
                                                ...
                                                <th width="20%" height="30"  align="left" valign="top">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th height="30" align="center" valign="middle" bgcolor="#854141" style="color:#fff;">Average Gross Customers</th>
...
?>
                                                    ...
                                                    <?php endforeach; endif; unset($_from); ?>
                                                        ...
                                                        <th height="30" align="center" valign="middle" bgcolor="#854141" style="color:#fff;">Average Gross Sales</th>
...
?>
                                                    ...
                                                    <?php endforeach; endif; unset($_from); ?>
                                                        ...
                                                        <th height="30" align="center" valign="middle" bgcolor="#854141" style="color:#fff;">Average Comparative Gross Sales&nbsp;&nbsp;(CY vs PY)</th>
...
?>
    ...
    <th height="30" align="center" valign="middle" bgcolor="#854141" style="color:#fff;">Average Variance&nbsp;&nbsp;(Comparative Gross Sales (CY vs PY))</th>
