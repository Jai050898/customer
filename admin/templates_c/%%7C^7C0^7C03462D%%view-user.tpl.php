<?php /* Smarty version 2.6.26, created on 2013-08-30 04:15:05
         compiled from view-user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'view-user.tpl', 32, false),array('modifier', 'nl2br', 'view-user.tpl', 48, false),array('modifier', 'date_format', 'view-user.tpl', 121, false),)), $this); ?>
...
<?php endif; ?></td>
						...
						<tr class="color_trbg">
						  ...
						  <tr class="color_trbg">
							...
							<td align="left"><?php echo $this->_tpl_vars['User']['shop_labor_rate']; ?>
</td>
						  </tr>
						  <tr class="color_trbg">
							<td>No of Technicians</td>
							<td align="left"><?php echo $this->_tpl_vars['User']['no_of_technicians']; ?>
</td>
						  </tr>
										   
						  <tr class="color_trbg">
							<td>No of Advisors</td>
							<td align="left"><?php echo $this->_tpl_vars['User']['no_of_advisors']; ?>
</td>
						  </tr>
						  <tr class="color_trbg">
							<td>sq ft of shop (entire)</td>
							<td align="left"><?php echo $this->_tpl_vars['User']['sq_ft_of_shop']; ?>
</td>
						  </tr>
						<tr class="color_trbg">
