<?php /* Smarty version 2.6.26, created on 2013-05-18 04:04:24
         compiled from manage-cd-cat.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-cd-cat.tpl', 48, false),array('modifier', 'date_format', 'manage-cd-cat.tpl', 77, false),array('function', 'cycle', 'manage-cd-cat.tpl', 73, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      <li>Manage Confirmed Directories Categories</li>
     
      </ul>
      <div class="clr"></div>
      </div>
      <div id="admin_head">Manage Confirmed Directories Categories</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Confirmed Directories Categories</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-cd-cat.php">Add Confirmed Directories Categories</a></td>
			</tr>
			 <tr>
...
/admin/add-cd-cat.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Confirmed Directories Categories Added</strong></font></th>
				</tr>
