<?php /* Smarty version 2.6.26, created on 2014-01-20 09:35:17
         compiled from manage-xml-make-reports.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-xml-make-reports.tpl', 55, false),array('modifier', 'count', 'manage-xml-make-reports.tpl', 69, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
                                    <li>Manage Reports By Makes</li>
                            </ul>
                            <div class="clr"></div>
                          </div>
                          <div id="admin_head">Manage Reports By Makes</div>
                        </div>
                            <div id="contentpane">
                                ...
                                <td align="left" valign="top" colspan="2">
                                  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
                                        <tr>
                                                ...
                                                <th width="7%" align="left"><a href="javascript: setClientSort('make','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCustomers);">Make</a></th>
