<?php /* Smarty version 2.6.26, created on 2013-05-13 01:10:58
         compiled from manage-payment-types.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-payment-types.tpl', 53, false),array('modifier', 'date_format', 'manage-payment-types.tpl', 82, false),array('function', 'cycle', 'manage-payment-types.tpl', 78, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      ...
      <div id="admin_head">Manage Payment Types</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Payment Types</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-payment-types.php">Add Payment Types</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('payment_type','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Payment Type</a> <?php if ($_REQUEST['sortby'] == 'payment_type'): ?><img src="../images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
"/></td>
				  <td align="left"><?php echo $this->_tpl_vars['item']['payment_type']; ?>
</td>
...
/admin/add-payment-types.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Payment Types Added</strong></font></th>
				</tr>
