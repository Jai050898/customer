<?php /* Smarty version 2.6.26, created on 2012-11-02 06:45:54
         compiled from integrated-step1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_checkboxes', 'integrated-step1.tpl', 80, false),)), $this); ?>
...
">Integrated survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmStepOne" id="frmStepOne" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step1.php?id=<?php echo $_REQUEST['id']; ?>
">
