<?php /* Smarty version 2.6.26, created on 2013-05-03 11:16:01
...
&summary=1&hide_redirects=1&hide_type=all&no_accept_language=0&recursive=1&depth=500&cookie=nochanges </a></li>
		<li><a href="http://validator.w3.org/unicorn/check?ucn_uri=<?php echo $this->_tpl_vars['domain']; ?>
&ucn_task=conformance#" target="_blank" id="linkid">http://validator.w3.org/unicorn/check?ucn_uri=<?php echo $this->_tpl_vars['domain']; ?>
&ucn_task=conformance# </a></li>
