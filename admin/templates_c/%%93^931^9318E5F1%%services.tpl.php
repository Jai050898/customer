<?php /* Smarty version 2.6.26, created on 2011-02-17 06:41:20
         compiled from services.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_checkboxes', 'services.tpl', 67, false),)), $this); ?>
...
">Website survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmServices" id="frmServices" method="post" class="fValidator-form" onsubmit="return validateForm();" action="services.php?id=<?php echo $_REQUEST['id']; ?>
">
