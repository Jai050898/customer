<?php /* Smarty version 2.6.26, created on 2013-06-18 03:27:29
         compiled from manage-keywords.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-keywords.tpl', 53, false),array('modifier', 'date_format', 'manage-keywords.tpl', 82, false),array('function', 'cycle', 'manage-keywords.tpl', 78, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      ...
      <div id="admin_head">Manage Keywords</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Keywords</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-keyword.php">Add Keyword</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="40%" align="left"><a href="javascript: setClientSort('key_name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCat);">Keyword Name</a> <?php if ($_REQUEST['sortby'] == 'key_name'): ?><img src="../images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
;">
				  <td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['key_id']; ?>
"/></td>
				  <td align="left"><?php echo $this->_tpl_vars['item']['key_name']; ?>
</td>
...
/admin/add-keyword.php?key_id=<?php echo $this->_tpl_vars['item']['key_id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="5"><font color="#FF0000"><strong>No Keywords Added</strong></font></th>
				</tr>
