<?php /* Smarty version 2.6.26, created on 2011-02-16 09:35:33
...
/dashboard.php">Home</a></li>
				...
				<div class="ad_textsp">
					...
					<ul style="list-style-type:upper-roman; padding-left:50px; padding-bottom:10px;">
						...
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step1.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Basic Marketing Information page</a></li>
		
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step2.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Business Profile</a></li>
		
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step3.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Marketing / Advertising Opportunties</a></li>
		
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step4.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Customer Profile</a></li>
		
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step5.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Service Practices</a></li>
		
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step6.php?id=<?php echo $_REQUEST['user_id']; ?>
'>Marketing / Advertising Elements</a></li>
		
						<li><a href='<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/step7.php?id=<?php echo $_REQUEST['user_id']; ?>
