<?php /* Smarty version 2.6.26, created on 2013-06-18 02:57:19
         compiled from manage-tasks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-tasks.tpl', 54, false),array('modifier', 'date_format', 'manage-tasks.tpl', 85, false),array('modifier', 'base64_encode', 'manage-tasks.tpl', 86, false),array('function', 'cycle', 'manage-tasks.tpl', 81, false),)), $this); ?>
...
/admin/add-tasks.php">Add Tasks</a></td>
			</tr>
			 <tr>
...
<?php endif; ?>" class="searchinput" /> <input type="image" src="../images/go_but.png" onclick="document.ManageTasks.submit();" /> 
			 <div class="clr"></div>
			  </div></td>
			</tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="15%" align="left"><a href="javascript: setClientSort('A.name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageTasks);">Project Name</a> <?php if ($_REQUEST['sortby'] == 'A.name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
				  <th width="15%" align="left"><a href="javascript: setClientSort('title','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageTasks);">Title</a> <?php if ($_REQUEST['sortby'] == 'title'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
				  <th width="12%" align="left"><a href="javascript: setClientSort('A.dead_line','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageTasks);">Dead Line Date </a> <?php if ($_REQUEST['sortby'] == 'A.dead_line'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
/admin/view-project.php?project_id=<?php echo $this->_tpl_vars['item']['project_id']; ?>
"><?php echo $this->_tpl_vars['item']['name']; ?>
</a>&nbsp;</td>
				  <td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-task.php?task_id=<?php echo $this->_tpl_vars['item']['task_id']; ?>
"><?php echo $this->_tpl_vars['item']['title']; ?>
</a></td>
				  <td align="left"> <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['dead_line'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m-%d-%Y") : smarty_modifier_date_format($_tmp, "%m-%d-%Y")); ?>
</td>
				  <td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/ajax.php?For=Comments&height=600&width=600&type=A&Id=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['task_id'])) ? $this->_run_mod_handler('base64_encode', true, $_tmp) : smarty_modifier_base64_encode($_tmp)); ?>
" class="thickbox" title="View Comments"><?php echo $this->_tpl_vars['item']['commentcount']; ?>
</a></td>
				  <td align="left"><span class="progressBar" id="task_status<?php echo ($this->_foreach['item']['iteration']-1); ?>
"><?php echo $this->_tpl_vars['item']['task_status']; ?>
</span></td>
				  <td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-tasks.php?task_id=<?php echo $this->_tpl_vars['item']['task_id']; ?>
