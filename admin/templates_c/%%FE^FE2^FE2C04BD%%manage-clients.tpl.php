<?php /* Smarty version 2.6.26, created on 2011-01-28 06:43:57
         compiled from manage-clients.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-clients.tpl', 58, false),array('modifier', 'base64_encode', 'manage-clients.tpl', 60, false),array('modifier', 'count', 'manage-clients.tpl', 77, false),)), $this); ?>
...
/admin/add-client.php">Add Client</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
...
/images/go_but.png" onclick="document.ManageClients.submit();" /> 
								 	<div class="clr"></div>
								</div>
							  </td>
							</tr>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="20%" align="left"><a href="javascript: setClientSort('A.first_name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageClients);">Client Name</a> <?php if ($_REQUEST['sortby'] == 'A.first_name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="15%" align="center"><a href="javascript: setClientSort('A.email','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageClients);">Email </a> <?php if ($_REQUEST['sortby'] == 'A.email'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
;">
											<td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['client_id']; ?>
"/></td>
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-client.php?client_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['client_id'])) ? $this->_run_mod_handler('base64_encode', true, $_tmp) : smarty_modifier_base64_encode($_tmp)); ?>
"><?php echo $this->_tpl_vars['item']['first_name']; ?>
 ...
 <?php echo $this->_tpl_vars['item']['price']; ?>
											...
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-client.php?client_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['client_id'])) ? $this->_run_mod_handler('base64_encode', true, $_tmp) : smarty_modifier_base64_encode($_tmp)); ?>
