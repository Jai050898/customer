<?php /* Smarty version 2.6.26, created on 2011-02-16 09:44:48
         compiled from step1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_checkboxes', 'step1.tpl', 99, false),array('function', 'html_options', 'step1.tpl', 153, false),)), $this); ?>
...
">Marketing survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmStepOne" id="frmStepOne" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="step1.php?id=<?php echo $_REQUEST['id']; ?>
">
...
"/></td>
							  ...
							  <tr>
								...
								<input type="text" name="FaxLineNumber" id="FaxLineNumber" maxlength="15" size="20" class="form" value="<?php echo $this->_tpl_vars['basicInfoDetail']['TollFreePhone']; ?>
"/></td>
