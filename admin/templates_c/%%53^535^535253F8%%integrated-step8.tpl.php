<?php /* Smarty version 2.6.26, created on 2011-02-18 07:00:40
         compiled from integrated-step8.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'integrated-step8.tpl', 49, false),array('function', 'html_checkboxes', 'integrated-step8.tpl', 166, false),)), $this); ?>
...
">Integrated survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmStepOne" id="frmStepOne" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step8.php?id=<?php echo $_REQUEST['id']; ?>
">
