<?php /* Smarty version 2.6.26, created on 2011-02-18 06:47:21
...
">Integrated survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmHistory" id="frmHistory" method="post" class="fValidator-form" onsubmit="return validateForm();" action="integrated-step2.php?id=<?php echo $_REQUEST['id']; ?>
">
