<?php /* Smarty version 2.6.26, created on 2014-04-23 07:45:06
         compiled from manage-portfolio.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-portfolio.tpl', 53, false),array('modifier', 'date_format', 'manage-portfolio.tpl', 82, false),array('function', 'cycle', 'manage-portfolio.tpl', 78, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
      ...
      <div id="admin_head">Manage Portfolio</div>
      </div>
	  <div class="ad_textsp">
...
" />
			...
			<tr>
			 ...
			 <tr>
			  <td><h2>Manage Portfolio</h2></td>
			  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-portfolio.php">Add Portfolio</a></td>
			</tr>
			 <tr>
			...
			<tr>
			  <td align="left" valign="top" colspan="2"><table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
				<tr>
				  ...
				  <th width="35%" align="left"><a href="javascript: setClientSort('project_name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManagePortfolio);">Project Name</a> <?php if ($_REQUEST['sortby'] == 'project_name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
...
',document.ManagePortfolio);">Crated Date </a> <?php if ($_REQUEST['sortby'] == 'created_date'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
"/></td>
				  <td align="left"><?php echo $this->_tpl_vars['item']['project_name']; ?>
&nbsp;</td>
...
/admin/view-portfolio.php?portfolio_id=<?php echo $this->_tpl_vars['item']['id']; ?>
" class="link023">View</a>&nbsp; | &nbsp;<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-portfolio.php?portfolio_id=<?php echo $this->_tpl_vars['item']['id']; ?>
" class="link023">Edit</a></td>
				</tr>
				<?php endforeach; else: ?>
				<tr>
				  <th width="100%" align="center" colspan="7"><font color="#FF0000"><strong>No Portfolio Added</strong></font></th>
				</tr>
			...
			<tr>
			  <td colspan="2"><table width="100%" cellspacing="0" cellpadding="5">
				...
				<td  align="right"  bgcolor="#854141">.<?php echo $this->_tpl_vars['first']; ?>
.<div style="float:right; padding-right:5px;"><?php if ($this->_tpl_vars['first'] != ""): ?><?php echo $this->_tpl_vars['first']; ?>
<?php endif; ?><?php if ($this->_tpl_vars['prev'] != ""): ?><?php echo $this->_tpl_vars['prev']; ?>
<?php endif; ?><?php if ($this->_tpl_vars['nav'] != ""): ?><?php echo $this->_tpl_vars['nav']; ?>
<?php endif; ?><?php if ($this->_tpl_vars['next'] != ""): ?><?php echo $this->_tpl_vars['next']; ?>
<?php endif; ?><?php if ($this->_tpl_vars['last'] != ""): ?><?php echo $this->_tpl_vars['last']; ?>
