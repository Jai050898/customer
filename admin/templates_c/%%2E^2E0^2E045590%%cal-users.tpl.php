<?php /* Smarty version 2.6.26, created on 2012-12-28 05:35:02
         compiled from cal-users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'cal-users.tpl', 48, false),array('modifier', 'count', 'cal-users.tpl', 72, false),)), $this); ?>
...
/admin/add-cal.php?user_id=<?php echo $_REQUEST['user_id']; ?>
">Add Calendar</a>&nbsp;|&nbsp;<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/shared-cal.php?user_id=<?php echo $_REQUEST['user_id']; ?>
">Shared Calendars</a></td>
							</tr>
...
;">
											...
											<td align="left"><?php echo $this->_tpl_vars['item']['sdate']; ?>
</td>
											<td align="left"><?php echo $this->_tpl_vars['item']['edate']; ?>
</td>
...
/admin/cal-gantt.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
...
/images/cal.png" border="0" title="View Gantt" alt="View Gantt" /></a>&nbsp;&nbsp;
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/show-cal.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&user_id=<?php echo $_REQUEST['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/calendar.png" border="0" title="Calendar" alt="Calendar" /></a>&nbsp;&nbsp;
						<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/edit-cal.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&user_id=<?php echo $_REQUEST['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/edit.png" border="0" title="Edit" alt="Edit" /></a>&nbsp;&nbsp;
						<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/copy-cal.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&user_id=<?php echo $_REQUEST['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/copy.png" border="0" title="Copy" alt="Copy" /></a>&nbsp;&nbsp;
						<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/cal-user.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&act=del&user_id=<?php echo $_REQUEST['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/del.png" border="0" title="Delete" alt="Delete" /></a>&nbsp;&nbsp;
						<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/slow-periods.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&user_id=<?php echo $_REQUEST['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/timeline_marker.png" border="0" title="Slow Periods" alt="Slow Periods" /></a>
											</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
