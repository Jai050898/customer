<?php /* Smarty version 2.6.26, created on 2014-04-23 23:57:34
         compiled from add-portfolio-category.tpl */ ?>
...
/dashboard.php">Home</a></li>
								  <li><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-portfolio-categories.php">Manage Portfolio Category</a></li>
								  <li><?php if ($_REQUEST['cat_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> Portfolio Category</li>
							  </ul>
						  	<div class="clr"></div>
						  </div>
						<div id="admin_head"><?php if ($_REQUEST['cat_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> Portfolio Category</div>
					  </div>
					<div class="ad_textsp">
