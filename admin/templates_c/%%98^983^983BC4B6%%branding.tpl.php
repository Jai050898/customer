<?php /* Smarty version 2.6.26, created on 2011-02-17 06:40:50
         compiled from branding.tpl */ ?>
...
">Website survey</a></li>
					...
					<div class="ad_textsp">
						<form name="frmBranding" id="frmBranding" method="post" class="fValidator-form" onsubmit="return validateForm();" action="branding.php?id=<?php echo $_REQUEST['id']; ?>
">
