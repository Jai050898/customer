<?php /* Smarty version 2.6.26, created on 2013-05-15 07:31:32
         compiled from add-seouser.tpl */ ?>
...
/admin/manage-seousers.php">Manage SEO Users</a></li>
							<li><?php if ($_REQUEST['user_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> SEO User</li>
						  </ul>
						<div class="clr"></div>
					  </div>
				 	<div id="admin_head"><?php if ($_REQUEST['user_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> SEO User</div>
				  </div>
					<div class="ad_textsp">
								...
								<td align="left" valign="top" >
									<form name="UsersForm" id="UsersForm" method="post" class="form" onsubmit="javascript:$('#hid_key').val('Post');">
										...
										<table width="100%" cellspacing="0" cellpadding="0" class="addadmin_box01">
											<tr>
												<td colspan="2"><h2><?php if ($_REQUEST['user_id'] != ""): ?>Edit<?php else: ?>Add<?php endif; ?> SEO User</h2></td>
											</tr>
											<tr class="color_trbg">
...
" onBlur="javascript:fnCheckSEOEmailAvail('email',this.value,'emaildiv');"/><br /><span id="validdiv" style="padding-left:5px; color:red"></span>
												 </td>
											  </tr>
											  <tr class="color_trbg">
...
" onBlur="javascript:fnCheckSEOUnameAvail('user_name',this.value,'uiddiv');"/><br /><span id="uiddiv" style="padding-left:5px; color:red"></span>
												 </td>
											  </tr>
											<?php if ($_REQUEST['user_id'] == ""): ?>
												<tr class="color_trbg">
