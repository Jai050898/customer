<?php /* Smarty version 2.6.26, created on 2014-01-20 09:42:20
         compiled from manage-xml-model-reports.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-xml-model-reports.tpl', 50, false),array('modifier', 'count', 'manage-xml-model-reports.tpl', 64, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
                                    <li>Manage Reports By Models</li>
                            </ul>
                            <div class="clr"></div>
                          </div>
                          <div id="admin_head">Manage Reports By Models</div>
                        </div>
                         <div id="contentpane">
                                ...
                                <td align="left" valign="top" colspan="2">
                                   <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
                                        <tr>
                                                ...
                                                <th width="7%"  align="left"><a href="javascript: setClientSort('model','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageCustomers);">Model</a></th>
                                                <th width="7%"  align="left"> Vehicle totals (Last 12 Months)</th>
                                                <th width="7%"  align="left">Vehicle Total Life Time</th>
                                        </tr>
...
;">
                                                ...
                                                <td align="left"> <?php echo $this->_tpl_vars['item']['yearTotal']; ?>
</td>
                                                <td align="left"><?php echo $this->_tpl_vars['item']['allTotal']; ?>
</td>
                                            </tr>
                                        <?php endforeach; else: ?>
                                            <tr>
                        ...
                        <?php if (count($this->_tpl_vars['vehicle']) > 0): ?>
                        <tr>
