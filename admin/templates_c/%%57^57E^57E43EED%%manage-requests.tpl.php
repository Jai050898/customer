<?php /* Smarty version 2.6.26, created on 2013-05-01 06:48:14
         compiled from manage-requests.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-requests.tpl', 61, false),array('modifier', 'stripslashes', 'manage-requests.tpl', 63, false),array('modifier', 'count', 'manage-requests.tpl', 78, false),)), $this); ?>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="20%" align="left"><a href="javascript: setClientSort('bname','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageRequests);">Business Name</a> <?php if ($_REQUEST['sortby'] == 'bname'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="20%" align="left"><a href="javascript: setClientSort('domain','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageRequests);">Domain</a> <?php if ($_REQUEST['sortby'] == 'domain'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="20%" align="left"><a href="javascript: setClientSort('keyword','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageRequests);">Keyword</a> <?php if ($_REQUEST['sortby'] == 'keyword'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
"/></td>
											<td align="left"> <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['bname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-request.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
"><?php echo $this->_tpl_vars['item']['domain']; ?>
</a></td>
											<td align="left"> <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['keyword'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
											<td align="left" ><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['city'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
											<td align="left" ><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['state'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
