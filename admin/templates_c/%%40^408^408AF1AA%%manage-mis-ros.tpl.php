<?php /* Smarty version 2.6.26, created on 2013-01-23 02:20:37
         compiled from manage-mis-ros.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-mis-ros.tpl', 55, false),array('modifier', 'count', 'manage-mis-ros.tpl', 71, false),)), $this); ?>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="17%" align="left"><a href="javascript: setClientSort('MIS_type','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMISCustomers);">Type</a> <?php if ($_REQUEST['sortby'] == 'MIS_type'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="17%" align="left"><a href="javascript: setClientSort('MIS_license','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageMISCustomers);">License </a> <?php if ($_REQUEST['sortby'] == 'MIS_license'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle" /><?php endif; ?></th>
...
;">
											<td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['MIS_id']; ?>
"/></td>
											<td align="left"><?php echo $this->_tpl_vars['item']['MIS_type']; ?>
</td>
											<td align="left"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/view-mis-ro.php?hid=<?php echo $this->_tpl_vars['item']['MIS_id']; ?>
"> <?php echo $this->_tpl_vars['item']['MIS_license']; ?>
</a></td>
											<td align="left"><?php echo $this->_tpl_vars['item']['MIS_sched']; ?>
</td>
											<td align="left"><?php echo $this->_tpl_vars['item']['MIS_promised']; ?>
</td>
											<td align="left" ><?php echo $this->_tpl_vars['item']['MIS_balancedue']; ?>
</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
