<?php /* Smarty version 2.6.26, created on 2014-08-20 02:50:50
         compiled from manage-users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'manage-users.tpl', 54, false),array('modifier', 'stripslashes', 'manage-users.tpl', 102, false),array('function', 'cycle', 'manage-users.tpl', 99, false),)), $this); ?>
...
/images/menu_permission.gif" title="MenuPermission" alt="MenuPermission" /></a>&nbsp; -->
                                                                                             ...
                                                                                             <?php if (in_array ( $this->_tpl_vars['item']['user_id'] , $this->_tpl_vars['mmsAry'] )): ?>
                                                                                            <a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/rebate-reports.php?user_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/rebate.gif" title="Rebate Reports" alt="Rebate Reports" /> </a>
                                                                                            <?php endif; ?>
											    <?php if (in_array ( $this->_tpl_vars['item']['user_id'] , $this->_tpl_vars['mmsAry'] )): ?>
                                                                                            <a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/average-records.php?user_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
...
/images/menu_permission.gif" title="MenuPermission" alt="MenuPermission" /></a>&nbsp;
                                                                                             <a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/notification_mail.php?user_id=<?php echo $this->_tpl_vars['item']['user_id']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
