<?php /* Smarty version 2.6.26, created on 2014-04-23 09:47:01
         compiled from add-portfolio-demo.tpl */ ?>
...
" />
									...
									<td width="80%" align="left">
									<select name="Log[category]" id="category" >
                                     <option value="">Select category</option>
                                 <?php $_from = $this->_tpl_vars['Cate_portfolio']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['category'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['category']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['category']):
        $this->_foreach['category']['iteration']++;
?>
                                     <?php if ($this->_tpl_vars['category']['cat_name'] != ''): ?>
