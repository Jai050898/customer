<?php /* Smarty version 2.6.26, created on 2014-04-10 07:54:19
         compiled from edit-staff.tpl */ ?>
...
" <?php if ($_REQUEST['user_id'] != ""): ?>
				...
				<tr>
				  ...
				  <td><input type="password" name="Log[password]" id="Log[password]"  class="input req-string" value="<?php echo $this->_tpl_vars['password']; ?>
"/></td>				
                                </tr>
...
"/> </td>				
				...
				<?php if ($this->_tpl_vars['error'] != ""): ?>
                        ...
                        <?php if ($_REQUEST['res'] != ""): ?>
                            <tr class="color_trbg">
                            <td colspan="2" style="color:#00FF00;text-align:center"><?php echo $_REQUEST['res']; ?>
</td>
                            </tr>
                        <?php endif; ?>
			</table>
