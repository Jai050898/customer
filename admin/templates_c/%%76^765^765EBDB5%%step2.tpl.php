<?php /* Smarty version 2.6.26, created on 2011-02-16 09:20:45
         compiled from step2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'step2.tpl', 40, false),array('function', 'html_checkboxes', 'step2.tpl', 240, false),)), $this); ?>
...
">Marketing survey</a></li>
				 	...
				 	<div id="admin_head">Business Profile</div>
				  </div>
					<div class="ad_textsp">
						<form name="frmStepTwo" id="frmStepTwo" method="post" enctype="multipart/form-data" class="fValidator-form" onsubmit="return validateForm();" action="step2.php?id=<?php echo $_REQUEST['id']; ?>
">
