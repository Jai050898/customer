...
$businessCustomerDetailarr = $usr->GetAllWhere("tbl_survey_customer_profile","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_customer_profile',$businessCustomerProfile,"UserId = '".$_REQUEST['id']."'");

		header('location:integrated-step11.php?id='.$_REQUEST['id']);
		exit;
