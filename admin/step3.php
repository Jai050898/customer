...
$usr 		= new General;
$marketingOpportunitiesarr = $usr->GetAllWhere("tbl_marketing_opportunities","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$delcomm = $usr->DeleteQry("tbl_community","UserId = '".$_REQUEST['id']."'");
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_marketing_opportunities',$customerMarketingOpportunities,"UserId = '".$_REQUEST['id']."'");

	header('location:step4.php?id='.$_REQUEST['id']);
	exit;
