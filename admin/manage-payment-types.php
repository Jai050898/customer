...
{	
	...
	$upid	= $usr->UpdateQry('tbl_payment_types',$upar,"id IN(".$_REQUEST['hid_id'].")");
}
$Where		= "1=1 AND status != 'D'";
//echo "<pre>";print_r($_REQUEST);exit;
if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!='')
{
	$Where .= " AND payment_type like '%".$_REQUEST['keyword']."%'";	
}
...
$Fields		= "id,payment_type,status,created_date";
...
//echo "<pre>";print_r($Cat);exit;
$smarty->display('manage-payment-types.tpl');
?>