...
{	
	...
	$upid	= $usr->UpdateQry('tbl_languages',$upar,"id IN(".$_REQUEST['hid_id'].")");
}
$Where		= "1=1 AND status != 'D'";
//echo "<pre>";print_r($_REQUEST);exit;
if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!='')
{
	$Where .= " AND languages like '%".$_REQUEST['keyword']."%'";	
}
...
$Table		= "tbl_languages";
$Fields		= "id,languages,status,created_date";
...
//echo "<pre>";print_r($Cat);exit;
$smarty->display('manage-languages.tpl');
?>