...
$usr 		= new General;
$businessProfileDetailarr = $usr->GetAllWhere("tbl_business_profile","UserId = '".$_REQUEST['id']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$delaff = $usr->DeleteQry("tbl_affiliation","UserId = '".$_REQUEST['id']."'");
	...
	//code to delete affiliate
	$delass = $usr->DeleteQry("tbl_association","UserId = '".$_REQUEST['id']."'");
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_business_profile',$customerBusinessProfile,"UserId = '".$_REQUEST['id']."'");
	
		header('location:step3.php?id='.$_REQUEST['id']);
		exit;
