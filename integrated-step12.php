...
$smarty->assign('breadcrumb','Integrated Survey- Step12');
$usr 		= new General;

$marketingInfoarr = $usr->GetAllWhere("tbl_survey_marketing_elements","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	#set the values
	$marketing = array();
	$marketing['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_marketing_elements',$marketing,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step13.php');
		exit;
