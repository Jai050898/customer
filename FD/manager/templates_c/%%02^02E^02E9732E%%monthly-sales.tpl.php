<?php /* Smarty version 2.6.26, created on 2012-11-23 00:28:25
         compiled from monthly-sales.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'monthly-sales.tpl', 59, false),array('modifier', 'date_format', 'monthly-sales.tpl', 62, false),array('modifier', 'count', 'monthly-sales.tpl', 79, false),)), $this); ?>
...
/admin/dashboard.php">Home</a></li>
						...
						<div id="admin_head">Monthly Sales</div>
				  </div>
				  <div class="ad_textsp">
...
" />
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td><h2>Monthly Sales</h2></td>
							  <td align="right"><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/manager/add-monthly-sales.php?Shop_ID=<?php echo $_REQUEST['Shop_ID']; ?>
">Add Monthly Sales</a></td>
							</tr>
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="17%" align="left">Year</th>
										<th width="17%" align="left">Month</th>
										<th width="15%" align="left">Gross Sales </th>
										<th width="15%" align="left">Repair Orders</th>
										<th width="15%" align="left">New Customers</th>
...
/manager/edit-monthly-sales.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
...
/images/page_edit.png" title="Edit" alt="Edit" /> </a>
									...
									<?php endforeach; else: ?>
										<tr>
										  <th width="100%" align="center" colspan="7"><font color="#FF0000"><strong>No  Monthly Data Added</strong></font></th>
										</tr>
