<?php /* Smarty version 2.6.26, created on 2012-11-23 00:23:36
         compiled from edit-yearly-sales.tpl */ ?>
...
/manager/dashboard.php">Home</a></li>
							<li>Edit Yearly Data</li>
						  </ul>
						<div class="clr"></div>
					  </div>
				 	<div id="admin_head">Edit Yearly Data</div>
				  </div>
					<div class="ad_textsp">
								...
								<td align="left" valign="top" >
									<form name="UsersForm" id="UsersForm" method="post" class="form" onsubmit="javascript:$('#hid_key').val('Post');">
										...
										<table width="100%" cellspacing="0" cellpadding="0" class="addadmin_box01">
											<tr>
												<td colspan="2"><h2>Edit Yearly Data</h2></td>
											</tr>
