<?php /* Smarty version 2.6.26, created on 2012-11-23 02:15:25
         compiled from dailyform.tpl */ ?>
<div class="bodyleftpopup">
			...
			<input type="hidden" name="day" id="day" value="<?php echo $_REQUEST['id']; ?>
">
			<input type="hidden" name="shopid" id="shopid" value="<?php echo $_REQUEST['shopid']; ?>
">
			<div style="height:10px;"></div>
...
<?php echo '/manager/dailyformsubmit.php\',{grosssales: $("#grosssales").val(), repairorders: $("#repairorders").val(), newcustomers: $("#newcustomers").val(), actualhours: $("#actualhours").val(), vibe: $("#vibe").val(), activity: $("#activity").val(), hid_type: $("#hid_type").val(), day: $("#day").val(), shopid: $("#shopid").val() }, function(data) {
	alert(data);
	  if(data == "success")
	  {
