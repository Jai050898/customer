...
$Where		= "1=1 AND A.status != 'D' AND A.Company_ID = '".$_SESSION['Manager']['ID']."'";
//echo "<pre>";print_r($_REQUEST);exit;
...
$Fields		= "A.Shop_ID,A.name,A.email,A.user_name,A.phone,A.country,A.state,A.city,A.status,B.Country_Name,C.State_Name";
