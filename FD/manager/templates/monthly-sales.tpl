					...
					<form id="ManageShops" class="form" method="post" name="ManageShops">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/manager/add-monthly-sales.php?Shop_ID={$smarty.request.Shop_ID}">Add Monthly Sales</a></td>
							</tr>
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Shops}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left">
											<a href="{$siteurl}/manager/edit-monthly-sales.php?id={$item.id}&Shop_ID={$smarty.request.Shop_ID}" class="link023"><img src="{$siteurl}/images/page_edit.png" title="Edit" alt="Edit" /> </a>
											</td>
										</tr>
									{foreachelse}
										<tr>
