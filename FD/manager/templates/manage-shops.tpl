					...
					<form id="ManageShops" class="form" method="post" name="ManageShops">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  ...
							  <td align="right"><a href="{$siteurl}/manager/add-shop.php">Add Shop</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								  ...
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									...
									{foreach item=item name=item from=$Shops}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											...
											<td align="left">
											<a href="{$siteurl}/manager/resendmail_shop.php?Shop_ID={$item.Shop_ID}" class="link023"><img src="{$siteurl}/images/email.png" title="Resend Welcome notification mail" alt="Resend Welcome notification mail" /> </a>
											<a href="{$siteurl}/manager/add-shop.php?Shop_ID={$item.Shop_ID}" class="link023"><img src="{$siteurl}/images/page_edit.png" title="Edit" alt="Edit" /> </a>
											<a href="{$siteurl}/manager/annual-settings.php?Shop_ID={$item.Shop_ID}" class="link023"><img src="{$siteurl}/images/cog.png" title="Annual Settings" alt="Annual Settings" /> </a>
											<a href="{$siteurl}/manager/daily-sales.php?Shop_ID={$item.Shop_ID}" class="link023"><img src="{$siteurl}/images/calendar_view_day.png" title="Daily Sales" alt="Daily Sales" /> </a>
											<a href="{$siteurl}/manager/monthly-sales.php?Shop_ID={$item.Shop_ID}" class="link023"><img src="{$siteurl}/images/calendar_view_month.png" title="Monthly Sales" alt="Monthly Sales" /> </a>
											<a href="{$siteurl}/manager/yearly-sales.php?Shop_ID={$item.Shop_ID}" class="link023"><img src="{$siteurl}/images/calendar_view_year.png" title="Yearly Sales" alt="Yearly Sales" /> </a>
											</td>
										</tr>
									{foreachelse}
										<tr>
