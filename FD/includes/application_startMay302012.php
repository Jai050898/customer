...
{
	define('SITEPATH',$root."rsvp"); // Local Site root directory
	define('SITEURL', 'http://'.$_SERVER['SERVER_NAME'].'/rsvp'); // For Local
}
else
{
	//define('SITEPATH',"/home/demoweb/public_html/rsvp");
	//define('SITEURL', 'http://'.$_SERVER['SERVER_NAME'].'/~demoweb/rsvp'); 
	define('SITEPATH',"/home/motorhea/public_html/programmer/");
	define('SITEURL', 'http://'.$_SERVER['SERVER_NAME'].'/programmer'); 
}
//require_once("recaptchalib.php");
define('SITENAME','programmer');
define('SITETITLE','.:Motor Head Marketing:.');
define('FROM','support@.com');
define('ADMINMAIL','srinivas.primaccess@gmail.com');
