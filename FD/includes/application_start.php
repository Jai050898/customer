...
else
{
	...
	define('SITEPATH',$root."/FD");
	define('SITEURL', 'http://'.$_SERVER['SERVER_NAME']."/FD"); 
}
//require_once("recaptchalib.php");
define('SITENAME','Financial Data');
define('SITETITLE','.:Financial Data:.');
define('FROM','support@FD.com');
