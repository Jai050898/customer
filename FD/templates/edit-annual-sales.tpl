		...
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[facebookfans]" id="facebookfans" value="{$Res.facebookfans}" class="input req-string req-numeric"></td>
				</tr>
				<tr>
				  <td align="right" valign="top" style="padding-left:95px;">Google Plus Users:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Log[googleplususers]" id="googleplususers" value="{$Res.googleplususers}" class="input req-string"></td>
				</tr>
				<tr>
				...
				<tr>
				  ...
				  <option value="">-- Please Select --</option>
				  <option value="+1" {if $Res.availablestaff eq "+1"} selected="selected"{/if}>Overtime</option>
				  <option value="0" {if $Res.availablestaff eq "0"} selected="selected"{/if}>Full Crew</option>
				  <option value="-1" {if $Res.availablestaff eq "-1"} selected="selected"{/if}>People on Vacation, off, low</option>
				  </select>
				  </td>
				</tr>
				<tr>
				  <td align="right" valign="top" style="padding-left:95px;">Days Open:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Log[daysopen]" id="daysopen" value="{$Res.daysopen}" class="input req-string"></td>
				</tr>
				<tr>
