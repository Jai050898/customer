...
<div id="body">
	<div class="bodybg" style="min-height:475px;">
		<div class="bodyleft">
			...
			<span style="float:right;"><a href="{$siteurl}/yearly-sales.php">Yearly Sales Entry</a></span>
			<h1>Annual Sales</h1>
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" >
				...
				<tr>
					...
					<td bgcolor="#f9f9f7" style="color:#000000;"><a href="edit-annual-sales.php?id={$item.id}">Edit</a></td>
				</tr>
				{foreachelse}
				<tr>
