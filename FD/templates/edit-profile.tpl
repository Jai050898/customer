		...
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[name]" id="name" class="input req-string" value="{$AccDet.name}"></td>
				</tr>
				<tr>
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[user_name]" id="user_name" class="input req-string" value="{$AccDet.user_name}" onBlur="javascript:fnCheckUnameAvail('user_name',this.value,'uiddiv');"/><br /><span id="uiddiv" style="padding-left:5px; color:red"></span></td>
				</tr>
				<tr>
				  <td align="right" valign="top" style="padding-left:95px;">Shop Email:</td>
				  <td align="left" valign="center"><input type="text" name="Log[shop_email]" id="shop_email" class="input req-string" value="{$AccDet.shop_email}" /></td>
				</tr>
				<tr>
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[opening_date]" id="opening_date" class="input req-string" value="{$AccDet.opening_date|date_format:'%m-%d-%Y'}"></td>
				</tr>
				<tr>
