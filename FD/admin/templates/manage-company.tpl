			...
			<div id="innerleft">
			  <div class="admin-rightpart">
				  <div class="admin_topbgnav">
						...
						<div id="admin_head">Manage Companies</div>
				  </div>
				  <div class="ad_textsp">
					<form id="ManageUsers" class="form" method="post" name="ManageUsers">
						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tr>
							  <td><h2>Manage Companies</h2></td>
							  <td align="right"><a href="{$siteurl}/admin/add-company.php">Add Company</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="17%" align="left"><a href="javascript: setClientSort('name','{$sortioption}',document.ManageUsers);">Company Name</a> {if $smarty.request.sortby eq 'name'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle"  />{/if}  </th>
										<th width="17%" align="left"><a href="javascript: setClientSort('email','{$sortioption}',document.ManageUsers);">Email </a> {if $smarty.request.sortby eq 'email'}<img src="images/{$sortimoption}.gif" alt="" align="absmiddle" />{/if}</th>
									...
									{foreach item=item name=item from=$Users}
										<tr style="background-color:{cycle values='#ffffff,#f3f3f3'};">
											<td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="{$item.Company_ID}"/></td>
											...
											<td align="left">
											<a href="{$siteurl}/admin/resendmail_company.php?user_id={$item.Company_ID}" class="link023"><img src="{$siteurl}/images/email.png" title="Resend Welcome notification mail" alt="Resend Welcome notification mail" /> </a>
											<a href="{$siteurl}/admin/add-company.php?user_id={$item.Company_ID}" class="link023"><img src="{$siteurl}/images/page_edit.png" title="Edit" alt="Edit" /> </a>
											<a href="{$siteurl}/admin/manage-shops.php?Company_ID={$item.Company_ID}" class="link023"><img src="{$siteurl}/images/application_home.png" title="Manage Shops" alt="Manage Shops" /> </a>
											</td>
										</tr>
									{foreachelse}
										<tr>
										  <th width="100%" align="center" colspan="7"><font color="#FF0000"><strong>No Companies Added</strong></font></th>
										</tr>
									{/foreach}
								  </table>
								</td>
