...
function sendajax()
{
	...
	$('#hid_type').val('Edit');
	$.post('{/literal}{$siteurl}{literal}/admin/dailyformsubmit.php',{grosssales: $("#grosssales").val(), repairorders: $("#repairorders").val(), newcustomers: $("#newcustomers").val(), actualhours: $("#actualhours").val(), vibe: $("#vibe").val(), activity: $("#activity").val(), hid_type: $("#hid_type").val(), day: $("#day").val(), shopid: $("#shopid").val() }, function(data) {
	//alert(data);
	  if(data == "success")
	  {
