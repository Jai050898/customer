<?php /* Smarty version 2.6.26, created on 2012-11-23 00:44:06
...
/admin/add-shop.php?Company_ID=<?php echo $_REQUEST['Company_ID']; ?>
">Add Shop</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
...
/admin/resendmail_shop.php?Shop_ID=<?php echo $this->_tpl_vars['item']['Shop_ID']; ?>
&Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
...
/images/email.png" title="Resend Welcome notification mail" alt="Resend Welcome notification mail" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-shop.php?Shop_ID=<?php echo $this->_tpl_vars['item']['Shop_ID']; ?>
&Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/page_edit.png" title="Edit" alt="Edit" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/annual-settings.php?Shop_ID=<?php echo $this->_tpl_vars['item']['Shop_ID']; ?>
&Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/cog.png" title="Annual Settings" alt="Annual Settings" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/daily-sales.php?Shop_ID=<?php echo $this->_tpl_vars['item']['Shop_ID']; ?>
&Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/calendar_view_day.png" title="Daily Sales" alt="Daily Sales" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/monthly-sales.php?Shop_ID=<?php echo $this->_tpl_vars['item']['Shop_ID']; ?>
&Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/calendar_view_month.png" title="Monthly Sales" alt="Monthly Sales" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/yearly-sales.php?Shop_ID=<?php echo $this->_tpl_vars['item']['Shop_ID']; ?>
&Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
