<?php /* Smarty version 2.6.26, created on 2012-11-23 03:21:39
...
<?php echo '/admin/dailyformsubmit.php\',{grosssales: $("#grosssales").val(), repairorders: $("#repairorders").val(), newcustomers: $("#newcustomers").val(), actualhours: $("#actualhours").val(), vibe: $("#vibe").val(), activity: $("#activity").val(), hid_type: $("#hid_type").val(), day: $("#day").val(), shopid: $("#shopid").val() }, function(data) {
	//alert(data);
	  if(data == "success")
	  {
