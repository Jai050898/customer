<?php /* Smarty version 2.6.26, created on 2012-11-19 07:38:20
         compiled from manage-company.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'manage-company.tpl', 67, false),array('modifier', 'count', 'manage-company.tpl', 88, false),)), $this); ?>
...
/admin/add-company.php">Add Company</a></td>
							</tr>
							<tr>
							  <td  colspan="2">
								...
								<td align="left" valign="top" colspan="2">
								  <table width="100%" cellpadding="0" cellspacing="0" class="admin_table">
									<tr>
										...
										<th width="17%" align="left"><a href="javascript: setClientSort('name','<?php echo $this->_tpl_vars['sortioption']; ?>
',document.ManageUsers);">Company Name</a> <?php if ($_REQUEST['sortby'] == 'name'): ?><img src="images/<?php echo $this->_tpl_vars['sortimoption']; ?>
.gif" alt="" align="absmiddle"  /><?php endif; ?>  </th>
										<th width="17%" align="left"><a href="javascript: setClientSort('email','<?php echo $this->_tpl_vars['sortioption']; ?>
...
;">
											<td align="left"><input type="checkbox" name="chkall[]" id="chkall" value="<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
"/></td>
...
/admin/resendmail_company.php?user_id=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
...
/images/email.png" title="Resend Welcome notification mail" alt="Resend Welcome notification mail" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/add-company.php?user_id=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/page_edit.png" title="Edit" alt="Edit" /> </a>
											<a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/admin/manage-shops.php?Company_ID=<?php echo $this->_tpl_vars['item']['Company_ID']; ?>
" class="link023"><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/images/application_home.png" title="Manage Shops" alt="Manage Shops" /> </a>
											</td>
										</tr>
									<?php endforeach; else: ?>
										<tr>
