...
if(isset($_REQUEST['Shop_ID']) && $_REQUEST['Shop_ID'] != "")
{
	...
	$result		.= "<br>";
	 ...
	 header('Location:'.SITEURL.'/admin/manage-shops.php?Company_ID='.$_REQUEST["Company_ID"].'&task=s');
}
else
	header('Location:'.SITEURL.'/admin/manage-shops.php?Company_ID='.$_REQUEST["Company_ID"].'&task=f');
?>