<?php /* Smarty version 2.6.26, created on 2012-11-22 04:28:28
         compiled from edit-annual-sales.tpl */ ?>
...
"></td>
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[facebookfans]" id="facebookfans" value="<?php echo $this->_tpl_vars['Res']['facebookfans']; ?>
" class="input req-string req-numeric"></td>
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[googleplususers]" id="googleplususers" value="<?php echo $this->_tpl_vars['Res']['googleplususers']; ?>
" class="input req-string"></td>
				...
				<tr>
				  ...
				  <option value="">-- Please Select --</option>
				  <option value="+1" <?php if ($this->_tpl_vars['Res']['availablestaff'] == "+1"): ?> selected="selected"<?php endif; ?>>Overtime</option>
				  <option value="0" <?php if ($this->_tpl_vars['Res']['availablestaff'] == '0'): ?> selected="selected"<?php endif; ?>>Full Crew</option>
				  <option value="-1" <?php if ($this->_tpl_vars['Res']['availablestaff'] == "-1"): ?> selected="selected"<?php endif; ?>>People on Vacation, off, low</option>
				  </select>
				  </td>
				</tr>
				<tr>
				  <td align="right" valign="top" style="padding-left:95px;">Days Open:<span class="redstar"> * </span></td>
				  <td align="left" valign="center"><input type="text" name="Log[daysopen]" id="daysopen" value="<?php echo $this->_tpl_vars['Res']['daysopen']; ?>
" class="input req-string"></td>
				</tr>
				<tr>
