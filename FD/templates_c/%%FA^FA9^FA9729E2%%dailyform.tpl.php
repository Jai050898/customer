<?php /* Smarty version 2.6.26, created on 2012-11-22 01:49:44
...
function sendajax()
{
	...
	$(\'#hid_type\').val(\'Edit\');
	$.post(\'dailyformsubmit.php\',{grosssales: $("#grosssales").val(), repairorders: $("#repairorders").val(), newcustomers: $("#newcustomers").val(), actualhours: $("#actualhours").val(), vibe: $("#vibe").val(), activity: $("#activity").val(), hid_type: $("#hid_type").val(), day: $("#day").val() }, function(data) {
	  if(data == "success")
	  {
