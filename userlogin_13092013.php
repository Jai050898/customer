...
if(isset($_SESSION['User']['UID']))
{
	...
	$UsrDet				= $Gen->GetSelWhere('tbl_users','user_id,email,user_name,xml_id,password,Last_Login_Date,status,login_status,access_to_mark_survey,access_to_site_survey,access_to_integrated_survey,ismarketingsurveycompleted,iswebsurveycompleted,issurveycompleted,created_date,attempts'," user_name = '".$_REQUEST['input_1']."' AND password = '".base64_encode($_REQUEST['input_2'])."'");
	$cnt			= count($UsrDet);
	$status = "F";
	if($cnt != 0)
	{
