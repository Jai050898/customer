...
$smarty->assign('breadcrumb','Integrated Survey- Step14');
$usr 		= new General;

$otherInfoarr = $usr->GetAllWhere("tbl_survey_other_info","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_other_info',$othersInfo,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-finish.php');
		exit;
