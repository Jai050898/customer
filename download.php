...
* Author: Lakshman Kumar.M
* Date: 22/2/2010 (DD/MM/YYYY)
...
{	
	...
	if (in_array($img_ext, $ext))
	{
		if(isset($_REQUEST['folder']) && $_REQUEST['folder'] == "admin")
			$down= SITEPATH."/Secured/".$_SESSION['User']['user_name']."/adminUploads/".$img;
		else				
			$down= SITEPATH."/Secured/".$_SESSION['User']['user_name']."/uploads/".$img;
