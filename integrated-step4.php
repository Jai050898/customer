...
$smarty->assign('breadcrumb','Integrated Survey- Step4');
$usr 		= new General;

$stuffDetailarr = $usr->GetAllWhere("tbl_survey_stuff","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_stuff',$stuff,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step5.php');
		exit;
