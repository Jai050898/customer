...
$smarty->assign('breadcrumb','Integrated Survey- Finish');
$usr 		= new General;
...
if(isset($_POST['btnSubmit']))
{
	if($usr->IsIntegratedSurveyCompleted())
	{
		...
		$subject	= "Integrated Survey Submitted!!!";
		$result		= $_SESSION['User']['user_name'].' has submitted his integrated survey sucessfully.' ;
...
$smarty->display('integrated-finish.tpl');
?>