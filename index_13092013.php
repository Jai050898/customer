...
if(isset($_REQUEST['hid_type']) && $_REQUEST['hid_type'] == 'Reg')
{
	...
	if($cnt != 0)
	{
		...
		if($UsrDet[0]['login_status'] == 'A' && $UsrDet[0]['attempts'] < 5)
		{
			...
			$email = trim("pm4.rizecorp@yahoo.com"," ");
