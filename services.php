...
$smarty->assign('breadcrumb','Website Survey- Services');
$usr 		= new General;

$servicesInfoarr = $usr->GetAllWhere("web_tbl_services","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_services',$services,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:competitiveAdvantages.php');
		exit;
