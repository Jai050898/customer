...
$smarty->assign('breadcrumb','Marketing Survey Step-4');
$usr 		= new General;
...
$businessCustomerDetailarr = $usr->GetAllWhere("tbl_customer_profile","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_customer_profile',$businessCustomerProfile,"UserId = '".$_SESSION['User']['UID']."'");
