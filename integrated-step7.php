...
$smarty->assign('breadcrumb','Integrated Survey- Step7');
$usr 		= new General;

$notorietyInfoarr = $usr->GetAllWhere("tbl_survey_notoriety","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$notoriety = array();
	$notoriety['UserId'] = $_SESSION['User']['UID'];
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_notoriety',$notoriety,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step8.php');
		exit;
