<?php
    ...
    // To Fetch Total ROws
    $Where  = "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND DATE(reg_date) = DATE_SUB(CURDATE(), INTERVAL 1 DAY)";
    $Table  = "XML_customers ";
    ...
    foreach($customersArray  as $key=>$value)
    {
        ...
        $Where3	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' and  cust_id = '".$value['cust_id']."' AND DATE(transaction_date) = DATE_SUB(CURDATE(), INTERVAL 1 DAY) ORDER BY transaction_date ASC LIMIT 0,1";
