...
<tr>
<td width="50%"><a href="javascript: ShowGntt(<?php echo $_REQUEST['id'];?>,<?php echo $py;?>);">Pre Year</a></td>
<td width="50%" align="right"><a href="javascript: ShowGntt(<?php echo $_REQUEST['id'];?>,<?php echo $ny;?>);">Next Year</a></td>
</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1"  style="font-size:14px; font-family:Arial, Helvetica, sans-serif;">
<tr>
<td width="50%" align="right"><a href="javascript: ShowGnttDaily(<?php echo $_REQUEST['id'];?>,<?php echo $_REQUEST['year'];?>);">View Daily Gantt</a></td>
</tr>
</table>
