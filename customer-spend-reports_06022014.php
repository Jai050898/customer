<?php
    ...
    foreach($custAry as $key=>$customer) {
        ...
        // To calculate Gross Sales
            $Wherefv	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' GROUP BY id ORDER BY transaction_date DESC LIMIT 0,1 " ;
            
            $Wheresv	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' GROUP BY id ORDER BY transaction_date DESC LIMIT 1,2 " ;
            
            $Wheretv	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' GROUP BY id ORDER BY transaction_date DESC LIMIT 2,3 " ;
            
            $Wherefov	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' GROUP BY id ORDER BY transaction_date DESC LIMIT 3,4 " ;
            
            $Wherefiv	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' GROUP BY id ORDER BY transaction_date DESC LIMIT 4,5 " ;
            
            $Wheretov	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' ORDER BY transaction_date DESC ";
           
            $Wherero	= "1=1 AND company_id = '".$_SESSION['User']['xml_id']."' AND cust_id = '".$customer['cust_id']."' ORDER BY transaction_date DESC ";
