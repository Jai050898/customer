...
$smarty->assign('breadcrumb','Manage Projects');
$usr 		= new General;
...
$Where		= "1=1 AND client_id = '".$_SESSION['User']['UID']."'";
//echo "<pre>";print_r($_REQUEST);exit;
...
$Fields		= "A.project_id,A.name,A.description,A.project_status,A.status,A.created_date,A.priority,COUNT(B.id) as totmembers,COUNT(C.task_id) as totaltasks";
