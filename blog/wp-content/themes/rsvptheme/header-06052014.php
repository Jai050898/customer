	...
	<div id="nav">
	  <ul>
		...
		<li><a href="<?php echo SITEURL; ?>/myaccount.php"  <?php if($Page == 'account') { ?>  class="active"<?php } ?>><span>My Account</span></a>
			<ul>
				<li><a href="<?php echo SITEURL; ?>/edit-profile.php"><span>Shop Profile</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/data-profile.php"><span>Data Profile</span></a></li>
				<li><a href="<?php echo SITEURL; ?>/change-password.php"><span>Change Password</span></a></li>
			</ul>
		</li>
		<li><a href="javascript:void(0);"  <?php if($Page == 'projects') {?>  class="active"<?php } ?>><span>Projects</span></a>
                    <ul>
                ...
                <li><a href="javascript:void(0);" <?php if($Page == 'customers') { ?>  class="active"<?php } ?>><span>Business</span></a>
                    <ul>
                        <li>
                            <a href="javascript:void(0);"><span class="drop-down-arrow-inner">Customers</span></a>
                            <ul>
                                <li><a href="<?php echo SITEURL; ?>/customer-dc.php"><span>Customer Dashboard</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/manage-customer-tracking.php"><span>Customer Tracking</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/customer-analysis.php"><span>Customer Analysis</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/customer-calender.php"><span>Calender Results</span></a></li>
                                ...
                                <li><a href="<?php echo SITEURL; ?>/manage-zipcode-customers.php"><span>Customers by Zip Code</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/manage-city-customers.php"><span>Customers by City</span></a></li>
                                
                                <li><a href="<?php echo SITEURL; ?>/manage-customer-visit-reports.php"><span>Customer Visit Reports</span></a></li>

                                <li><a href="<?php echo SITEURL; ?>/manage-customer-counts.php"><span>Customer Durationwise Reports</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/manage-customer-spendings.php"><span>Customer Spend Reports</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/ro-calculations.php"><span>RO Calculations</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/customer-visit-spending.php"><span>Customer Visit Spending</span></a></li>

                                <li><a href="<?php echo SITEURL; ?>/manage-mis-customers.php"><span>Manage MIS Customers</span></a></li>
			  	<li><a href="<?php echo SITEURL; ?>/manage-mis-zipcode-customers.php"><span>MIS Zipcode Customers</span></a></li>
			  	<li><a href="<?php echo SITEURL; ?>/manage-mis-city-customers.php"><span>MIS City Customers</span></a></li>
			  	<li><a href="<?php echo SITEURL; ?>/manage-mis-customers-report.php"><span>MIS Customers Report</span></a></li>
				<li><a href="<?php echo SITEURL; ?>/customer-dc.php"><span>MIS Customer DC</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/new-reports.php"><span>Export Customer Reports</span></a></li>
                                
                                <li><a href="<?php echo SITEURL; ?>/gross-sale-weekwise-report.php" target="_blank"><span>Weekwise Sales Report</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/gross-sale-daywise-report.php" target="_blank"><span>Daywise Sales Report</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/customer-last-visits.php" target="_blank"><span>Customer Last Visits</span></a></li>
                        ...
                        <li><a href="javascript:void(0);"><span  class="drop-down-arrow-inner">Vehicles</span></a>
                            <ul>
                                <li>
                                    <a href="<?php echo SITEURL; ?>/manage-vehicles.php"><span>Vehicle List</span></a>
                                </li>

                                <li>
                                    <a href="<?php echo SITEURL; ?>/top-ten-vehicles.php"><span>Top Ten Vehicles</span></a>
                                </li>


                                <li><a href="<?php echo SITEURL; ?>/manage-make-reports.php"><span>Make wise Reports</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/manage-model-reports.php"><span>Model wise Reports</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/model-years.php"><span>Model Years</span></a></li>
                            </ul>
                        </li>
                        <li><a href="<?php echo SITEURL; ?>/manage-ros.php"><span>Repair Orders</span></a></li>
                        <li><a href="<?php echo SITEURL; ?>/manage-competitors.php"><span>Manage Competitors</span></a></li>
                    </ul>
		</li>
		<li><a href="javascript:void(0);"  <?php if($Page == 'daily') { ?>  class="active"<?php } ?>><span>Daily Data</span></a>
			<ul>
		...
		<li><a href="javascript:void(0);" <?php if($Page == 'marketing') { ?>  class="active"<?php } ?>><span>Marketing</span></a>
			<ul>
				...
				<li><a href="javascript: ShowMG();"><span>Monitoring Goals Map</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/ro-goal.php"><span>RO Goal</span></a></li>
		...
		<li><a href="javascript:void(0);" <?php if($Page == 'website') { ?>  class="active"<?php } ?>><span>Website</span></a>
			<ul>
                ...
                <li><a href="javascript:void(0);"  <?php if($Page == 'surveys') { ?>  class="active"<?php } ?>><span>Surveys</span></a>
			<ul>
		...
		<li><a href="javascript:void(0);"  <?php if($Page == 'resources') { ?>  class="active"<?php } ?>><span>Resources</span></a>
			<ul>
