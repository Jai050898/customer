                ...
                <li><a href="javascript:void(0);" <?php if($Page == 'customers') { ?>  class="active"<?php } ?>><span>Business</span></a>
                    <ul>
                        <li>
                            ...
                            <ul>
                                <?php if($_SERVER['REMOTE_ADDR'] == '182.72.66.214' || $_SERVER['REMOTE_ADDR'] == '182.72.88.155') { ?>
                                    <li><a href="javascript: ShowROReport();"><span>Gross Sales Week-wise Report</span></a></li>
                                <?php } ?>
                                ...
                                <li><a href="<?php echo SITEURL; ?>/manage-customer-visit-reports.php"><span>Customer Visit wise Reports</span></a></li>

                                <li><a href="<?php echo SITEURL; ?>/manage-customer-counts.php"><span>Customer Duration wise Reports</span></a></li>
                                <li><a href="<?php echo SITEURL; ?>/manage-customer-spendings.php"><span>Customer Spend wise Reports</span></a></li>
