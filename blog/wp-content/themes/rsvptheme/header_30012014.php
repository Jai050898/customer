	  ...
	  <ul>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo SITEURL; ?>/manage-total-reports.php"><span>Year wise Customer Reports</span></a></li>
		...
		<li><a href="javascript:void(0);"  <?php if($Page == 'daily') { ?>  class="active"<?php } ?>><span>Daily Data</span></a>
			...
			<li><a href="<?php echo SITEURL; ?>/add-daily-data.php"><span>Add Data</span></a></li>
                        <li><a href="<?php echo SITEURL; ?>/customer-calender.php"><span>Manage Schedules</span></a></li>
