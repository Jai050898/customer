...
$smarty->assign('breadcrumb','Integrated Survey- Step9');
$usr 		= new General;

$marketingOpportunitiesarr = $usr->GetAllWhere("tbl_survey_marketing_opportunities","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	$delcomm = $usr->DeleteQry("tbl_survey_community","UserId = '".$_SESSION['User']['UID']."'");
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_survey_marketing_opportunities',$customerMarketingOpportunities,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:integrated-step10.php');
		exit;
