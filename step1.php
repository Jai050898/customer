...
$smarty->assign('breadcrumb','Marketing Survey Step-1');
...
$basicInfoDetailarr = $usr->GetAllWhere("tbl_basic_information","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('tbl_basic_information',$insarr,"UserId = '".$_SESSION['User']['UID']."'");
