...
<tr>
<td><a href="http://marketingnavigator.info/cal-gantt-day.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $py;?>">Pre Year</a></td>
<td><a href="http://marketingnavigator.info/cal-gantt-day.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $ny;?>">Next Year</a></td>
</tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1"  style="font-size:14px; font-family:Arial, Helvetica, sans-serif;">
<tr>
<td width="50%" align="left"><a href="http://marketingnavigator.info/cal-gantt.php?id=<?php echo $_REQUEST['id'];?>&year=<?php echo $_REQUEST['year'];?>">View Weekly Gantt</a></td>
</tr>
</table>