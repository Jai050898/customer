		...
		<h1>Results</h1>
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="GLS" id="GLS" value="{$Tasks.GLS}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Gross Parts Sales (GPS):</td>
				  <td align="left" valign="center"><input type="text" name="GPS" id="GPS" value="{$Tasks.GPS}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Gross Sales (GS):</td>
				  <td align="left" valign="center"><input type="text" name="GS" id="GS" value="{$Tasks.GS}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Total Labor Costs (TLC):</td>
				  <td align="left" valign="center"><input type="text" name="TLC" id="TLC" value="{$Tasks.TLC}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Total Parts Costs (TPC):</td>
				  <td align="left" valign="center"><input type="text" name="TPC" id="TPC" value="{$Tasks.TPC}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Marketing Budget:</td>
				  <td align="left" valign="center"><input type="text" name="MB" id="MB" value="{$Tasks.MB}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Rent Budget:</td>
				  <td align="left" valign="center"><input type="text" name="RB" id="RB" value="{$Tasks.RB}"/></td>
				</tr>
				<tr>
				  <td align="right" valign="center" style="padding-left:5px;">Number of Customers Needed:</td>
				  <td align="left" valign="center"><input type="text" name="NCN" id="NCN" value="{$Tasks.NCN}"/></td>
				</tr>
				<tr>
