                     ...
                     <tr>
                         <td>
                             <form id="category_type" class="form" method="POST" name="category_type"> 
                                 ...
                                 {section name=totallist loop=$total_temp}
                                     {if $total_temp[totallist].cat_id neq ''}
                                     <option value="{$total_temp[totallist].cat_id}">{$total_temp[totallist].cat_name}</option>{/if}
                                 {/section}
                                 </select>
                             </form>
                         </td>
