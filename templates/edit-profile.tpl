			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
					...
					<select name="state[]" id="state" style="width:187px; height:23px;" class="select req-string">
						...
						<option value="{$State[list].State_ID}" {if $State[list].State_ID eq $AccDet.state} selected="selected"{/if}>{if $State[list].State_Code neq "" }{$State[list].State_Code}{else}{$State[list].State_Name}{/if}</option>
						{/section}
					</select>
					</span></td>
				</tr>
				...
				<tr>
				  ...
				  <td align="left" valign="center">
				  	<table width="100%" border="0" cellspacing="5" cellpadding="5">
						...
						{if $smarty.foreach.item.iteration%4 eq 0}
						</tr><tr>
						{/if}
						{/foreach}
						</tr>
				...
				<tr>
				  ...
				  <td align="left" valign="center">
				  	<input type="text" name="Log[dob]" id="dob" class="input" value="{$AccDet.dob|date_format:'%m-%d-%Y'}"/>
				  </td>
				</tr>
				<tr>
