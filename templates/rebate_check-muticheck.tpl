                    ...
                    <table  width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc"  class="tableinnercontent">
                        ...
                        <tr>
                            <td align="left" valign="center" colspan="7">
                                <div class="search_divbox"><label style="color: #FFFFFF;">From Date:</label> &nbsp;<input type="text" name="sdate" id="sdate" class="select req-string reqDate" value="{$smarty.request.sdate}"/>&nbsp;&nbsp;&nbsp;<label style="color: #FFFFFF;">To Date:</label> &nbsp;<input type="text" name="edate" id="edate" class="select req-string reqDate" value="{$smarty.request.edate}"/> &nbsp;&nbsp;<label style="color: #FFFFFF;">Percentage</label><input type="text" name="percentage" class="input" id="percentage" onblur="if(this.value == '') this.value='Enter a Percentage to proceed'" onfocus="if(this.value == 'Enter a Percentage to proceed') this.value=''" value="{if $smarty.request.percentage neq ""}{$smarty.request.percentage}{else}Enter a Percentage to proceed{/if}" class="searchinput" style="width:170px" />
                                </div>
                            <br/>
                            <div class="search_divbox">
                                <label style="color: #FFFFFF;">Range between </label><input type="text" name="start_range" class="input" id="start_range" style="width:100px"  value="{if $smarty.request.start_range neq ""}{$smarty.request.start_range}{else}{/if}" /><label style="color: #FFFFFF;"> and </label><input type="text" name="end_range" class="input" id="end_range"  style="width:100px"  value="{if $smarty.request.end_range neq ""}{$smarty.request.end_range}{else}{/if}" />
...
<!--                        <tr>
                          <td  colspan="9">
                                ...
                                <td align="left" valign="center" colspan="7">
                                    <div class="search_divbox">
                                   <div class="search_divbox"><label style="color: #FFFFFF;">From Date:</label>
                                    &nbsp;<input type="text" name="sdate" id="sdate" class="select req-string reqDate" value="{$smarty.request.sdate}"/>&nbsp;&nbsp;&nbsp;<label style="color: #FFFFFF;">To Date:</label> &nbsp;
                                    <input type="text" name="edate" id="edate" class="select req-string reqDate" value="{$smarty.request.edate}"/></div>
                                    <td>&nbsp;</td>
                                </tr>
                           --> 
                                   <!-- <tr>
                            ...
                            <tr>
                                <td colspan="9">
                                      <div class="pagecount_info_divbox">
                                          ...
                                          <form id="batchcustomers" name="batchcustomer" method="POST" action="rebate_checkexporttocsv-multi.php">
                                              <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc"  class="tableinnercontent">
...
<input type=checkbox name="unbatch[]" id="unbatch{$smarty.foreach.item.index+1}" onclick="unbatch(this.id,this.value)" value={$item.cust_id}   />
...
<script language="javascript" type="text/javascript">
    ...
    function unbatch(unbatch_id,cust_id){
        var batchitem_id = unbatch_id;
        
        if (document.getElementById(batchitem_id).checked) {
                        $.ajax({
                        url: 'batch_unbatch_customers.php',
                        data: {
                        cust_id: cust_id,
                        type:'unbatch'
                        },
