		...
		<div class="bodyleft daily_hours_left">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" >
				<tr>
					...
					<td  bgcolor="#336699" style="color:#fff;"><strong>Sales before Discount</strong></td>
					<td  bgcolor="#336699" style="color:#fff;"><strong>Parts Sales</strong></td>
					<td  bgcolor="#336699" style="color:#fff;"><strong>Labor sales</strong></td>
					<td  bgcolor="#336699" style="color:#fff;"><strong>Sales per Technician</strong></td>
                                        <td  bgcolor="#336699" style="color:#fff;"><strong>Sales per Adviser</strong></td>
                                        <td  bgcolor="#336699" style="color:#fff;"><strong>Sales per Bay</strong></td>
				...
				<tr>
					...
					<td bgcolor="#f9f9f7" style="color:#000000;">${$item.sales_before_discounts|number_format:2:".":","}</td>
					<td bgcolor="#f9f9f7" style="color:#000000;">${$item.parts_sales|number_format:2:".":","}</td>
					<td bgcolor="#f9f9f7" style="color:#000000;">${$item.labor_sales|number_format:2:".":","}</td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;">${$item.sales_per_technician|number_format:2:".":","}</td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;">${$item.sales_per_advisor|number_format:2:".":","}</td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;">${$item.sales_per_bay|number_format:2:".":","}</td>
