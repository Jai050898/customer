                    ...
                    <form name="TaskForm" class="form" id="TaskForm" method="post" onsubmit="return ajaxSubmit();">
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="center"><input type="text" name="Log[source]" id="source" class="select req-string" value="{$source}"/></td>
                            </tr>
                            <tr>
                                <td align="right" valign="center" style="padding-left:5px;">Referral:<span class="redstar"> * </span></td>
                                <td align="left" valign="center"><input type="text" name="Log[referral]" id="referral" class="select req-string" value="{$referral}"/></td>
                            </tr>
                            <tr>
                                <td colspan="2" id="errorDiv1" style="color:#935;font-size:12px; padding-left:215px;"><span id="errorDiv1Span"></span></td>
                            </tr>
                            <tr>
                                <td colspan="2" id="errorDiv_res" style="color:#00FF00;font-size:12px; padding-left:215px;"></td>
                            </tr>
                            <tr>
                                <td align="center" valign="top" style="padding-left:5px;" colspan="2"><input name="input" id="submitBtn1" type="submit" value="Submit" onclick="validate_fields()" /></td>
                            </tr>
                        </table>
                        <div class="clear"></div>
                    </form>
...
<script language="javascript" type="text/javascript">
    function validate_fields(){
        if($('#referral').val()=='' && $('#source').val()==''  ){
           $ ('#errorDiv1').html('Please enter source or referral');
           return false;
        }else{
          //  $('#TaskForm').submit();
            return true;
...
*/
    function ajaxSubmit() {
        ...
        $('#errorDiv_res').html('');
        $.post( 
                'https://www.autorepairmarketing.com/customer/newcustomers_staff.php', 
                ...
                function(data) {
                    //alert(data);
                    if(data == 1 || data == '1') {
                        $('#errorDiv_res').html('Data Updated Successfully!!!');
                        location.reload();
                    }
                    return false;
                }
