            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
                {foreach item=item name=item key=k from=$RODetails}
                    ...
                    <tr>
                        ...
                        <td align="left" valign="center" width="65%">${$item.unitcost|number_format:2:".":","}</td>
                    </tr>
                    <tr>
                        <td align="right" valign="center" style="padding-left:55px;" width="35%">Unit Sale :</td>
                        <td align="left" valign="center" width="65%">${$item.unitsale|number_format:2:".":","}</td>
                    </tr>
                    <tr>
                        <td align="right" valign="center" style="padding-left:55px;" width="35%">Extented Cost :</td>
                        <td align="left" valign="center" width="65%">${$item.extendedcost|number_format:2:".":","}</td>
                    </tr>
                    <tr>
                        <td align="right" valign="center" style="padding-left:55px;" width="35%">Extented Sale :</td>
                        <td align="left" valign="center" width="65%">${$item.extendedsale|number_format:2:".":","}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="center" width="65%">${$RODetails.laborrate|number_format:2:".":","}</td>
                    </tr>
                {foreachelse}
                    <tr>
