...
<div id="body">
	<div class="bodybg">
		<div class="bodyleft">
			...
			<h1>{if $smarty.request.task_id neq ""}Edit{else}Add{/if}Category</h1>
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr>
				  ...
				  <td align="left" valign="center"><input type="text" name="Log[cat_name]" id="cat_name" class="select req-string" value="{$Tasks.cat_name}"/></td>
				</tr>
				<tr>
