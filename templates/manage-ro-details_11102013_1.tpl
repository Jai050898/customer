                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                            ...
                            {foreach item=item name=item from=$Users}
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;">{$item.unitquantity|string_format:"%.2f"}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;">${$item.unitcost|number_format:2:".":","}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;">{$item.unitsale|string_format:"%.2f"}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;">${$item.extendedcost|number_format:2:".":","}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;">${$item.extendedsale|number_format:2:".":","}</td>
