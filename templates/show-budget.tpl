	...
	<div class="bodybg">
		<div class="bodyleft">
			...
			<tr style="background-color:{cycle values='#ffffff,#ffffff'};">
				...
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;">$ {$item1.amount|number_format:2:".":","}</td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;">$ {$item1.actual_amount|number_format:2:".":","}</td>
			</tr>
			{/foreach}
			{/if}
			{/foreach}
			<tr style="background-color:#f3f3f3;">
				...
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Cal.gsales|number_format:2:".":","}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Cal.gsales|number_format:2:".":","}</strong></td>
			</tr>
			<tr style="background-color:#f3f3f3;">
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>Total</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Cal.amount|number_format:2:".":","}</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>$ {$Cal.actualamount|number_format:2:".":","}</strong></td>
			</tr>
			<tr style="background-color:#f3f3f3;">
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>% of Gross Sales</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>{$Cal.per} %</strong></td>
				<td align="left" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;text-align: right;"><strong>{$Cal.actper} %</strong></td>
			</tr>
			</table>
		<div class="clear"></div>
