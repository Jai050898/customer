        ...
        <div>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                ...
                <tr>
                    ...
                    <td bgcolor="#f9f9f7" style="color:#000000;">${$highestRO|number_format:2:".":","}</td>
                </tr>
                <tr>
                    ...
                    <td bgcolor="#f9f9f7" style="color:#000000;">${$lowestRO|number_format:2:".":","}</td>
                </tr>
                <tr>
                    ...
                    <td bgcolor="#f9f9f7" style="color:#000000;">${$averageROTotal|number_format:2:".":","}</td>
                </tr>
            </table>
            <div style="height:10px;"></div>
