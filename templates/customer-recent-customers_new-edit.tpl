	...
	<div class="bodybg" style="min-height:475px;">
            <div>
                ...
                <form id="ManageCustomers" class="form"  method="GET" name="ManageCustomers" onsubmit="return validateFrom();">
                                ...
                                <!--<input type="hidden" name="sortby1" value="{$smarty.request.sortby1}" />
                                <input type="hidden" name="sortoption1" value="{$smarty.request.sortoption1}" />-->
			...
			<tr>
                                <td colspan="8">
                                    ...
                                    <tr>
                                            ...
                                            <th bgcolor="#336699" style="color:#fff;">Edit</th>
                                    ...
                                    {foreach item=item name=item from=$allArray}
                                        <tr>
                                            ...
                                            {else}
                                                ...
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">&nbsp;&nbsp;<a href="javascript: ShowSR({$item.id}, {$item.ro_id}, {$item.company_id}, {$item.cust_id});">Edit</a></td>
                                            {/if}
                                        </tr>
                                    {foreachelse}	                                  
                                        <tr>
...
function ShowSR(id,ro_id,company_id, cust_id) {
        tb_show('Recent Customers','newcustomers-edit.php?height=200&width=500&id='+id+'&ro_id='+ro_id+'&company_id='+company_id+'&cust_id='+cust_id);
    return;
}
