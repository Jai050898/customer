...
<div id="container">
    <div id="logo">
        ...
        <div style="float:right;padding: 10px 60px 10px 20px;">
            <p style="text-align:right;"><strong style="font-size:15px;">{$smarty.session.User.company_name}</strong></p>
...
<div id="nav">
  <ul>
	...
	<li><a href="javascript:void(0);" {if $Page eq 'projects'}  class="active"{/if}><span>Projects</span></a>
		...
		<ul>
                    <li><a href="javascript:void(0);"><span>Customers</span></a>
                        <ul>
                            ...
                            <li><a href="{$siteurl}/manage-total-reports.php"><span>Year wise Customer Reports</span></a></li>
                            <li><a href="{$siteurl}/manage-customer-visit-reports.php"><span>Customer Visit wise Reports</span></a></li>
                            <li><a href="{$siteurl}/manage-customer-counts.php"><span>Customer Duration wise Reports</span></a></li>
                            <li><a href="{$siteurl}/manage-customer-spendings.php"><span>Customer Spend wise Reports</span></a></li>
                            <li><a href="{$siteurl}/new-reports.php"><span>Export Customer Reports</span></a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);"><span>Vehicles</span></a>
                        <ul>
