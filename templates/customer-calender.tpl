...
<div id="body">
    <div class="bodybg" style="min-height:475px;">
        <div class="bodyleft">
            ...
            <form id="ManageCustomers" class="form" method="GET" name="ManageCustomers">
                ...
                <table cellspacing="1" cellpadding="5" border="0" bgcolor="#6699cc" width="100%">
                    <tr>
                    <th bgcolor="#336699" style="color:#fff;">Technicians</th>
                    <th bgcolor="#336699" style="color:#fff;">Month working hours</th>
                    </tr>
            {foreach from=$techArray key=k item=nc}    
                <tr>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$nc.technician|stripslashes}</td>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$nc.totalhrs|number_format:0:".":","}</td>
                </tr>
             {foreachelse}
                <tr>
                    <th bgcolor="#f9f9f7" style="color:#000000;" colspan="2"><font color="#FF0000"><strong>No Technicians Found</strong></font></th>
                </tr>
            {/foreach}
               </table>
            </form>
        ...
        <div class="bodyright_calender">
            ...
            <table cellspacing="1" cellpadding="5" border="0" bgcolor="#6699cc" width="100%">
                    <tr>
                    <th bgcolor="#336699" style="color:#fff;">Repeated Cusotmers</th>
                    <th bgcolor="#336699" style="color:#fff;">New Cusotmers</th>
                        <th bgcolor="#336699" style="color:#fff;">Total</th>
                    </tr>
            
                <tr>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$repeated_cust}</td>
                    
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$new_cusotmers_sum}</td>
                     <td bgcolor="#f9f9f7" style="color:#000000;">{$totalcustomers}</td>
                </tr> </table>
