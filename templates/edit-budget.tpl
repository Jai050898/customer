	...
	<div class="bodybg">
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" class="left_content" style="color:#2f3337;">
				...
				<tr  align="right" id="itemicon{$item.id}" >
					<td colspan="4"><a href="javascript:void(0);" onclick="javascript: DeleteItem({$item.id})"><img src="{$siteurl}/images/del.png" border="0" />&nbsp;Delete Item</a></td>
				</tr>
