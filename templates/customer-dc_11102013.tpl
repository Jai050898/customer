        ...
        <div>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                ...
                <tr>
                    ...
                    <td bgcolor="#f9f9f7" style="color:#000000;">$ {$avgVariance|number_format:2}</td>
                </tr>
                <tr>
                    <td bgcolor="#f9f9f7" style="color:#000000;">Best Year</td>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$bestYear} (${$bestYearTotal})</td>
                </tr>
                <tr>
                    <td bgcolor="#f9f9f7" style="color:#000000;">Average Year</td>
                    <td bgcolor="#f9f9f7" style="color:#000000;">${$averageYearTotal|number_format:"2"}</td>
                </tr>
                <tr>
                    <td bgcolor="#f9f9f7" style="color:#000000;">Highest Year</td>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$highestYear} (${$highestYearTotal})</td>
                </tr>
                <tr>
                    <td bgcolor="#f9f9f7" style="color:#000000;">Lowest Year</td>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$lowestYear} (${$lowestYearTotal})</td>
                </tr>
            </table>
            <div style="height:10px;"></div>
            <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                ...
                {foreach item=item name=item from=$dataArray}
                    <tr>
                        ...
                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.custTotal}</td>
                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.roTotal}</td>
                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.vehicleTotal}</td>
                        <td bgcolor="#f9f9f7" style="color:#000000;">${$item.grossSale|string_format:"%.2f"}</td>
                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.variance|string_format:"%.2f"}%</td>
