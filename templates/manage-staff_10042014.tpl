                      ...
                      <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" class="tableinnercontent">
                            ...
                            {foreach item=item name=item from=$Users}
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.status}</td>
                                    ...
                                    <a href="{$siteurl}/manage-staff.php?id={$item.user_id}&act=del" class="link023"><img src="{$siteurl}/images/del.png" border="0" title="Delete" alt="Delete" /></a></td>
</td>
                                </tr>
                        {foreachelse}
                                <tr>
