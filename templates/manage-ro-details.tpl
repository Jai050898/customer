                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                            ...
                            {foreach item=item name=item from=$Users}
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.ro_id}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.transactiondetailextid}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.unitquantity|string_format:"%.2f"}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">${$item.unitcost|number_format:2:".":","}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.unitsale|string_format:"%.2f"}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">${$item.extendedcost|number_format:2:".":","}</td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">${$item.extendedsale|number_format:2:".":","}</td>
