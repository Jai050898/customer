                        ...
                        <tr>
                            <th width="9%" height="30"  align="left" valign="top">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      <th  height="38" colspan="2" bgcolor="#336699" align="center" valign="middle" style="color:#fff;">Total Disc/Adj</th>
                                    </tr>
                                    <tr>
                            ...
                            <th width="9%" height="30"  align="left" valign="top">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc"  class="tableinnercontent">
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            {foreach item=item name=item from=$roCalculationsArray}
                                                <td height="30" align="center" valign="middle" bgcolor="#f9f9f7" style="color:#000000;">${$item.managercharges|number_format:2:".":","}</td> 
                                            {/foreach}    
                                        </tr>
                                        <tr>
