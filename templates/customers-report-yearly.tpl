        ...
        <div class="bodyleft">
            ...
            {foreach item=item name=item from=$dataArray}
                <tr>
                    ...
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$item.repeated_cust}</td>
                    <td bgcolor="#f9f9f7" style="color:#000000;">{$item.newCustArray}</td>
                     <td bgcolor="#f9f9f7" style="color:#000000;">{$item.Events}</td>
                </tr>
                {foreachelse}
                    <tr>
