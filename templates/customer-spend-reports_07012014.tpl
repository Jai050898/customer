                                      ...
                                      <tr>
                                        ...
                                        {foreach item=item name=item from=$customer}
                                            <tr>
                                                ...
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{if $item.fv eq ""}{'--N-A--'}{else}${$item.fv|number_format:2:".":","}{/if}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{if $item.sv eq ""}{'-N-A-'}{else}${$item.sv|number_format:2:".":","}{/if}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{if $item.tv eq ""}{'-N-A-'}{else}${$item.tv|number_format:2:".":","}{/if}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{if $item.fov eq ""}{'-N-A-'}{else}${$item.fov|number_format:2:".":","}{/if}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{if $item.fiv eq ""}{'-N-A-'}{else}${$item.fiv|number_format:2:".":","}{/if}</td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{if $item.tov eq ""}{'-N-A-'}{else}${$item.tov|number_format:2:".":","}{/if}</td>
                                               <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">{$item.allTotal}</td>
                                                
                                                <td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">${$item.avro|number_format:2:".":","}</td>
