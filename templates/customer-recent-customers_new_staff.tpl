                        ...
                        <!-- <tr>
                          <td  colspan="8">
                            ...
                            <td align="left" valign="center" colspan="8">
                                <div class="search_divbox"><label style="color: #FFFFFF;">From Date:</label> &nbsp;<input type="text" name="fdate" id="fdate" class="select req-string reqDate" value="{if $smarty.request.fdate eq ''}{$fromdate}{else}{$smarty.request.fdate}{/if}" /> &nbsp;&nbsp;&nbsp;<label style="color: #FFFFFF;">To Date:</label> &nbsp;<input type="text" name="tdate" id="tdate" class="select req-string reqDate" value="{if $smarty.request.tdate eq ''} {$todate}{else}{$smarty.request.tdate} {/if}" />&nbsp;&nbsp;&nbsp;
...
function ShowSR(id,ro_id,company_id, cust_id) {
        tb_show('Recent Customers','newcustomers_staff.php?height=200&width=500&id='+id+'&ro_id='+ro_id+'&company_id='+company_id+'&cust_id='+cust_id);
    return;
}
