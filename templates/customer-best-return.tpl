                ...
                <form id="ManageCustomers" class="form" method="GET" name="ManageCustomers">
                    ...
                    <table  width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#6699cc">
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc"  class="tableinnercontent">
                                        ...
                                        {/foreach}
                                            <tr>
                                                ...
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><font color="#FF0000"><strong></strong></font></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><font color="#FF0000"><strong></strong></font></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><font color="#FF0000"><strong>${$totalGrossSale_RO1}</strong></font></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><font color="#FF0000"><strong>{if $totalGrossSale_RO2 eq "0"}&nbsp;{else}${$totalGrossSale_RO2}{/if}</strong></font></td>
                                                <td bgcolor="#f9f9f7" style="color:#000000;"><font color="#FF0000"><strong>{if $totalGrossSale_RO3 eq "0"}&nbsp;{else}${$totalGrossSale_RO3}{/if}</strong></font></td>
						...
						<td bgcolor="#f9f9f7" style="color:#000000;"><font color="#FF0000"><strong>{$Totalgrosscount}</strong></font></td>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><font color="#000"><strong>{if $ro1_visits eq "0"}&nbsp;{else}{$ro1_visits}{/if}</strong></font></td>
                                                <td><font color="#000"><strong>{if $ro2_visits eq "0"}&nbsp;{else}{$ro2_visits}{/if}</strong></font></td>
                                                <td><font color="#000"><strong>{if $ro3_visits eq "0"}&nbsp;{else}{$ro3_visits}{/if}</strong></font></td>
                                                <td></td>
                                                <td></td>
                                                </tr>
