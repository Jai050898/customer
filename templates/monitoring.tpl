		...
		<div class="bodyleft">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc"  class="tableinnercontent">
				...
				<tr>
					...
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">$ {$item.maxamt|number_format:2:".":","}</td>
					<td bgcolor="#f9f9f7" style="color:#000000;text-align: right;">$ {$item.minamt|number_format:2:".":","}</td>
					<td bgcolor="#f9f9f7">
