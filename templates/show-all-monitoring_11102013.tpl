		<div>
			...
			<tr height="25">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px; width:7%">${$item.grosssales|number_format}</td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px; width:7%"><strong>${$Calitem.amount|number_format}</strong></td>
			</tr>
			{foreachelse}
			<tr height="25">
			...
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$item|number_format}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$MaxTotals1|number_format}</strong></td>
			</tr>
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$item|number_format}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$MinTotals1|number_format}</strong></td>
			</tr>
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$item|number_format}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$AvgTotals1|number_format}</strong></td>
			</tr>
			<tr height="30">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$item|number_format}</strong></td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px;"><strong>${$MedTotals1|number_format}</strong></td>
			</tr>
			...
			<tr height="25" style="color:#993300;">
				...
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px; width:7%">${$Gitem.goalsales|number_format}</td>
				{/foreach}
				<td  align="right" valign="middle" bgcolor="#FFFFFF" style="font-size:13px; width:7%"><strong>${$CalGoalitem.amount|number_format}</strong></td>
			</tr>
			{/foreach}
			{/if}
			</table>
