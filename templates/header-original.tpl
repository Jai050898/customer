...
<div style='display:none'><a href='http://www.helponclick.com'>Live Chat Software</a></div>
    <div id="logo">
        ...
        <div style="float:right;padding: 10px 60px 10px 20px;">
            ...
            <p style="text-align:right;"><span style="float:left;">{if $breadcrumb neq '' }{$breadcrumb} -&nbsp;&nbsp;{/if}</span><a href="{$siteurl}/logout.php">Logout</a> </p>
        </div>
...
<div id="nav">
  <ul>
	...
	<li><a href="javascript:void(0);" {if $Page eq 'projects'}  class="active"{/if}><span>Projects</span></a>
		...
		<ul>
			    ...
			    <li><a href="{$siteurl}/customer-visit-spending.php"><span>Customer Visit Spending</span></a></li>
                            ...
                            <li><a href="{$siteurl}/customer-last-visits.php" target="_blank"><span>Customer Last Visits</span></a></li>
                        </ul>
                    </li>
			    ...
			    <li><a href="{$siteurl}/model-years.php"><span>Model Years</span></a></li>
	...
	<li><a href="javascript:void(0);" {if $Page eq 'resources'}  class="active"{/if}><span>Resources</span></a>
        ...
        <li><a href="javascript:void(0);" {if $Page eq 'product'}  class="active"{/if}><span>Product</span></a>
		<ul>
                    <li><a href="{$siteurl}/rebate_check.php"><span>Rebate Check</span></a></li>
		</ul>
	</li>
