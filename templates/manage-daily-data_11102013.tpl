		...
		<div class="bodyleft daily_hours_left">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc" >
				...
				<tr>
					...
					<td bgcolor="#f9f9f7" style="color:#000000;">{$item.sales_before_discounts}</td>
					<td bgcolor="#f9f9f7" style="color:#000000;">{$item.parts_sales}</td>
					<td bgcolor="#f9f9f7" style="color:#000000;">{$item.labor_sales}</td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.sales_per_technician}</td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.sales_per_advisor}</td>
                                        <td bgcolor="#f9f9f7" style="color:#000000;">{$item.sales_per_bay}</td>
