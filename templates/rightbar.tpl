	...
	<div class="title">Quick Links</div>
		<div class="rightboxbg">
			<ul>
				...
				<li><a href="{$siteurl}/manage-mis-customers.php">Manage MIS Customers</a></li>
			  	<li><a href="{$siteurl}/manage-mis-zipcode-customers.php">MIS Zipcode Customers</a></li>
			  	<li><a href="{$siteurl}/manage-mis-city-customers.php">MIS City Customers</a></li>
			  	<li><a href="{$siteurl}/manage-mis-customers-report.php">MIS Customers Report</a></li>
				<li><a href="{$siteurl}/customer-dc.php">MIS Customer DC</a></li>-->
