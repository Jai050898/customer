                          ...
                          <table width="100%" border="0" cellspacing="1" cellpadding="5" bgcolor="#6699cc">
                            ...
                            {foreach item=item name=item from=$Users}
                                <tr>
                                    ...
                                    <td bgcolor="#f9f9f7" style="color:#000000;"><a href="{$siteurl}/view-models-by-make.php?make={$item.make}&sdate={$smarty.request.sdate}&edate={$smarty.request.edate}">{$item.make}</a></td>
                                    <td bgcolor="#f9f9f7" style="color:#000000;"><a href="{$siteurl}/view-models-by-make.php?make={$item.make}&sdate={$smarty.request.sdate}&edate={$smarty.request.edate}">{$item.Total}</a></td>
                                    </tr>
                            {foreachelse}
                                <tr>
