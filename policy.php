...
$smarty->assign('breadcrumb','Website Survey- Policy');
$usr 		= new General;

$policyInfoarr = $usr->GetAllWhere("web_tbl_policy","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_policy',$policy,"UserId = '".$_SESSION['User']['UID']."'");

		header('location:notoriety.php');
		exit;
