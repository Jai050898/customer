<?php 
/*********************************************************************
* Description: Page for Uploading the Images.
* Author: Venu Gopal	
...
$file_name_exploded = explode(".",$_FILES['userfile']['name']);
$newname			= $_REQUEST['time'].'-'.str_replace(" ","_",$file_name_exploded[0]);
$extension			= strtolower($file_name_exploded[count($file_name_exploded)-1]);
$FileName			= $newname.'.'.$extension;
move_uploaded_file($_FILES['userfile']['tmp_name'],SITEPATH.'/photos/original/'.$FileName);
