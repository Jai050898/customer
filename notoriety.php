...
$smarty->assign('breadcrumb','Website Survey- Notoriety');
$usr 		= new General;

$notorietyInfoarr = $usr->GetAllWhere("web_tbl_notoriety","UserId = '".$_SESSION['User']['UID']."'");
...
if(isset($_POST['btnSubmit']))
{
	...
	if($_POST['isNew'])
	{
		...
		$ins = $Gen->UpdateQry('web_tbl_notoriety',$notoriety,"UserId = '".$_SESSION['User']['UID']."'");
